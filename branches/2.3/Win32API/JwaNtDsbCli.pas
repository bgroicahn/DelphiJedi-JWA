...
function DsIsNTDSOnlineA; external ntdsbclilib name 'DsIsNTDSOnlineA' delayed;
function DsIsNTDSOnlineW; external ntdsbclilib name 'DsIsNTDSOnlineW' delayed;
function DsIsNTDSOnline; external ntdsbclilib name 'DsIsNTDSOnline' + AWSuffix delayed;
function DsBackupPrepareA; external ntdsbclilib name 'DsBackupPrepareA' delayed;
function DsBackupPrepareW; external ntdsbclilib name 'DsBackupPrepareW' delayed;
function DsBackupPrepare; external ntdsbclilib name 'DsBackupPrepare' + AWSuffix delayed;
function DsBackupGetDatabaseNamesA; external ntdsbclilib name 'DsBackupGetDatabaseNamesA' delayed;
function DsBackupGetDatabaseNamesW; external ntdsbclilib name 'DsBackupGetDatabaseNamesW' delayed;
function DsBackupGetDatabaseNames; external ntdsbclilib name 'DsBackupGetDatabaseNames' + AWSuffix delayed;
function DsBackupOpenFileA; external ntdsbclilib name 'DsBackupOpenFileA' delayed;
function DsBackupOpenFileW; external ntdsbclilib name 'DsBackupOpenFileW' delayed;
function DsBackupOpenFile; external ntdsbclilib name 'DsBackupOpenFile' + AWSuffix delayed;
function DsBackupRead; external ntdsbclilib name 'DsBackupRead' delayed;
function DsBackupClose; external ntdsbclilib name 'DsBackupClose' delayed;
function DsBackupGetBackupLogsA; external ntdsbclilib name 'DsBackupGetBackupLogsA' delayed;
function DsBackupGetBackupLogsW; external ntdsbclilib name 'DsBackupGetBackupLogsW' delayed;
function DsBackupGetBackupLogs; external ntdsbclilib name 'DsBackupGetBackupLogs' + AWSuffix delayed;
function DsBackupTruncateLogs; external ntdsbclilib name 'DsBackupTruncateLogs' delayed;
function DsBackupEnd; external ntdsbclilib name 'DsBackupEnd' delayed;
procedure DsBackupFree; external ntdsbclilib name 'DsBackupFree' delayed;
function DsRestoreGetDatabaseLocationsA; external ntdsbclilib name 'DsRestoreGetDatabaseLocationsA' delayed;
function DsRestoreGetDatabaseLocationsW; external ntdsbclilib name 'DsRestoreGetDatabaseLocationsW' delayed;
function DsRestoreGetDatabaseLocations; external ntdsbclilib name 'DsRestoreGetDatabaseLocations' + AWSuffix delayed;
function DsRestorePrepareA; external ntdsbclilib name 'DsRestorePrepareA' delayed;
function DsRestorePrepareW; external ntdsbclilib name 'DsRestorePrepareW' delayed;
function DsRestorePrepare; external ntdsbclilib name 'DsRestorePrepare' + AWSuffix delayed;
function DsRestoreRegisterA; external ntdsbclilib name 'DsRestoreRegisterA' delayed;
function DsRestoreRegisterW; external ntdsbclilib name 'DsRestoreRegisterW' delayed;
function DsRestoreRegister; external ntdsbclilib name 'DsRestoreRegister' + AWSuffix delayed;
function DsRestoreRegisterComplete; external ntdsbclilib name 'DsRestoreRegisterComplete' delayed;
function DsRestoreEnd; external ntdsbclilib name 'DsRestoreEnd' delayed;
function DsSetCurrentBackupLogA; external ntdsbclilib name 'DsSetCurrentBackupLogA' delayed;
function DsSetCurrentBackupLogW; external ntdsbclilib name 'DsSetCurrentBackupLogW' delayed;
function DsSetCurrentBackupLog; external ntdsbclilib name 'DsSetCurrentBackupLog' + AWSuffix delayed;
function DsSetAuthIdentityA; external ntdsbclilib name 'DsSetAuthIdentityA' delayed;
function DsSetAuthIdentityW; external ntdsbclilib name 'DsSetAuthIdentityW' delayed;
function DsSetAuthIdentity; external ntdsbclilib name 'DsSetAuthIdentity' + AWSuffix delayed;
