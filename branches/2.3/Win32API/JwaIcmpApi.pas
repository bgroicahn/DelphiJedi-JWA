...
function IcmpCreateFile; external icmplib name 'IcmpCreateFile' delayed;
function Icmp6CreateFile; external icmplib name 'Icmp6CreateFile' delayed;
function IcmpCloseHandle; external icmplib name 'IcmpCloseHandle' delayed;
function IcmpSendEcho; external icmplib name 'IcmpSendEcho' delayed;
function IcmpSendEcho2; external icmplib name 'IcmpSendEcho2' delayed;
function Icmp6SendEcho2; external icmplib name 'Icmp6SendEcho2' delayed;
function IcmpParseReplies; external icmplib name 'IcmpParseReplies' delayed;
function Icmp6ParseReplies; external icmplib name 'Icmp6ParseReplies' delayed;
