...
function EnumProtocolsA; external nsplib name 'EnumProtocolsA' delayed;
function EnumProtocolsW; external nsplib name 'EnumProtocolsW' delayed;
function EnumProtocols; external nsplib name 'EnumProtocols' + AWSuffix delayed;
function GetAddressByNameA; external nsplib name 'GetAddressByNameA' delayed;
function GetAddressByNameW; external nsplib name 'GetAddressByNameW' delayed;
function GetAddressByName; external nsplib name 'GetAddressByName' + AWSuffix delayed;
function GetTypeByNameA; external nsplib name 'GetTypeByNameA' delayed;
function GetTypeByNameW; external nsplib name 'GetTypeByNameW' delayed;
function GetTypeByName; external nsplib name 'GetTypeByName' + AWSuffix delayed;
function GetNameByTypeA; external nsplib name 'GetNameByTypeA' delayed;
function GetNameByTypeW; external nsplib name 'GetNameByTypeW' delayed;
function GetNameByType; external nsplib name 'GetNameByType' + AWSuffix delayed;
function SetServiceA; external nsplib name 'SetServiceA' delayed;
function SetServiceW; external nsplib name 'SetServiceW' delayed;
function SetService; external nsplib name 'SetService' + AWSuffix delayed;
function GetServiceA; external nsplib name 'GetServiceA' delayed;
function GetServiceW; external nsplib name 'GetServiceW' delayed;
function GetService; external nsplib name 'GetService' + AWSuffix delayed;
