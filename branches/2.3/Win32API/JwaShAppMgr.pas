...
function InstallApplication; external Advapi32 name 'InstallApplication' delayed;
function UninstallApplication; external Advapi32 name 'UninstallApplication' delayed;
function CommandLineFromMsiDescriptor; external Advapi32 name 'CommandLineFromMsiDescriptor' delayed;
function GetManagedApplications; external Advapi32 name 'GetManagedApplications' delayed;
function GetLocalManagedApplications; external Advapi32 name 'GetLocalManagedApplications' delayed;
procedure GetLocalManagedApplicationData; external Advapi32 name 'GetLocalManagedApplicationData' delayed;
function GetManagedApplicationCategories; external Advapi32 name 'GetManagedApplicationCategories' delayed;
