...
function WSCEnumProtocols; external ws2_32 name 'WSCEnumProtocols' delayed;
function WSCDeinstallProvider; external ws2_32 name 'WSCDeinstallProvider' delayed;
function WSCInstallProvider; external ws2_32 name 'WSCInstallProvider' delayed;
function WSCGetProviderPath; external ws2_32 name 'WSCGetProviderPath' delayed;
function WSCUpdateProvider; external ws2_32 name 'WSCUpdateProvider' delayed;
function WSCInstallQOSTemplate; external qosname name 'WSCInstallQOSTemplate' delayed;
function WSCRemoveQOSTemplate; external qosname name 'WSCRemoveQOSTemplate' delayed;
function WSCInstallNameSpace; external ws2_32 name 'WSCInstallNameSpace' delayed;
function WSCUnInstallNameSpace; external ws2_32 name 'WSCUnInstallNameSpace' delayed;
function WSCEnableNSProvider; external ws2_32 name 'WSCEnableNSProvider' delayed;
{$IFDEF _WIN64}
function WSCEnumProtocols32; external ws2_32 name 'WSCEnumProtocols32' delayed;
function WSCDeinstallProvider32; external ws2_32 name 'WSCDeinstallProvider32' delayed;
function WSCInstallProvider64_32; external ws2_32 name 'WSCInstallProvider64_32' delayed;
function WSCGetProviderPath32; external ws2_32 name 'WSCGetProviderPath32' delayed;
function WSCUpdateProvider32; external ws2_32 name 'WSCUpdateProvider32' delayed;
function WSCEnumNameSpaceProviders32; external ws2_32 name 'WSCEnumNameSpaceProviders32' delayed;
function WSCInstallNameSpace32; external ws2_32 name 'WSCInstallNameSpace32' delayed;
function WSCUnInstallNameSpace32; external ws2_32 name 'WSCUnInstallNameSpace32' delayed;
function WSCEnableNSProvider32; external ws2_32 name 'WSCEnableNSProvider32' delayed;
{$ENDIF _WIN64}
