...
function IsHungAppWindow; external user32 name 'IsHungAppWindow' delayed;
procedure DisableProcessWindowsGhosting; external user32 name 'DisableProcessWindowsGhosting' delayed;
function wvsprintfA; external user32 name 'wvsprintfA' delayed;
function wvsprintfW; external user32 name 'wvsprintfW' delayed;
function wvsprintf; external user32 name 'wvsprintf' + AWSuffix delayed;
function wsprintfA; external user32 name 'wsprintfA' delayed;
function wsprintfW; external user32 name 'wsprintfW' delayed;
function wsprintf; external user32 name 'wsprintf' + AWSuffix delayed;
function LoadKeyboardLayoutA; external user32 name 'LoadKeyboardLayoutA' delayed;
function LoadKeyboardLayoutW; external user32 name 'LoadKeyboardLayoutW' delayed;
function LoadKeyboardLayout; external user32 name 'LoadKeyboardLayout' + AWSuffix delayed;
function ActivateKeyboardLayout; external user32 name 'ActivateKeyboardLayout' delayed;
function ToUnicodeEx; external user32 name 'ToUnicodeEx' delayed;
function UnloadKeyboardLayout; external user32 name 'UnloadKeyboardLayout' delayed;
function GetKeyboardLayoutNameA; external user32 name 'GetKeyboardLayoutNameA' delayed;
function GetKeyboardLayoutNameW; external user32 name 'GetKeyboardLayoutNameW' delayed;
function GetKeyboardLayoutName; external user32 name 'GetKeyboardLayoutName' + AWSuffix delayed;
function GetKeyboardLayoutList; external user32 name 'GetKeyboardLayoutList' delayed;
function GetKeyboardLayout; external user32 name 'GetKeyboardLayout' delayed;
function GetMouseMovePointsEx; external user32 name 'GetMouseMovePointsEx' delayed;
function CreateDesktopA; external user32 name 'CreateDesktopA' delayed;
function CreateDesktopW; external user32 name 'CreateDesktopW' delayed;
function CreateDesktop; external user32 name 'CreateDesktop' + AWSuffix delayed;
function OpenDesktopA; external user32 name 'OpenDesktopA' delayed;
function OpenDesktopW; external user32 name 'OpenDesktopW' delayed;
function OpenDesktop; external user32 name 'OpenDesktop' + AWSuffix delayed;
function OpenInputDesktop; external user32 name 'OpenInputDesktop' delayed;
function EnumDesktopsA; external user32 name 'EnumDesktopsA' delayed;
function EnumDesktopsW; external user32 name 'EnumDesktopsW' delayed;
function EnumDesktops; external user32 name 'EnumDesktops' + AWSuffix delayed;
function EnumDesktopWindows; external user32 name 'EnumDesktopWindows' delayed;
function SwitchDesktop; external user32 name 'SwitchDesktop' delayed;
function SetThreadDesktop; external user32 name 'SetThreadDesktop' delayed;
function CloseDesktop; external user32 name 'CloseDesktop' delayed;
function GetThreadDesktop; external user32 name 'GetThreadDesktop' delayed;
function CreateWindowStationA; external user32 name 'CreateWindowStationA' delayed;
function CreateWindowStationW; external user32 name 'CreateWindowStationW' delayed;
function CreateWindowStation; external user32 name 'CreateWindowStation' + AWSuffix delayed;
function OpenWindowStationA; external user32 name 'OpenWindowStationA' delayed;
function OpenWindowStationW; external user32 name 'OpenWindowStationW' delayed;
function OpenWindowStation; external user32 name 'OpenWindowStation' + AWSuffix delayed;
function EnumWindowStationsA; external user32 name 'EnumWindowStationsA' delayed;
function EnumWindowStationsW; external user32 name 'EnumWindowStationsW' delayed;
function EnumWindowStations; external user32 name 'EnumWindowStations' + AWSuffix delayed;
function CloseWindowStation; external user32 name 'CloseWindowStation' delayed;
function SetProcessWindowStation; external user32 name 'SetProcessWindowStation' delayed;
function GetProcessWindowStation; external user32 name 'GetProcessWindowStation' delayed;
function SetUserObjectSecurity; external user32 name 'SetUserObjectSecurity' delayed;
function GetUserObjectSecurity; external user32 name 'GetUserObjectSecurity' delayed;
function GetUserObjectInformationA; external user32 name 'GetUserObjectInformationA' delayed;
function GetUserObjectInformationW; external user32 name 'GetUserObjectInformationW' delayed;
function GetUserObjectInformation; external user32 name 'GetUserObjectInformation' + AWSuffix delayed;
function SetUserObjectInformationA; external user32 name 'SetUserObjectInformationA' delayed;
function SetUserObjectInformationW; external user32 name 'SetUserObjectInformationW' delayed;
function SetUserObjectInformation; external user32 name 'SetUserObjectInformation' + AWSuffix delayed;
function RegisterWindowMessageA; external user32 name 'RegisterWindowMessageA' delayed;
function RegisterWindowMessageW; external user32 name 'RegisterWindowMessageW' delayed;
function RegisterWindowMessage; external user32 name 'RegisterWindowMessage' + AWSuffix delayed;
function TrackMouseEvent; external user32 name 'TrackMouseEvent' delayed;
function DrawEdge; external user32 name 'DrawEdge' delayed;
function DrawFrameControl; external user32 name 'DrawFrameControl' delayed;
function DrawCaption; external user32 name 'DrawCaption' delayed;
function DrawAnimatedRects; external user32 name 'DrawAnimatedRects' delayed;
function GetMessageA; external user32 name 'GetMessageA' delayed;
function GetMessageW; external user32 name 'GetMessageW' delayed;
function GetMessage; external user32 name 'GetMessage' + AWSuffix delayed;
function TranslateMessage; external user32 name 'TranslateMessage' delayed;
function DispatchMessageA; external user32 name 'DispatchMessageA' delayed;
function DispatchMessageW; external user32 name 'DispatchMessageW' delayed;
function DispatchMessage; external user32 name 'DispatchMessage' + AWSuffix delayed;
function SetMessageQueue; external user32 name 'SetMessageQueue' delayed;
function PeekMessageA; external user32 name 'PeekMessageA' delayed;
function PeekMessageW; external user32 name 'PeekMessageW' delayed;
function PeekMessage; external user32 name 'PeekMessage' + AWSuffix delayed;
function RegisterHotKey; external user32 name 'RegisterHotKey' delayed;
function UnregisterHotKey; external user32 name 'UnregisterHotKey' delayed;
function ExitWindowsEx; external user32 name 'ExitWindowsEx' delayed;
function SwapMouseButton; external user32 name 'SwapMouseButton' delayed;
function GetMessagePos; external user32 name 'GetMessagePos' delayed;
function GetMessageTime; external user32 name 'GetMessageTime' delayed;
function GetMessageExtraInfo; external user32 name 'GetMessageExtraInfo' delayed;
function SetMessageExtraInfo; external user32 name 'SetMessageExtraInfo' delayed;
function SendMessageA; external user32 name 'SendMessageA' delayed;
function SendMessageW; external user32 name 'SendMessageW' delayed;
function SendMessage; external user32 name 'SendMessage' + AWSuffix delayed;
function SendMessageTimeoutA; external user32 name 'SendMessageTimeoutA' delayed;
function SendMessageTimeoutW; external user32 name 'SendMessageTimeoutW' delayed;
function SendMessageTimeout; external user32 name 'SendMessageTimeout' + AWSuffix delayed;
function SendNotifyMessageA; external user32 name 'SendNotifyMessageA' delayed;
function SendNotifyMessageW; external user32 name 'SendNotifyMessageW' delayed;
function SendNotifyMessage; external user32 name 'SendNotifyMessage' + AWSuffix delayed;
function SendMessageCallbackA; external user32 name 'SendMessageCallbackA' delayed;
function SendMessageCallbackW; external user32 name 'SendMessageCallbackW' delayed;
function SendMessageCallback; external user32 name 'SendMessageCallback' + AWSuffix delayed;
function BroadcastSystemMessageExA; external user32 name 'BroadcastSystemMessageExA' delayed;
function BroadcastSystemMessageExW; external user32 name 'BroadcastSystemMessageExW' delayed;
function BroadcastSystemMessageEx; external user32 name 'BroadcastSystemMessageEx' + AWSuffix delayed;
function BroadcastSystemMessageA; external user32 name 'BroadcastSystemMessageA' delayed;
function BroadcastSystemMessageW; external user32 name 'BroadcastSystemMessageW' delayed;
function BroadcastSystemMessage; external user32 name 'BroadcastSystemMessage' + AWSuffix delayed;
function RegisterDeviceNotificationA; external user32 name 'RegisterDeviceNotificationA' delayed;
function RegisterDeviceNotificationW; external user32 name 'RegisterDeviceNotificationW' delayed;
function RegisterDeviceNotification; external user32 name 'RegisterDeviceNotification' + AWSuffix delayed;
function UnregisterDeviceNotification; external user32 name 'UnregisterDeviceNotification' delayed;
function PostMessageA; external user32 name 'PostMessageA' delayed;
function PostMessageW; external user32 name 'PostMessageW' delayed;
function PostMessage; external user32 name 'PostMessage' + AWSuffix delayed;
function PostThreadMessageA; external user32 name 'PostThreadMessageA' delayed;
function PostThreadMessageW; external user32 name 'PostThreadMessageW' delayed;
function PostThreadMessage; external user32 name 'PostThreadMessage' + AWSuffix delayed;
function AttachThreadInput; external user32 name 'AttachThreadInput' delayed;
function ReplyMessage; external user32 name 'ReplyMessage' delayed;
function WaitMessage; external user32 name 'WaitMessage' delayed;
function WaitForInputIdle; external user32 name 'WaitForInputIdle' delayed;
function DefWindowProcA; external user32 name 'DefWindowProcA' delayed;
function DefWindowProcW; external user32 name 'DefWindowProcW' delayed;
function DefWindowProc; external user32 name 'DefWindowProc' + AWSuffix delayed;
procedure PostQuitMessage; external user32 name 'PostQuitMessage' delayed;
function CallWindowProcA; external user32 name 'CallWindowProcA' delayed;
function CallWindowProcW; external user32 name 'CallWindowProcW' delayed;
function CallWindowProc; external user32 name 'CallWindowProc' + AWSuffix delayed;
function InSendMessage; external user32 name 'InSendMessage' delayed;
function InSendMessageEx; external user32 name 'InSendMessageEx' delayed;
function GetDoubleClickTime; external user32 name 'GetDoubleClickTime' delayed;
function SetDoubleClickTime; external user32 name 'SetDoubleClickTime' delayed;
function RegisterClassA; external user32 name 'RegisterClassA' delayed;
function RegisterClassW; external user32 name 'RegisterClassW' delayed;
function RegisterClass; external user32 name 'RegisterClass' + AWSuffix delayed;
function UnregisterClassA; external user32 name 'UnregisterClassA' delayed;
function UnregisterClassW; external user32 name 'UnregisterClassW' delayed;
function UnregisterClass; external user32 name 'UnregisterClass' + AWSuffix delayed;
function GetClassInfoA; external user32 name 'GetClassInfoA' delayed;
function GetClassInfoW; external user32 name 'GetClassInfoW' delayed;
function GetClassInfo; external user32 name 'GetClassInfo' + AWSuffix delayed;
function RegisterClassExA; external user32 name 'RegisterClassExA' delayed;
function RegisterClassExW; external user32 name 'RegisterClassExW' delayed;
function RegisterClassEx; external user32 name 'RegisterClassEx' + AWSuffix delayed;
function GetClassInfoExA; external user32 name 'GetClassInfoExA' delayed;
function GetClassInfoExW; external user32 name 'GetClassInfoExW' delayed;
function GetClassInfoEx; external user32 name 'GetClassInfoEx' + AWSuffix delayed;
function CreateWindowExA; external user32 name 'CreateWindowExA' delayed;
function CreateWindowExW; external user32 name 'CreateWindowExW' delayed;
function CreateWindowEx; external user32 name 'CreateWindowEx' + AWSuffix delayed;
function IsWindow; external user32 name 'IsWindow' delayed;
function IsMenu; external user32 name 'IsMenu' delayed;
function IsChild; external user32 name 'IsChild' delayed;
function DestroyWindow; external user32 name 'DestroyWindow' delayed;
function ShowWindow; external user32 name 'ShowWindow' delayed;
function AnimateWindow; external user32 name 'AnimateWindow' delayed;
function UpdateLayeredWindow; external user32 name 'UpdateLayeredWindow' delayed;
function GetLayeredWindowAttributes; external user32 name 'GetLayeredWindowAttributes' delayed;
function PrintWindow; external user32 name 'PrintWindow' delayed;
function SetLayeredWindowAttributes; external user32 name 'SetLayeredWindowAttributes' delayed;
function ShowWindowAsync; external user32 name 'ShowWindowAsync' delayed;
function FlashWindow; external user32 name 'FlashWindow' delayed;
function FlashWindowEx; external user32 name 'FlashWindowEx' delayed;
function ShowOwnedPopups; external user32 name 'ShowOwnedPopups' delayed;
function OpenIcon; external user32 name 'OpenIcon' delayed;
function CloseWindow; external user32 name 'CloseWindow' delayed;
function MoveWindow; external user32 name 'MoveWindow' delayed;
function SetWindowPos; external user32 name 'SetWindowPos' delayed;
function GetWindowPlacement; external user32 name 'GetWindowPlacement' delayed;
function SetWindowPlacement; external user32 name 'SetWindowPlacement' delayed;
function BeginDeferWindowPos; external user32 name 'BeginDeferWindowPos' delayed;
function DeferWindowPos; external user32 name 'DeferWindowPos' delayed;
function EndDeferWindowPos; external user32 name 'EndDeferWindowPos' delayed;
function IsWindowVisible; external user32 name 'IsWindowVisible' delayed;
function IsIconic; external user32 name 'IsIconic' delayed;
function AnyPopup; external user32 name 'AnyPopup' delayed;
function BringWindowToTop; external user32 name 'BringWindowToTop' delayed;
function IsZoomed; external user32 name 'IsZoomed' delayed;
function CreateDialogParamA; external user32 name 'CreateDialogParamA' delayed;
function CreateDialogParamW; external user32 name 'CreateDialogParamW' delayed;
function CreateDialogParam; external user32 name 'CreateDialogParam' + AWSuffix delayed;
function CreateDialogIndirectParamA; external user32 name 'CreateDialogIndirectParamA' delayed;
function CreateDialogIndirectParamW; external user32 name 'CreateDialogIndirectParamW' delayed;
function CreateDialogIndirectParam; external user32 name 'CreateDialogIndirectParam' + AWSuffix delayed;
function DialogBoxParamA; external user32 name 'DialogBoxParamA' delayed;
function DialogBoxParamW; external user32 name 'DialogBoxParamW' delayed;
function DialogBoxParam; external user32 name 'DialogBoxParam' + AWSuffix delayed;
function DialogBoxIndirectParamA; external user32 name 'DialogBoxIndirectParamA' delayed;
function DialogBoxIndirectParamW; external user32 name 'DialogBoxIndirectParamW' delayed;
function DialogBoxIndirectParam; external user32 name 'DialogBoxIndirectParam' + AWSuffix delayed;
function EndDialog; external user32 name 'EndDialog' delayed;
function GetDlgItem; external user32 name 'GetDlgItem' delayed;
function SetDlgItemInt; external user32 name 'SetDlgItemInt' delayed;
function GetDlgItemInt; external user32 name 'GetDlgItemInt' delayed;
function SetDlgItemTextA; external user32 name 'SetDlgItemTextA' delayed;
function SetDlgItemTextW; external user32 name 'SetDlgItemTextW' delayed;
function SetDlgItemText; external user32 name 'SetDlgItemText' + AWSuffix delayed;
function GetDlgItemTextA; external user32 name 'GetDlgItemTextA' delayed;
function GetDlgItemTextW; external user32 name 'GetDlgItemTextW' delayed;
function GetDlgItemText; external user32 name 'GetDlgItemText' + AWSuffix delayed;
function CheckDlgButton; external user32 name 'CheckDlgButton' delayed;
function CheckRadioButton; external user32 name 'CheckRadioButton' delayed;
function IsDlgButtonChecked; external user32 name 'IsDlgButtonChecked' delayed;
function SendDlgItemMessageA; external user32 name 'SendDlgItemMessageA' delayed;
function SendDlgItemMessageW; external user32 name 'SendDlgItemMessageW' delayed;
function SendDlgItemMessage; external user32 name 'SendDlgItemMessage' + AWSuffix delayed;
function GetNextDlgGroupItem; external user32 name 'GetNextDlgGroupItem' delayed;
function GetNextDlgTabItem; external user32 name 'GetNextDlgTabItem' delayed;
function GetDlgCtrlID; external user32 name 'GetDlgCtrlID' delayed;
function GetDialogBaseUnits; external user32 name 'GetDialogBaseUnits' delayed;
function DefDlgProcA; external user32 name 'DefDlgProcA' delayed;
function DefDlgProcW; external user32 name 'DefDlgProcW' delayed;
function DefDlgProc; external user32 name 'DefDlgProc' + AWSuffix delayed;
function CallMsgFilterA; external user32 name 'CallMsgFilterA' delayed;
function CallMsgFilterW; external user32 name 'CallMsgFilterW' delayed;
function CallMsgFilter; external user32 name 'CallMsgFilter' + AWSuffix delayed;
function OpenClipboard; external user32 name 'OpenClipboard' delayed;
function CloseClipboard; external user32 name 'CloseClipboard' delayed;
function GetClipboardSequenceNumber; external user32 name 'GetClipboardSequenceNumber' delayed;
function GetClipboardOwner; external user32 name 'GetClipboardOwner' delayed;
function SetClipboardViewer; external user32 name 'SetClipboardViewer' delayed;
function GetClipboardViewer; external user32 name 'GetClipboardViewer' delayed;
function ChangeClipboardChain; external user32 name 'ChangeClipboardChain' delayed;
function SetClipboardData; external user32 name 'SetClipboardData' delayed;
function GetClipboardData; external user32 name 'GetClipboardData' delayed;
function RegisterClipboardFormatA; external user32 name 'RegisterClipboardFormatA' delayed;
function RegisterClipboardFormatW; external user32 name 'RegisterClipboardFormatW' delayed;
function RegisterClipboardFormat; external user32 name 'RegisterClipboardFormat' + AWSuffix delayed;
function CountClipboardFormats; external user32 name 'CountClipboardFormats' delayed;
function EnumClipboardFormats; external user32 name 'EnumClipboardFormats' delayed;
function GetClipboardFormatNameA; external user32 name 'GetClipboardFormatNameA' delayed;
function GetClipboardFormatNameW; external user32 name 'GetClipboardFormatNameW' delayed;
function GetClipboardFormatName; external user32 name 'GetClipboardFormatName' + AWSuffix delayed;
function EmptyClipboard; external user32 name 'EmptyClipboard' delayed;
function IsClipboardFormatAvailable; external user32 name 'IsClipboardFormatAvailable' delayed;
function GetPriorityClipboardFormat; external user32 name 'GetPriorityClipboardFormat' delayed;
function GetOpenClipboardWindow; external user32 name 'GetOpenClipboardWindow' delayed;
function CharToOemA; external user32 name 'CharToOemA' delayed;
function CharToOemW; external user32 name 'CharToOemW' delayed;
function CharToOem; external user32 name 'CharToOem' + AWSuffix delayed;
function OemToCharA; external user32 name 'OemToCharA' delayed;
function OemToCharW; external user32 name 'OemToCharW' delayed;
function OemToChar; external user32 name 'OemToChar' + AWSuffix delayed;
function CharToOemBuffA; external user32 name 'CharToOemBuffA' delayed;
function CharToOemBuffW; external user32 name 'CharToOemBuffW' delayed;
function CharToOemBuff; external user32 name 'CharToOemBuff' + AWSuffix delayed;
function OemToCharBuffA; external user32 name 'OemToCharBuffA' delayed;
function OemToCharBuffW; external user32 name 'OemToCharBuffW' delayed;
function OemToCharBuff; external user32 name 'OemToCharBuff' + AWSuffix delayed;
function CharUpperA; external user32 name 'CharUpperA' delayed;
function CharUpperW; external user32 name 'CharUpperW' delayed;
function CharUpper; external user32 name 'CharUpper' + AWSuffix delayed;
function CharUpperBuffA; external user32 name 'CharUpperBuffA' delayed;
function CharUpperBuffW; external user32 name 'CharUpperBuffW' delayed;
function CharUpperBuff; external user32 name 'CharUpperBuff' + AWSuffix delayed;
function CharLowerA; external user32 name 'CharLowerA' delayed;
function CharLowerW; external user32 name 'CharLowerW' delayed;
function CharLower; external user32 name 'CharLower' + AWSuffix delayed;
function CharLowerBuffA; external user32 name 'CharLowerBuffA' delayed;
function CharLowerBuffW; external user32 name 'CharLowerBuffW' delayed;
function CharLowerBuff; external user32 name 'CharLowerBuff' + AWSuffix delayed;
function CharNextA; external user32 name 'CharNextA' delayed;
function CharNextW; external user32 name 'CharNextW' delayed;
function CharNext; external user32 name 'CharNext' + AWSuffix delayed;
function CharPrevA; external user32 name 'CharPrevA' delayed;
function CharPrevW; external user32 name 'CharPrevW' delayed;
function CharPrev; external user32 name 'CharPrev' + AWSuffix delayed;
function CharNextExA; external user32 name 'CharNextExA' delayed;
function CharPrevExA; external user32 name 'CharPrevExA' delayed;
function IsCharAlphaA; external user32 name 'IsCharAlphaA' delayed;
function IsCharAlphaW; external user32 name 'IsCharAlphaW' delayed;
function IsCharAlpha; external user32 name 'IsCharAlpha' + AWSuffix delayed;
function IsCharAlphaNumericA; external user32 name 'IsCharAlphaNumericA' delayed;
function IsCharAlphaNumericW; external user32 name 'IsCharAlphaNumericW' delayed;
function IsCharAlphaNumeric; external user32 name 'IsCharAlphaNumeric' + AWSuffix delayed;
function IsCharUpperA; external user32 name 'IsCharUpperA' delayed;
function IsCharUpperW; external user32 name 'IsCharUpperW' delayed;
function IsCharUpper; external user32 name 'IsCharUpper' + AWSuffix delayed;
function IsCharLowerA; external user32 name 'IsCharLowerA' delayed;
function IsCharLowerW; external user32 name 'IsCharLowerW' delayed;
function IsCharLower; external user32 name 'IsCharLower' + AWSuffix delayed;
function SetFocus; external user32 name 'SetFocus' delayed;
function GetActiveWindow; external user32 name 'GetActiveWindow' delayed;
function GetFocus; external user32 name 'GetFocus' delayed;
function GetKBCodePage; external user32 name 'GetKBCodePage' delayed;
function GetKeyState; external user32 name 'GetKeyState' delayed;
function GetAsyncKeyState; external user32 name 'GetAsyncKeyState' delayed;
function GetKeyboardState; external user32 name 'GetKeyboardState' delayed;
function SetKeyboardState; external user32 name 'SetKeyboardState' delayed;
function GetKeyNameTextA; external user32 name 'GetKeyNameTextA' delayed;
function GetKeyNameTextW; external user32 name 'GetKeyNameTextW' delayed;
function GetKeyNameText; external user32 name 'GetKeyNameText' + AWSuffix delayed;
function GetKeyboardType; external user32 name 'GetKeyboardType' delayed;
function ToAscii; external user32 name 'ToAscii' delayed;
function ToAsciiEx; external user32 name 'ToAsciiEx' delayed;
function ToUnicode; external user32 name 'ToUnicode' delayed;
function OemKeyScan; external user32 name 'OemKeyScan' delayed;
function VkKeyScanA; external user32 name 'VkKeyScanA' delayed;
function VkKeyScanW; external user32 name 'VkKeyScanW' delayed;
function VkKeyScan; external user32 name 'VkKeyScan' + AWSuffix delayed;
function VkKeyScanExA; external user32 name 'VkKeyScanExA' delayed;
function VkKeyScanExW; external user32 name 'VkKeyScanExW' delayed;
function VkKeyScanEx; external user32 name 'VkKeyScanEx' + AWSuffix delayed;
procedure keybd_event; external user32 name 'keybd_event' delayed;
procedure mouse_event; external user32 name 'mouse_event' delayed;
function SendInput; external user32 name 'SendInput' delayed;
function GetLastInputInfo; external user32 name 'GetLastInputInfo' delayed;
function MapVirtualKeyA; external user32 name 'MapVirtualKeyA' delayed;
function MapVirtualKeyW; external user32 name 'MapVirtualKeyW' delayed;
function MapVirtualKey; external user32 name 'MapVirtualKey' + AWSuffix delayed;
function MapVirtualKeyExA; external user32 name 'MapVirtualKeyExA' delayed;
function MapVirtualKeyExW; external user32 name 'MapVirtualKeyExW' delayed;
function MapVirtualKeyEx; external user32 name 'MapVirtualKeyEx' + AWSuffix delayed;
function GetInputState; external user32 name 'GetInputState' delayed;
function GetQueueStatus; external user32 name 'GetQueueStatus' delayed;
function GetCapture; external user32 name 'GetCapture' delayed;
function SetCapture; external user32 name 'SetCapture' delayed;
function ReleaseCapture; external user32 name 'ReleaseCapture' delayed;
function MsgWaitForMultipleObjects; external user32 name 'MsgWaitForMultipleObjects' delayed;
function MsgWaitForMultipleObjectsEx; external user32 name 'MsgWaitForMultipleObjectsEx' delayed;
function SetTimer; external user32 name 'SetTimer' delayed;
function KillTimer; external user32 name 'KillTimer' delayed;
function IsWindowUnicode; external user32 name 'IsWindowUnicode' delayed;
function EnableWindow; external user32 name 'EnableWindow' delayed;
function IsWindowEnabled; external user32 name 'IsWindowEnabled' delayed;
function LoadAcceleratorsA; external user32 name 'LoadAcceleratorsA' delayed;
function LoadAcceleratorsW; external user32 name 'LoadAcceleratorsW' delayed;
function LoadAccelerators; external user32 name 'LoadAccelerators' + AWSuffix delayed;
function CreateAcceleratorTableA; external user32 name 'CreateAcceleratorTableA' delayed;
function CreateAcceleratorTableW; external user32 name 'CreateAcceleratorTableW' delayed;
function CreateAcceleratorTable; external user32 name 'CreateAcceleratorTable' + AWSuffix delayed;
function DestroyAcceleratorTable; external user32 name 'DestroyAcceleratorTable' delayed;
function CopyAcceleratorTableA; external user32 name 'CopyAcceleratorTableA' delayed;
function CopyAcceleratorTableW; external user32 name 'CopyAcceleratorTableW' delayed;
function CopyAcceleratorTable; external user32 name 'CopyAcceleratorTable' + AWSuffix delayed;
function TranslateAcceleratorA; external user32 name 'TranslateAcceleratorA' delayed;
function TranslateAcceleratorW; external user32 name 'TranslateAcceleratorW' delayed;
function TranslateAccelerator; external user32 name 'TranslateAccelerator' + AWSuffix delayed;
function GetSystemMetrics; external user32 name 'GetSystemMetrics' delayed;
function LoadMenuA; external user32 name 'LoadMenuAA' delayed;
function LoadMenuW; external user32 name 'LoadMenuWA' delayed;
function LoadMenu; external user32 name 'LoadMenu' + AWSuffix delayed;
function LoadMenuIndirectA; external user32 name 'LoadMenuIndirectA' delayed;
function LoadMenuIndirectW; external user32 name 'LoadMenuIndirectW' delayed;
function LoadMenuIndirect; external user32 name 'LoadMenuIndirect' + AWSuffix delayed;
function GetMenu; external user32 name 'GetMenu' delayed;
function SetMenu; external user32 name 'SetMenu' delayed;
function ChangeMenuA; external user32 name 'ChangeMenuA' delayed;
function ChangeMenuW; external user32 name 'ChangeMenuW' delayed;
function ChangeMenu; external user32 name 'ChangeMenu' + AWSuffix delayed;
function HiliteMenuItem; external user32 name 'HiliteMenuItem' delayed;
function GetMenuStringA; external user32 name 'GetMenuStringA' delayed;
function GetMenuStringW; external user32 name 'GetMenuStringW' delayed;
function GetMenuString; external user32 name 'GetMenuString' + AWSuffix delayed;
function GetMenuState; external user32 name 'GetMenuState' delayed;
function DrawMenuBar; external user32 name 'DrawMenuBar' delayed;
function GetSystemMenu; external user32 name 'GetSystemMenu' delayed;
function CreateMenu; external user32 name 'CreateMenu' delayed;
function CreatePopupMenu; external user32 name 'CreatePopupMenu' delayed;
function DestroyMenu; external user32 name 'DestroyMenu' delayed;
function CheckMenuItem; external user32 name 'CheckMenuItem' delayed;
function EnableMenuItem; external user32 name 'EnableMenuItem' delayed;
function GetSubMenu; external user32 name 'GetSubMenu' delayed;
function GetMenuItemID; external user32 name 'GetMenuItemID' delayed;
function GetMenuItemCount; external user32 name 'GetMenuItemCount' delayed;
function InsertMenuA; external user32 name 'InsertMenuA' delayed;
function InsertMenuW; external user32 name 'InsertMenuW' delayed;
function InsertMenu; external user32 name 'InsertMenu' + AWSuffix delayed;
function AppendMenuA; external user32 name 'AppendMenuA' delayed;
function AppendMenuW; external user32 name 'AppendMenuW' delayed;
function AppendMenu; external user32 name 'AppendMenu' + AWSuffix delayed;
function ModifyMenuA; external user32 name 'ModifyMenuA' delayed;
function ModifyMenuW; external user32 name 'ModifyMenuW' delayed;
function ModifyMenu; external user32 name 'ModifyMenu' + AWSuffix delayed;
function RemoveMenu; external user32 name 'RemoveMenu' delayed;
function DeleteMenu; external user32 name 'DeleteMenu' delayed;
function SetMenuItemBitmaps; external user32 name 'SetMenuItemBitmaps' delayed;
function GetMenuCheckMarkDimensions; external user32 name 'GetMenuCheckMarkDimensions' delayed;
function TrackPopupMenu; external user32 name 'TrackPopupMenu' delayed;
function TrackPopupMenuEx; external user32 name 'TrackPopupMenuEx' delayed;
function GetMenuInfo; external user32 name 'GetMenuInfo' delayed;
function SetMenuInfo; external user32 name 'SetMenuInfo' delayed;
function EndMenu; external user32 name 'EndMenu' delayed;
function InsertMenuItemA; external user32 name 'InsertMenuItemA' delayed;
function InsertMenuItemW; external user32 name 'InsertMenuItemW' delayed;
function InsertMenuItem; external user32 name 'InsertMenuItem' + AWSuffix delayed;
function GetMenuItemInfoA; external user32 name 'GetMenuItemInfoA' delayed;
function GetMenuItemInfoW; external user32 name 'GetMenuItemInfoW' delayed;
function GetMenuItemInfo; external user32 name 'GetMenuItemInfo' + AWSuffix delayed;
function SetMenuItemInfoA; external user32 name 'SetMenuItemInfoA' delayed;
function SetMenuItemInfoW; external user32 name 'SetMenuItemInfoW' delayed;
function SetMenuItemInfo; external user32 name 'SetMenuItemInfo' + AWSuffix delayed;
function GetMenuDefaultItem; external user32 name 'GetMenuDefaultItem' delayed;
function SetMenuDefaultItem; external user32 name 'SetMenuDefaultItem' delayed;
function GetMenuItemRect; external user32 name 'GetMenuItemRect' delayed;
function MenuItemFromPoint; external user32 name 'MenuItemFromPoint' delayed;
function DragObject; external user32 name 'DragObject' delayed;
function DragDetect; external user32 name 'DragDetect' delayed;
function DrawIcon; external user32 name 'DrawIcon' delayed;
function DrawTextA; external user32 name 'DrawTextA' delayed;
function DrawTextW; external user32 name 'DrawTextW' delayed;
function DrawText; external user32 name 'DrawText' + AWSuffix delayed;
function DrawTextExA; external user32 name 'DrawTextExA' delayed;
function DrawTextExW; external user32 name 'DrawTextExW' delayed;
function DrawTextEx; external user32 name 'DrawTextEx' + AWSuffix delayed;
function GrayStringA; external user32 name 'GrayStringA' delayed;
function GrayStringW; external user32 name 'GrayStringW' delayed;
function GrayString; external user32 name 'GrayString' + AWSuffix delayed;
function DrawStateA; external user32 name 'DrawStateA' delayed;
function DrawStateW; external user32 name 'DrawStateW' delayed;
function DrawState; external user32 name 'DrawState' + AWSuffix delayed;
function TabbedTextOutA; external user32 name 'TabbedTextOutA' delayed;
function TabbedTextOutW; external user32 name 'TabbedTextOutW' delayed;
function TabbedTextOut; external user32 name 'TabbedTextOut' + AWSuffix delayed;
function GetTabbedTextExtentA; external user32 name 'GetTabbedTextExtentA' delayed;
function GetTabbedTextExtentW; external user32 name 'GetTabbedTextExtentW' delayed;
function GetTabbedTextExtent; external user32 name 'GetTabbedTextExtent' + AWSuffix delayed;
function UpdateWindow; external user32 name 'UpdateWindow' delayed;
function SetActiveWindow; external user32 name 'SetActiveWindow' delayed;
function GetForegroundWindow; external user32 name 'GetForegroundWindow' delayed;
function PaintDesktop; external user32 name 'PaintDesktop' delayed;
procedure SwitchToThisWindow; external user32 name 'SwitchToThisWindow' delayed;
function SetForegroundWindow; external user32 name 'SetForegroundWindow' delayed;
function AllowSetForegroundWindow; external user32 name 'AllowSetForegroundWindow' delayed;
function LockSetForegroundWindow; external user32 name 'LockSetForegroundWindow' delayed;
function WindowFromDC; external user32 name 'WindowFromDC' delayed;
function GetDC; external user32 name 'GetDC' delayed;
function GetDCEx; external user32 name 'GetDCEx' delayed;
function GetWindowDC; external user32 name 'GetWindowDC' delayed;
function ReleaseDC; external user32 name 'ReleaseDC' delayed;
function BeginPaint; external user32 name 'BeginPaint' delayed;
function EndPaint; external user32 name 'EndPaint' delayed;
function GetUpdateRect; external user32 name 'GetUpdateRect' delayed;
function GetUpdateRgn; external user32 name 'GetUpdateRgn' delayed;
function SetWindowRgn; external user32 name 'SetWindowRgn' delayed;
function GetWindowRgn; external user32 name 'GetWindowRgn' delayed;
function GetWindowRgnBox; external user32 name 'GetWindowRgnBox' delayed;
function ExcludeUpdateRgn; external user32 name 'ExcludeUpdateRgn' delayed;
function InvalidateRect; external user32 name 'InvalidateRect' delayed;
function ValidateRect; external user32 name 'ValidateRect' delayed;
function InvalidateRgn; external user32 name 'InvalidateRgn' delayed;
function ValidateRgn; external user32 name 'ValidateRgn' delayed;
function RedrawWindow; external user32 name 'RedrawWindow' delayed;
function LockWindowUpdate; external user32 name 'LockWindowUpdate' delayed;
function ScrollWindow; external user32 name 'ScrollWindow' delayed;
function ScrollDC; external user32 name 'ScrollDC' delayed;
function ScrollWindowEx; external user32 name 'ScrollWindowEx' delayed;
function SetScrollPos; external user32 name 'SetScrollPos' delayed;
function GetScrollPos; external user32 name 'GetScrollPos' delayed;
function SetScrollRange; external user32 name 'SetScrollRange' delayed;
function GetScrollRange; external user32 name 'GetScrollRange' delayed;
function ShowScrollBar; external user32 name 'ShowScrollBar' delayed;
function EnableScrollBar; external user32 name 'EnableScrollBar' delayed;
function SetPropA; external user32 name 'SetPropA' delayed;
function SetPropW; external user32 name 'SetPropW' delayed;
function SetProp; external user32 name 'SetProp' + AWSuffix delayed;
function GetPropA; external user32 name 'GetPropA' delayed;
function GetPropW; external user32 name 'GetPropW' delayed;
function GetProp; external user32 name 'GetProp' + AWSuffix delayed;
function RemovePropA; external user32 name 'RemovePropA' delayed;
function RemovePropW; external user32 name 'RemovePropW' delayed;
function RemoveProp; external user32 name 'RemoveProp' + AWSuffix delayed;
function EnumPropsExA; external user32 name 'EnumPropsExA' delayed;
function EnumPropsExW; external user32 name 'EnumPropsExW' delayed;
function EnumPropsEx; external user32 name 'EnumPropsEx' + AWSuffix delayed;
function EnumPropsA; external user32 name 'EnumPropsA' delayed;
function EnumPropsW; external user32 name 'EnumPropsW' delayed;
function EnumProps; external user32 name 'EnumProps' + AWSuffix delayed;
function SetWindowTextA; external user32 name 'SetWindowTextA' delayed;
function SetWindowTextW; external user32 name 'SetWindowTextW' delayed;
function SetWindowText; external user32 name 'SetWindowText' + AWSuffix delayed;
function GetWindowTextA; external user32 name 'GetWindowTextA' delayed;
function GetWindowTextW; external user32 name 'GetWindowTextW' delayed;
function GetWindowText; external user32 name 'GetWindowText' + AWSuffix delayed;
function GetWindowTextLengthA; external user32 name 'GetWindowTextLengthA' delayed;
function GetWindowTextLengthW; external user32 name 'GetWindowTextLengthW' delayed;
function GetWindowTextLength; external user32 name 'GetWindowTextLength' + AWSuffix delayed;
function GetClientRect; external user32 name 'GetClientRect' delayed;
function GetWindowRect; external user32 name 'GetWindowRect' delayed;
function AdjustWindowRect; external user32 name 'AdjustWindowRect' delayed;
function AdjustWindowRectEx; external user32 name 'AdjustWindowRectEx' delayed;
function SetWindowContextHelpId; external user32 name 'SetWindowContextHelpId' delayed;
function GetWindowContextHelpId; external user32 name 'GetWindowContextHelpId' delayed;
function SetMenuContextHelpId; external user32 name 'SetMenuContextHelpId' delayed;
function GetMenuContextHelpId; external user32 name 'GetMenuContextHelpId' delayed;
function MessageBoxA; external user32 name 'MessageBoxA' delayed;
function MessageBoxW; external user32 name 'MessageBoxW' delayed;
function MessageBox; external user32 name 'MessageBox' + AWSuffix delayed;
function MessageBoxExA; external user32 name 'MessageBoxExA' delayed;
function MessageBoxExW; external user32 name 'MessageBoxExW' delayed;
function MessageBoxEx; external user32 name 'MessageBoxEx' + AWSuffix delayed;
function MessageBoxIndirectA; external user32 name 'MessageBoxIndirectA' delayed;
function MessageBoxIndirectW; external user32 name 'MessageBoxIndirectW' delayed;
function MessageBoxIndirect; external user32 name 'MessageBoxIndirect' + AWSuffix delayed;
function MessageBeep; external user32 name 'MessageBeep' delayed;
function ShowCursor; external user32 name 'ShowCursor' delayed;
function SetCursorPos; external user32 name 'SetCursorPos' delayed;
function SetCursor; external user32 name 'SetCursor' delayed;
function GetCursorPos; external user32 name 'GetCursorPos' delayed;
function ClipCursor; external user32 name 'ClipCursor' delayed;
function GetClipCursor; external user32 name 'GetClipCursor' delayed;
function GetCursor; external user32 name 'GetCursor' delayed;
function CreateCaret; external user32 name 'CreateCaret' delayed;
function GetCaretBlinkTime; external user32 name 'GetCaretBlinkTime' delayed;
function SetCaretBlinkTime; external user32 name 'SetCaretBlinkTime' delayed;
function DestroyCaret; external user32 name 'DestroyCaret' delayed;
function HideCaret; external user32 name 'HideCaret' delayed;
function ShowCaret; external user32 name 'ShowCaret' delayed;
function SetCaretPos; external user32 name 'SetCaretPos' delayed;
function GetCaretPos; external user32 name 'GetCaretPos' delayed;
function ClientToScreen; external user32 name 'ClientToScreen' delayed;
function ScreenToClient; external user32 name 'ScreenToClient' delayed;
function MapWindowPoints; external user32 name 'MapWindowPoints' delayed;
function WindowFromPoint; external user32 name 'WindowFromPoint' delayed;
function ChildWindowFromPoint; external user32 name 'ChildWindowFromPoint' delayed;
function ChildWindowFromPointEx; external user32 name 'ChildWindowFromPointEx' delayed;
function GetSysColor; external user32 name 'GetSysColor' delayed;
function GetSysColorBrush; external user32 name 'GetSysColorBrush' delayed;
function SetSysColors; external user32 name 'SetSysColors' delayed;
function DrawFocusRect; external user32 name 'DrawFocusRect' delayed;
function FillRect; external user32 name 'FillRect' delayed;
function FrameRect; external user32 name 'FrameRect' delayed;
function InvertRect; external user32 name 'InvertRect' delayed;
function SetRect; external user32 name 'SetRect' delayed;
function SetRectEmpty; external user32 name 'SetRectEmpty' delayed;
function CopyRect; external user32 name 'CopyRect' delayed;
function InflateRect; external user32 name 'InflateRect' delayed;
function IntersectRect; external user32 name 'IntersectRect' delayed;
function UnionRect; external user32 name 'UnionRect' delayed;
function SubtractRect; external user32 name 'SubtractRect' delayed;
function OffsetRect; external user32 name 'OffsetRect' delayed;
function IsRectEmpty; external user32 name 'IsRectEmpty' delayed;
function EqualRect; external user32 name 'EqualRect' delayed;
function PtInRect; external user32 name 'PtInRect' delayed;
function GetWindowWord; external user32 name 'GetWindowWord' delayed;
function SetWindowWord; external user32 name 'SetWindowWord' delayed;
function GetWindowLongA; external user32 name 'GetWindowLongA' delayed;
function GetWindowLongW; external user32 name 'GetWindowLongW' delayed;
function GetWindowLong; external user32 name 'GetWindowLong' + AWSuffix delayed;
function SetWindowLongA; external user32 name 'SetWindowLongA' delayed;
function SetWindowLongW; external user32 name 'SetWindowLongW' delayed;
function SetWindowLong; external user32 name 'SetWindowLong' + AWSuffix delayed;
function GetClassWord; external user32 name 'GetClassWord' delayed;
function SetClassWord; external user32 name 'SetClassWord' delayed;
function GetClassLongA; external user32 name 'GetClassLongA' delayed;
function GetClassLongW; external user32 name 'GetClassLongW' delayed;
function GetClassLong; external user32 name 'GetClassLong' + AWSuffix delayed;
function SetClassLongA; external user32 name 'SetClassLongA' delayed;
function SetClassLongW; external user32 name 'SetClassLongW' delayed;
function SetClassLong; external user32 name 'SetClassLong' + AWSuffix delayed;
function GetProcessDefaultLayout; external user32 name 'GetProcessDefaultLayout' delayed;
function SetProcessDefaultLayout; external user32 name 'SetProcessDefaultLayout' delayed;
function GetDesktopWindow; external user32 name 'GetDesktopWindow' delayed;
function GetParent; external user32 name 'GetParent' delayed;
function SetParent; external user32 name 'SetParent' delayed;
function EnumChildWindows; external user32 name 'EnumChildWindows' delayed;
function FindWindowA; external user32 name 'FindWindowA' delayed;
function FindWindowW; external user32 name 'FindWindowW' delayed;
function FindWindow; external user32 name 'FindWindow' + AWSuffix delayed;
function FindWindowExA; external user32 name 'FindWindowExA' delayed;
function FindWindowExW; external user32 name 'FindWindowExW' delayed;
function FindWindowEx; external user32 name 'FindWindowEx' + AWSuffix delayed;
function GetShellWindow; external user32 name 'GetShellWindow' delayed;
function RegisterShellHookWindow; external user32 name 'RegisterShellHookWindow' delayed;
function DeregisterShellHookWindow; external user32 name 'DeregisterShellHookWindow' delayed;
function EnumWindows; external user32 name 'EnumWindows' delayed;
function EnumThreadWindows; external user32 name 'EnumThreadWindows' delayed;
function GetClassNameA; external user32 name 'GetClassNameA' delayed;
function GetClassNameW; external user32 name 'GetClassNameW' delayed;
function GetClassName; external user32 name 'GetClassName' + AWSuffix delayed;
function GetTopWindow; external user32 name 'GetTopWindow' delayed;
function GetWindowThreadProcessId; external user32 name 'GetWindowThreadProcessId' delayed;
function IsGUIThread; external user32 name 'IsGUIThread' delayed;
function GetLastActivePopup; external user32 name 'GetLastActivePopup' delayed;
function GetWindow; external user32 name 'GetWindow' delayed;
function SetWindowsHookA; external user32 name 'SetWindowsHookA' delayed;
function SetWindowsHookW; external user32 name 'SetWindowsHookW' delayed;
function SetWindowsHook; external user32 name 'SetWindowsHook' + AWSuffix delayed;
function UnhookWindowsHook; external user32 name 'UnhookWindowsHook' delayed;
function SetWindowsHookExA; external user32 name 'SetWindowsHookExA' delayed;
function SetWindowsHookExW; external user32 name 'SetWindowsHookExW' delayed;
function SetWindowsHookEx; external user32 name 'SetWindowsHookEx' + AWSuffix delayed;
function UnhookWindowsHookEx; external user32 name 'UnhookWindowsHookEx' delayed;
function CallNextHookEx; external user32 name 'CallNextHookEx' delayed;
function CheckMenuRadioItem; external user32 name 'CheckMenuRadioItem' delayed;
function LoadBitmapA; external user32 name 'LoadBitmapA' delayed;
function LoadBitmapW; external user32 name 'LoadBitmapW' delayed;
function LoadBitmap; external user32 name 'LoadBitmap' + AWSuffix delayed;
function LoadCursorA; external user32 name 'LoadCursorA' delayed;
function LoadCursorW; external user32 name 'LoadCursorW' delayed;
function LoadCursor; external user32 name 'LoadCursor' + AWSuffix delayed;
function LoadCursorFromFileA; external user32 name 'LoadCursorFromFileA' delayed;
function LoadCursorFromFileW; external user32 name 'LoadCursorFromFileW' delayed;
function LoadCursorFromFile; external user32 name 'LoadCursorFromFile' + AWSuffix delayed;
function CreateCursor; external user32 name 'CreateCursor' delayed;
function DestroyCursor; external user32 name 'DestroyCursor' delayed;
function SetSystemCursor; external user32 name 'SetSystemCursor' delayed;
function LoadIconA; external user32 name 'LoadIconA' delayed;
function LoadIconW; external user32 name 'LoadIconW' delayed;
function LoadIcon; external user32 name 'LoadIcon' + AWSuffix delayed;
function PrivateExtractIconsA; external user32 name 'PrivateExtractIconsA' delayed;
function PrivateExtractIconsW; external user32 name 'PrivateExtractIconsW' delayed;
function PrivateExtractIcons; external user32 name 'PrivateExtractIcons' + AWSuffix delayed;
function CreateIcon; external user32 name 'CreateIcon' delayed;
function DestroyIcon; external user32 name 'DestroyIcon' delayed;
function LookupIconIdFromDirectory; external user32 name 'LookupIconIdFromDirectory' delayed;
function LookupIconIdFromDirectoryEx; external user32 name 'LookupIconIdFromDirectoryEx' delayed;
function CreateIconFromResource; external user32 name 'CreateIconFromResource' delayed;
function CreateIconFromResourceEx; external user32 name 'CreateIconFromResourceEx' delayed;
function LoadImageA; external user32 name 'LoadImageA' delayed;
function LoadImageW; external user32 name 'LoadImageW' delayed;
function LoadImage; external user32 name 'LoadImage' + AWSuffix delayed;
function CopyImage; external user32 name 'CopyImage' delayed;
function DrawIconEx; external user32 name 'DrawIconEx' delayed;
function CreateIconIndirect; external user32 name 'CreateIconIndirect' delayed;
function CopyIcon; external user32 name 'CopyIcon' delayed;
function GetIconInfo; external user32 name 'GetIconInfo' delayed;
function LoadStringA; external user32 name 'LoadStringA' delayed;
function LoadStringW; external user32 name 'LoadStringW' delayed;
function LoadString; external user32 name 'LoadString' + AWSuffix delayed;
function IsDialogMessageA; external user32 name 'IsDialogMessageA' delayed;
function IsDialogMessageW; external user32 name 'IsDialogMessageW' delayed;
function IsDialogMessage; external user32 name 'IsDialogMessage' + AWSuffix delayed;
function MapDialogRect; external user32 name 'MapDialogRect' delayed;
function DlgDirListA; external user32 name 'DlgDirListA' delayed;
function DlgDirListW; external user32 name 'DlgDirListW' delayed;
function DlgDirList; external user32 name 'DlgDirList' + AWSuffix delayed;
function DlgDirSelectExA; external user32 name 'DlgDirSelectExA' delayed;
function DlgDirSelectExW; external user32 name 'DlgDirSelectExW' delayed;
function DlgDirSelectEx; external user32 name 'DlgDirSelectEx' + AWSuffix delayed;
function DlgDirListComboBoxA; external user32 name 'DlgDirListComboBoxA' delayed;
function DlgDirListComboBoxW; external user32 name 'DlgDirListComboBoxW' delayed;
function DlgDirListComboBox; external user32 name 'DlgDirListComboBox' + AWSuffix delayed;
function DlgDirSelectComboBoxExA; external user32 name 'DlgDirSelectComboBoxExA' delayed;
function DlgDirSelectComboBoxExW; external user32 name 'DlgDirSelectComboBoxExW' delayed;
function DlgDirSelectComboBoxEx; external user32 name 'DlgDirSelectComboBoxEx' + AWSuffix delayed;
function SetScrollInfo; external user32 name 'SetScrollInfo' delayed;
function GetScrollInfo; external user32 name 'GetScrollInfo' delayed;
function DefFrameProcA; external user32 name 'DefFrameProcA' delayed;
function DefFrameProcW; external user32 name 'DefFrameProcW' delayed;
function DefFrameProc; external user32 name 'DefFrameProc' + AWSuffix delayed;
function DefMDIChildProcA; external user32 name 'DefMDIChildProcA' delayed;
function DefMDIChildProcW; external user32 name 'DefMDIChildProcW' delayed;
function DefMDIChildProc; external user32 name 'DefMDIChildProc' + AWSuffix delayed;
function TranslateMDISysAccel; external user32 name 'TranslateMDISysAccel' delayed;
function ArrangeIconicWindows; external user32 name 'ArrangeIconicWindows' delayed;
function CreateMDIWindowA; external user32 name 'CreateMDIWindowA' delayed;
function CreateMDIWindowW; external user32 name 'CreateMDIWindowW' delayed;
function CreateMDIWindow; external user32 name 'CreateMDIWindow' + AWSuffix delayed;
function TileWindows; external user32 name 'TileWindows' delayed;
function CascadeWindows; external user32 name 'CascadeWindows' delayed;
function WinHelpA; external user32 name 'WinHelpA' delayed;
function WinHelpW; external user32 name 'WinHelpW' delayed;
function WinHelp; external user32 name 'WinHelp' + AWSuffix delayed;
function GetGuiResources; external user32 name 'GetGuiResources' delayed;
function ChangeDisplaySettingsA; external user32 name 'ChangeDisplaySettingsA' delayed;
function ChangeDisplaySettingsW; external user32 name 'ChangeDisplaySettingsW' delayed;
function ChangeDisplaySettings; external user32 name 'ChangeDisplaySettings' + AWSuffix delayed;
function ChangeDisplaySettingsExA; external user32 name 'ChangeDisplaySettingsExA' delayed;
function ChangeDisplaySettingsExW; external user32 name 'ChangeDisplaySettingsExW' delayed;
function ChangeDisplaySettingsEx; external user32 name 'ChangeDisplaySettingsEx' + AWSuffix delayed;
function EnumDisplaySettingsA; external user32 name 'EnumDisplaySettingsA' delayed;
function EnumDisplaySettingsW; external user32 name 'EnumDisplaySettingsW' delayed;
function EnumDisplaySettings; external user32 name 'EnumDisplaySettings' + AWSuffix delayed;
function EnumDisplaySettingsExA; external user32 name 'EnumDisplaySettingsExA' delayed;
function EnumDisplaySettingsExW; external user32 name 'EnumDisplaySettingsExW' delayed;
function EnumDisplaySettingsEx; external user32 name 'EnumDisplaySettingsEx' + AWSuffix delayed;
function EnumDisplayDevicesA; external user32 name 'EnumDisplayDevicesA' delayed;
function EnumDisplayDevicesW; external user32 name 'EnumDisplayDevicesW' delayed;
function EnumDisplayDevices; external user32 name 'EnumDisplayDevices' + AWSuffix delayed;
function SystemParametersInfoA; external user32 name 'SystemParametersInfoA' delayed;
function SystemParametersInfoW; external user32 name 'SystemParametersInfoW' delayed;
function SystemParametersInfo; external user32 name 'SystemParametersInfo' + AWSuffix delayed;
procedure SetDebugErrorLevel; external user32 name 'SetDebugErrorLevel' delayed;
procedure SetLastErrorEx; external user32 name 'SetLastErrorEx' delayed;
function InternalGetWindowText; external user32 name 'InternalGetWindowText' delayed;
function EndTask; external user32 name 'EndTask' delayed;
function MonitorFromPoint; external user32 name 'MonitorFromPoint' delayed;
function MonitorFromRect; external user32 name 'MonitorFromRect' delayed;
function MonitorFromWindow; external user32 name 'MonitorFromWindow' delayed;
function GetMonitorInfoA; external user32 name 'GetMonitorInfoA' delayed;
function GetMonitorInfoW; external user32 name 'GetMonitorInfoW' delayed;
function GetMonitorInfo; external user32 name 'GetMonitorInfo' + AWSuffix delayed;
function EnumDisplayMonitors; external user32 name 'EnumDisplayMonitors' delayed;
...
function IsWinEventHookInstalled; external user32 name 'IsWinEventHookInstalled' delayed;
...
function GetWindowModuleFileName; external user32 name 'GetWindowModuleFileName' + AWSuffix delayed;
function GetCursorInfo; external user32 name 'GetCursorInfo' delayed;
function GetWindowInfo; external user32 name 'GetWindowInfo' delayed;
function GetTitleBarInfo; external user32 name 'GetTitleBarInfo' delayed;
function GetMenuBarInfo; external user32 name 'GetMenuBarInfo' delayed;
function GetScrollBarInfo; external user32 name 'GetScrollBarInfo' delayed;
function GetComboBoxInfo; external user32 name 'GetComboBoxInfo' delayed;
function GetAncestor; external user32 name 'GetAncestor' delayed;
function RealChildWindowFromPoint; external user32 name 'RealChildWindowFromPoint' delayed;
function RealGetWindowClassA; external user32 name 'RealGetWindowClassA' delayed;
function RealGetWindowClassW; external user32 name 'RealGetWindowClassW' delayed;
function RealGetWindowClass; external user32 name 'RealGetWindowClass' + AWSuffix delayed;
function GetAltTabInfoA; external user32 name 'GetAltTabInfoA' delayed;
function GetAltTabInfoW; external user32 name 'GetAltTabInfoW' delayed;
function GetAltTabInfo; external user32 name 'GetAltTabInfo' + AWSuffix delayed;
function GetListBoxInfo; external user32 name 'GetListBoxInfo' delayed;
function LockWorkStation; external user32 name 'LockWorkStation' delayed;
function UserHandleGrantAccess; external user32 name 'UserHandleGrantAccess' delayed;
function GetRawInputData; external user32 name 'GetRawInputData' delayed;
function GetRawInputDeviceInfoA; external user32 name 'GetRawInputDeviceInfoA' delayed;
function GetRawInputDeviceInfoW; external user32 name 'GetRawInputDeviceInfoW' delayed;
function GetRawInputDeviceInfo; external user32 name 'GetRawInputDeviceInfo' + AWSuffix delayed;
function GetRawInputBuffer; external user32 name 'GetRawInputBuffer' delayed;
function RegisterRawInputDevices; external user32 name 'RegisterRawInputDevices' delayed;
function GetRegisteredRawInputDevices; external user32 name 'GetRegisteredRawInputDevices' delayed;
function GetRawInputDeviceList; external user32 name 'GetRawInputDeviceList' delayed;
function DefRawInputProc; external user32 name 'DefRawInputProc' delayed;
