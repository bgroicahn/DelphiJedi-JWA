...
function AuthzAccessCheck; external authzlib name 'AuthzAccessCheck' delayed;
function AuthzCachedAccessCheck; external authzlib name 'AuthzCachedAccessCheck' delayed;
function AuthzOpenObjectAudit; external authzlib name 'AuthzOpenObjectAudit' delayed;
function AuthzFreeHandle; external authzlib name 'AuthzFreeHandle' delayed;
function AuthzInitializeResourceManager; external authzlib name 'AuthzInitializeResourceManager' delayed;
function AuthzFreeResourceManager; external authzlib name 'AuthzFreeResourceManager' delayed;
function AuthzInitializeContextFromToken; external authzlib name 'AuthzInitializeContextFromToken' delayed;
function AuthzInitializeContextFromSid; external authzlib name 'AuthzInitializeContextFromSid' delayed;
function AuthzInitializeContextFromAuthzContext; external authzlib name 'AuthzInitializeContextFromAuthzContext' delayed;
function AuthzAddSidsToContext; external authzlib name 'AuthzAddSidsToContext' delayed;
function AuthzGetInformationFromContext; external authzlib name 'AuthzGetInformationFromContext' delayed;
function AuthzFreeContext; external authzlib name 'AuthzFreeContext' delayed;
function AuthzInitializeObjectAccessAuditEvent; external authzlib name 'AuthzInitializeObjectAccessAuditEvent' delayed;
function AuthzInitializeObjectAccessAuditEvent2; external authzlib name 'AuthzInitializeObjectAccessAuditEvent2' delayed;
function AuthzGetInformationFromAuditEvent; external authzlib name 'AuthzGetInformationFromAuditEvent' delayed;
function AuthzFreeAuditEvent; external authzlib name 'AuthzFreeAuditEvent' delayed;
