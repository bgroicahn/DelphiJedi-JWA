...
function WNetAddConnectionA; external mpr name 'WNetAddConnectionA' delayed;
function WNetAddConnectionW; external mpr name 'WNetAddConnectionW' delayed;
function WNetAddConnection; external mpr name 'WNetAddConnection' + AWSuffix delayed;
function WNetAddConnection2A; external mpr name 'WNetAddConnection2A' delayed;
function WNetAddConnection2W; external mpr name 'WNetAddConnection2W' delayed;
function WNetAddConnection2; external mpr name 'WNetAddConnection2' + AWSuffix delayed;
function WNetAddConnection3A; external mpr name 'WNetAddConnection3A' delayed;
function WNetAddConnection3W; external mpr name 'WNetAddConnection3W' delayed;
function WNetAddConnection3; external mpr name 'WNetAddConnection3' + AWSuffix delayed;
function WNetCancelConnectionA; external mpr name 'WNetCancelConnectionA' delayed;
function WNetCancelConnectionW; external mpr name 'WNetCancelConnectionW' delayed;
function WNetCancelConnection; external mpr name 'WNetCancelConnection' + AWSuffix delayed;
function WNetCancelConnection2A; external mpr name 'WNetCancelConnection2A' delayed;
function WNetCancelConnection2W; external mpr name 'WNetCancelConnection2W' delayed;
function WNetCancelConnection2; external mpr name 'WNetCancelConnection2' + AWSuffix delayed;
function WNetGetConnectionA; external mpr name 'WNetGetConnectionA' delayed;
function WNetGetConnectionW; external mpr name 'WNetGetConnectionW' delayed;
function WNetGetConnection; external mpr name 'WNetGetConnection' + AWSuffix delayed;
{WNetRestoreConnectionA is no more available
See bug tracker
http://sourceforge.net/tracker/index.php?func=detail&aid=1846980&group_id=121894&atid=694029
function WNetRestoreConnectionA; external mpr name 'WNetRestoreConnectionA' delayed;
}
{$IFNDEF WINVISTA_UP}
function WNetRestoreConnectionW; external mpr name 'WNetRestoreConnectionW' delayed;
function WNetRestoreConnection; external mpr name 'WNetRestoreConnection' +'A'{+ AWSuffix};
{$ENDIF WINVISTA_UP}
function WNetUseConnectionA; external mpr name 'WNetUseConnectionA' delayed;
function WNetUseConnectionW; external mpr name 'WNetUseConnectionW' delayed;
function WNetUseConnection; external mpr name 'WNetUseConnection' + AWSuffix delayed;
function WNetConnectionDialog; external mpr name 'WNetConnectionDialog' delayed;
function WNetDisconnectDialog; external mpr name 'WNetDisconnectDialog' delayed;
function WNetConnectionDialog1A; external mpr name 'WNetConnectionDialog1A' delayed;
function WNetConnectionDialog1W; external mpr name 'WNetConnectionDialog1W' delayed;
function WNetConnectionDialog1; external mpr name 'WNetConnectionDialog1' + AWSuffix delayed;
function WNetDisconnectDialog1A; external mpr name 'WNetDisconnectDialog1A' delayed;
function WNetDisconnectDialog1W; external mpr name 'WNetDisconnectDialog1W' delayed;
function WNetDisconnectDialog1; external mpr name 'WNetDisconnectDialog1' + AWSuffix delayed;
function WNetOpenEnumA; external mpr name 'WNetOpenEnumA' delayed;
function WNetOpenEnumW; external mpr name 'WNetOpenEnumW' delayed;
function WNetOpenEnum; external mpr name 'WNetOpenEnum' + AWSuffix delayed;
function WNetEnumResourceA; external mpr name 'WNetEnumResourceA' delayed;
function WNetEnumResourceW; external mpr name 'WNetEnumResourceW' delayed;
function WNetEnumResource; external mpr name 'WNetEnumResource' + AWSuffix delayed;
function WNetCloseEnum; external mpr name 'WNetCloseEnum' delayed;
function WNetGetResourceParentA; external mpr name 'WNetGetResourceParentA' delayed;
function WNetGetResourceParentW; external mpr name 'WNetGetResourceParentW' delayed;
function WNetGetResourceParent; external mpr name 'WNetGetResourceParent' + AWSuffix delayed;
function WNetGetResourceInformationA; external mpr name 'WNetGetResourceInformationA' delayed;
function WNetGetResourceInformationW; external mpr name 'WNetGetResourceInformationW' delayed;
function WNetGetResourceInformation; external mpr name 'WNetGetResourceInformation' + AWSuffix delayed;
function WNetGetUniversalNameA; external mpr name 'WNetGetUniversalNameA' delayed;
function WNetGetUniversalNameW; external mpr name 'WNetGetUniversalNameW' delayed;
function WNetGetUniversalName; external mpr name 'WNetGetUniversalName' + AWSuffix delayed;
function WNetGetUserA; external mpr name 'WNetGetUserA' delayed;
function WNetGetUserW; external mpr name 'WNetGetUserW' delayed;
function WNetGetUser; external mpr name 'WNetGetUser' + AWSuffix delayed;
function WNetGetProviderNameA; external mpr name 'WNetGetProviderNameA' delayed;
function WNetGetProviderNameW; external mpr name 'WNetGetProviderNameW' delayed;
function WNetGetProviderName; external mpr name 'WNetGetProviderName' + AWSuffix delayed;
function WNetGetNetworkInformationA; external mpr name 'WNetGetNetworkInformationA' delayed;
function WNetGetNetworkInformationW; external mpr name 'WNetGetNetworkInformationW' delayed;
function WNetGetNetworkInformation; external mpr name 'WNetGetNetworkInformation' + AWSuffix delayed;
function WNetGetLastErrorA; external mpr name 'WNetGetLastErrorA' delayed;
function WNetGetLastErrorW; external mpr name 'WNetGetLastErrorW' delayed;
function WNetGetLastError; external mpr name 'WNetGetLastError' + AWSuffix delayed;
function MultinetGetConnectionPerformanceA; external mpr name 'MultinetGetConnectionPerformanceA' delayed;
function MultinetGetConnectionPerformanceW; external mpr name 'MultinetGetConnectionPerformanceW' delayed;
function MultinetGetConnectionPerformance; external mpr name 'MultinetGetConnectionPerformance' + AWSuffix delayed;
