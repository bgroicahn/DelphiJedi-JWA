...
function DhcpGetVersion; external dhcplib name 'DhcpGetVersion' delayed;
function DhcpSetServerBindingInfo; external dhcplib name 'DhcpSetServerBindingInfo' delayed;
function DhcpGetServerBindingInfo; external dhcplib name 'DhcpGetServerBindingInfo' delayed;
function DhcpCreateClientInfo; external dhcplib name 'DhcpCreateClientInfo' delayed;
function DhcpSetClientInfo; external dhcplib name 'DhcpSetClientInfo' delayed;
function DhcpGetClientInfo; external dhcplib name 'DhcpGetClientInfo' delayed;
function DhcpDeleteClientInfo; external dhcplib name 'DhcpDeleteClientInfo' delayed;
function DhcpEnumSubnetClients; external dhcplib name 'DhcpEnumSubnetClients' delayed;
function DhcpEnumSubnets; external dhcplib name 'DhcpEnumSubnets' delayed;
function DhcpGetSubnetInfo; external dhcplib name 'DhcpGetSubnetInfo' delayed;
function DhcpGetOptionValue; external dhcplib name 'DhcpGetOptionValue' delayed;
procedure DhcpRpcFreeMemory; external dhcplib name 'DhcpRpcFreeMemory' delayed;
