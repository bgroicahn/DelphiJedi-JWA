...
function WTSStopRemoteControlSession; external wtsapi name 'WTSStopRemoteControlSession' delayed;
function WTSStartRemoteControlSessionW; external wtsapi name 'WTSStartRemoteControlSessionW' delayed;
function WTSStartRemoteControlSessionA; external wtsapi name 'WTSStartRemoteControlSessionA' delayed;
function WTSConnectSessionA; external wtsapi name 'WTSConnectSessionA' delayed;
function WTSConnectSessionW; external wtsapi name 'WTSConnectSessionW' delayed;
function WTSConnectSession; external wtsapi name 'WTSConnectSession' + AWSuffix delayed;
function WTSStartRemoteControlSession; external wtsapi name 'WTSStartRemoteControlSession' + AWSuffix delayed;
function WTSEnumerateServersA; external wtsapi name 'WTSEnumerateServersA' delayed;
function WTSEnumerateServersW; external wtsapi name 'WTSEnumerateServersW' delayed;
function WTSEnumerateServers; external wtsapi name 'WTSEnumerateServers' + AWSuffix delayed;
function WTSOpenServerA; external wtsapi name 'WTSOpenServerA' delayed;
function WTSOpenServerW; external wtsapi name 'WTSOpenServerW' delayed;
function WTSOpenServer; external wtsapi name 'WTSOpenServer' + AWSuffix delayed;
procedure WTSCloseServer; external wtsapi name 'WTSCloseServer' delayed;
function WTSEnumerateSessionsA; external wtsapi name 'WTSEnumerateSessionsA' delayed;
function WTSEnumerateSessionsW; external wtsapi name 'WTSEnumerateSessionsW' delayed;
function WTSEnumerateSessions; external wtsapi name 'WTSEnumerateSessions' + AWSuffix delayed;
function WTSEnumerateProcessesA; external wtsapi name 'WTSEnumerateProcessesA' delayed;
function WTSEnumerateProcessesW; external wtsapi name 'WTSEnumerateProcessesW' delayed;
function WTSEnumerateProcesses; external wtsapi name 'WTSEnumerateProcesses' + AWSuffix delayed;
function WTSTerminateProcess; external wtsapi name 'WTSTerminateProcess' delayed;
function WTSQuerySessionInformationA; external wtsapi name 'WTSQuerySessionInformationA' delayed;
function WTSQuerySessionInformationW; external wtsapi name 'WTSQuerySessionInformationW' delayed;
function WTSQuerySessionInformation; external wtsapi name 'WTSQuerySessionInformation' + AWSuffix delayed;
function WTSQueryUserConfigA; external wtsapi name 'WTSQueryUserConfigA' delayed;
function WTSQueryUserConfigW; external wtsapi name 'WTSQueryUserConfigW' delayed;
function WTSQueryUserConfig; external wtsapi name 'WTSQueryUserConfig' + AWSuffix delayed;
function WTSSetUserConfigA; external wtsapi name 'WTSSetUserConfigA' delayed;
function WTSSetUserConfigW; external wtsapi name 'WTSSetUserConfigW' delayed;
function WTSSetUserConfig; external wtsapi name 'WTSSetUserConfig' + AWSuffix delayed;
function WTSSendMessageA; external wtsapi name 'WTSSendMessageA' delayed;
function WTSSendMessageW; external wtsapi name 'WTSSendMessageW' delayed;
function WTSSendMessage; external wtsapi name 'WTSSendMessage' + AWSuffix delayed;
function WTSDisconnectSession; external wtsapi name 'WTSDisconnectSession' delayed;
function WTSLogoffSession; external wtsapi name 'WTSLogoffSession' delayed;
function WTSShutdownSystem; external wtsapi name 'WTSShutdownSystem' delayed;
function WTSWaitSystemEvent; external wtsapi name 'WTSWaitSystemEvent' delayed;
function WTSVirtualChannelOpen; external wtsapi name 'WTSVirtualChannelOpen' delayed;
function WTSVirtualChannelOpenEx; external wtsapi name 'WTSVirtualChannelOpenEx' delayed;
function WTSVirtualChannelClose; external wtsapi name 'WTSVirtualChannelClose' delayed;
function WTSVirtualChannelRead; external wtsapi name 'WTSVirtualChannelRead' delayed;
function WTSVirtualChannelWrite; external wtsapi name 'WTSVirtualChannelWrite' delayed;
function WTSVirtualChannelPurgeInput; external wtsapi name 'WTSVirtualChannelPurgeInput' delayed;
function WTSVirtualChannelPurgeOutput; external wtsapi name 'WTSVirtualChannelPurgeOutput' delayed;
function WTSVirtualChannelQuery; external wtsapi name 'WTSVirtualChannelQuery' delayed;
procedure WTSFreeMemory; external wtsapi name 'WTSFreeMemory' delayed;
function WTSRegisterSessionNotification; external wtsapi name 'WTSRegisterSessionNotification' delayed;
function WTSUnRegisterSessionNotification; external wtsapi name 'WTSUnRegisterSessionNotification' delayed;
function WTSRegisterSessionNotificationEx; external wtsapi name 'WTSRegisterSessionNotificationEx' delayed;
function WTSUnRegisterSessionNotificationEx; external wtsapi name 'WTSUnRegisterSessionNotificationEx' delayed;
function WTSQueryUserToken; external wtsapi name 'WTSQueryUserToken' delayed;
