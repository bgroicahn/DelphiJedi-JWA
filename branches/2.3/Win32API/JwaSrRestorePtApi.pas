...
function SRSetRestorePointA; external srclient name 'SRSetRestorePointA' delayed;
function SRSetRestorePointW; external srclient name 'SRSetRestorePointW' delayed;
function SRSetRestorePoint; external srclient name 'SRSetRestorePointW' + AWSuffix delayed;
function SRRemoveRestorePoint; external srclient name 'SRRemoveRestorePoint' delayed;
