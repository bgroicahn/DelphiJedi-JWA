...
function GetUserNameExA; external secur32 name 'GetUserNameExA' delayed;
function GetUserNameExW; external secur32 name 'GetUserNameExW' delayed;
function GetUserNameEx; external secur32 name 'GetUserNameEx' + AWSuffix delayed;
function GetComputerObjectNameA; external secur32 name 'GetComputerObjectNameA' delayed;
function GetComputerObjectNameW; external secur32 name 'GetComputerObjectNameW' delayed;
function GetComputerObjectName; external secur32 name 'GetComputerObjectName' + AWSuffix delayed;
function TranslateNameA; external secur32 name 'TranslateNameA' delayed;
function TranslateNameW; external secur32 name 'TranslateNameW' delayed;
function TranslateName; external secur32 name 'TranslateName' + AWSuffix delayed;
