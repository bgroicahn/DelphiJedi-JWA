...
function WinVerifyTrust; external wintrust name 'WinVerifyTrust' delayed;
function WTHelperGetProvSignerFromChain; external wintrust name 'WTHelperGetProvSignerFromChain' delayed;
function WTHelperGetProvCertFromChain; external wintrust name 'WTHelperGetProvCertFromChain' delayed;
function WTHelperProvDataFromStateData; external wintrust name 'WTHelperProvDataFromStateData' delayed;
function WTHelperGetProvPrivateDataFromChain; external wintrust name 'WTHelperGetProvPrivateDataFromChain' delayed;
function WTHelperCertIsSelfSigned; external wintrust name 'WTHelperCertIsSelfSigned' delayed;
function WTHelperCertCheckValidSignature; external wintrust name 'WTHelperCertCheckValidSignature' delayed;
