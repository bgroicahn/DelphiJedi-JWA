...
procedure RtlCaptureContext; external ntdll name 'RtlCaptureContext' delayed;
function RtlCompareMemory; external ntdll name 'RtlCompareMemory' delayed;
function VerSetConditionMask; external kernel32 name 'VerSetConditionMask' delayed;

procedure RtlInitializeSListHead; external 'ntdll.dll' name 'RtlInitializeSListHead' delayed;

function RtlFirstEntrySList; external 'ntdll.dll' name 'RtlFirstEntrySList' delayed;
function RtlInterlockedPopEntrySList; external 'ntdll.dll' name 'RtlInterlockedPopEntrySList' delayed;
{$IFNDEF JWA_INCLUDEMODE}
function RtlInterlockedPushEntrySList; external 'ntdll.dll' name 'RtlInterlockedPushEntrySList' delayed;
{$ENDIF JWA_INCLUDEMODE}

function RtlInterlockedFlushSList; external 'ntdll.dll' name 'RtlInterlockedFlushSList';
function RtlQueryDepthSList; external 'ntdll.dll' name 'RtlQueryDepthSList' delayed;

{$IFDEF WINVISTA_UP}
function AddMandatoryAce(pAcl: PACL; dwAceRevision, AceFlags, MandatoryPolicy: DWORD;
    pLabelSid: PSID): BOOL; stdcall; external advapi32 name 'AddMandatoryAce' delayed;
