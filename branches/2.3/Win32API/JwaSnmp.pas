...
function SnmpUtilOidCpy; external snmpapilib name 'SnmpUtilOidCpy' delayed;
function SnmpUtilOidAppend; external snmpapilib name 'SnmpUtilOidAppend' delayed;
function SnmpUtilOidNCmp; external snmpapilib name 'SnmpUtilOidNCmp' delayed;
function SnmpUtilOidCmp; external snmpapilib name 'SnmpUtilOidCmp' delayed;
procedure SnmpUtilOidFree; external snmpapilib name 'SnmpUtilOidFree' delayed;
function SnmpUtilOctetsCmp; external snmpapilib name 'SnmpUtilOctetsCmp' delayed;
function SnmpUtilOctetsNCmp; external snmpapilib name 'SnmpUtilOctetsNCmp' delayed;
function SnmpUtilOctetsCpy; external snmpapilib name 'SnmpUtilOctetsCpy' delayed;
procedure SnmpUtilOctetsFree; external snmpapilib name 'SnmpUtilOctetsFree' delayed;
function SnmpUtilAsnAnyCpy; external snmpapilib name 'SnmpUtilAsnAnyCpy' delayed;
procedure SnmpUtilAsnAnyFree; external snmpapilib name 'SnmpUtilAsnAnyFree' delayed;
function SnmpUtilVarBindCpy; external snmpapilib name 'SnmpUtilVarBindCpy' delayed;
procedure SnmpUtilVarBindFree; external snmpapilib name 'SnmpUtilVarBindFree' delayed;
function SnmpUtilVarBindListCpy; external snmpapilib name 'SnmpUtilVarBindListCpy' delayed;
procedure SnmpUtilVarBindListFree; external snmpapilib name 'SnmpUtilVarBindListFree' delayed;
procedure SnmpUtilMemFree; external snmpapilib name 'SnmpUtilMemFree' delayed;
function SnmpUtilMemAlloc; external snmpapilib name 'SnmpUtilMemAlloc' delayed;
function SnmpUtilMemReAlloc; external snmpapilib name 'SnmpUtilMemReAlloc' delayed;
function SnmpUtilOidToA; external snmpapilib name 'SnmpUtilOidToA' delayed;
function SnmpUtilIdsToA; external snmpapilib name 'SnmpUtilIdsToA' delayed;
procedure SnmpUtilPrintOid; external snmpapilib name 'SnmpUtilPrintOid' delayed;
procedure SnmpUtilPrintAsnAny; external snmpapilib name 'SnmpUtilPrintAsnAny' delayed;
function SnmpSvcGetUptime; external snmpapilib name 'SnmpSvcGetUptime' delayed;
procedure SnmpSvcSetLogLevel; external snmpapilib name 'SnmpSvcSetLogLevel' delayed;
procedure SnmpSvcSetLogType; external snmpapilib name 'SnmpSvcSetLogType' delayed;
procedure SnmpUtilDbgPrint; external snmpapilib name 'SnmpUtilDbgPrint' delayed;
{$IFNDEF SNMPSTRICT}
function SNMP_oidcpy; external snmpapilib name 'SnmpUtilOidCpy' delayed;
function SNMP_oidappend; external snmpapilib name 'SnmpUtilOidAppend' delayed;
function SNMP_oidncmp; external snmpapilib name 'SnmpUtilOidNCmp' delayed;
function SNMP_oidcmp; external snmpapilib name 'SnmpUtilOidCmp' delayed;
procedure SNMP_oidfree; external snmpapilib name 'SnmpUtilOidFree' delayed;
function SNMP_CopyVarBind; external snmpapilib name 'SnmpUtilVarBindCpy' delayed;
procedure SNMP_FreeVarBind; external snmpapilib name 'SnmpUtilVarBindFree' delayed;
function SNMP_CopyVarBindList; external snmpapilib name 'SnmpUtilVarBindListCpy' delayed;
procedure SNMP_FreeVarBindList; external snmpapilib name 'SnmpUtilVarBindListFree' delayed;
procedure SNMP_printany; external snmpapilib name 'SnmpUtilPrintAsnAny' delayed;
procedure SNMP_free; external snmpapilib name 'SnmpUtilMemFree' delayed;
function SNMP_malloc; external snmpapilib name 'SnmpUtilMemAlloc' delayed;
function SNMP_realloc; external snmpapilib name 'SnmpUtilMemReAlloc' delayed;
procedure SNMP_DBG_free; external snmpapilib name 'SnmpUtilMemFree' delayed;
function SNMP_DBG_malloc; external snmpapilib name 'SnmpUtilMemAlloc' delayed;
function SNMP_DBG_realloc; external snmpapilib name 'SnmpUtilMemReAlloc' delayed;
{$ENDIF !SNMPSTRICT}
