...
function DwmDefWindowProc; external dwmlib name 'DwmDefWindowProc' delayed;
function DwmEnableBlurBehindWindow; external dwmlib name 'DwmEnableBlurBehindWindow' delayed;
function DwmEnableComposition; external dwmlib name 'DwmEnableComposition' delayed;
function DwmEnableMMCSS; external dwmlib name 'DwmEnableMMCSS' delayed;
function DwmExtendFrameIntoClientArea; external dwmlib name 'DwmExtendFrameIntoClientArea' delayed;
function DwmGetColorizationColor; external dwmlib name 'DwmGetColorizationColor' delayed;
function DwmGetCompositionTimingInfo; external dwmlib name 'DwmGetCompositionTimingInfo' delayed;
function DwmGetWindowAttribute; external dwmlib name 'DwmGetWindowAttribute' delayed;
function DwmIsCompositionEnabled; external dwmlib name 'DwmIsCompositionEnabled' delayed;
function DwmModifyPreviousDxFrameDuration; external dwmlib name 'DwmModifyPreviousDxFrameDuration' delayed;
function DwmQueryThumbnailSourceSize; external dwmlib name 'DwmQueryThumbnailSourceSize' delayed;
function DwmRegisterThumbnail; external dwmlib name 'DwmRegisterThumbnail' delayed;
function DwmSetDxFrameDuration; external dwmlib name 'DwmSetDxFrameDuration' delayed;
function DwmSetPresentParameters; external dwmlib name 'DwmSetPresentParameters' delayed;
function DwmSetWindowAttribute; external dwmlib name 'DwmSetWindowAttribute' delayed;
function DwmUnregisterThumbnail; external dwmlib name 'DwmUnregisterThumbnail' delayed;
function DwmUpdateThumbnailProperties; external dwmlib name 'DwmUpdateThumbnailProperties' delayed;
function DwmAttachMilContent; external dwmlib name 'DwmAttachMilContent' delayed;
function DwmDetachMilContent; external dwmlib name 'DwmDetachMilContent' delayed;
function DwmFlush; external dwmlib name 'DwmFlush' delayed;
function DwmGetGraphicsStreamTransformHint; external dwmlib name 'DwmGetGraphicsStreamTransformHint' delayed;
function DwmGetGraphicsStreamClient; external dwmlib name 'DwmGetGraphicsStreamClient' delayed;
function DwmGetTransportAttributes; external dwmlib name 'DwmGetTransportAttributes' delayed;
