...
function NetShareAdd; external netapi32 name 'NetShareAdd' delayed;
function NetShareEnum; external netapi32 name 'NetShareEnum' delayed;
function NetShareEnumSticky; external netapi32 name 'NetShareEnumSticky' delayed;
function NetShareGetInfo; external netapi32 name 'NetShareGetInfo' delayed;
function NetShareSetInfo; external netapi32 name 'NetShareSetInfo' delayed;
function NetShareDel; external netapi32 name 'NetShareDel' delayed;
function NetShareDelSticky; external netapi32 name 'NetShareDelSticky' delayed;
function NetShareCheck; external netapi32 name 'NetShareCheck' delayed;
function NetSessionEnum; external netapi32 name 'NetSessionEnum' delayed;
function NetSessionDel; external netapi32 name 'NetSessionDel' delayed;
function NetSessionGetInfo; external netapi32 name 'NetSessionGetInfo' delayed;
function NetConnectionEnum; external netapi32 name 'NetConnectionEnum' delayed;
function NetFileClose; external netapi32 name 'NetFileClose' delayed;
function NetFileEnum; external netapi32 name 'NetFileEnum' delayed;
function NetFileGetInfo; external netapi32 name 'NetFileGetInfo' delayed;
