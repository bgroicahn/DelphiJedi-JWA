...
function StartTraceW; external advapi32 name 'StartTraceW' delayed;
function StartTraceA; external advapi32 name 'StartTraceA' delayed;
function StartTrace; external advapi32 name 'StartTrace'+AWSuffix delayed;

function StopTraceW; external advapi32 name 'StopTraceW' delayed;
function StopTraceA; external advapi32 name 'StopTraceA' delayed;
function StopTrace; external advapi32 name 'StopTraceA'+AWSuffix delayed;


function QueryTraceW; external advapi32 name 'QueryTraceW' delayed;
function QueryTraceA; external advapi32 name 'QueryTraceA' delayed;
function QueryTrace; external advapi32 name 'QueryTrace'+AWSuffix delayed;

function UpdateTraceW; external advapi32 name 'UpdateTraceW' delayed;
function UpdateTraceA; external advapi32 name 'UpdateTraceA' delayed;
function UpdateTrace; external advapi32 name 'UpdateTrace'+AWSuffix delayed;

{$IFDEF WINXP_UP}
function FlushTraceW; external advapi32 name 'FlushTraceW' delayed;
function FlushTraceA; external advapi32 name 'FlushTraceA' delayed;
function FlushTrace; external advapi32 name 'FlushTrace'+AWSuffix delayed;

{$ENDIF WINXP_UP}
function ControlTraceW; external advapi32 name 'ControlTraceW' delayed;
function ControlTraceA; external advapi32 name 'ControlTraceA' delayed;
function ControlTrace; external advapi32 name 'ControlTraceA'+AWSuffix delayed;

function QueryAllTracesW; external advapi32 name 'QueryAllTracesW' delayed;
function QueryAllTracesA; external advapi32 name 'QueryAllTracesA' delayed;
function QueryAllTraces; external advapi32 name 'QueryAllTraces'+AWSuffix delayed;

function EnableTrace; external advapi32 name 'EnableTrace' delayed;

{$IFDEF WINVISTA_UP}
function EnableTraceEx; external advapi32 name 'EnableTraceEx' delayed;
function EnumerateTraceGuidsEx; external advapi32 name 'EnumerateTraceGuidsEx' delayed;
{$ENDIF}
function CreateTraceInstanceId; external advapi32 name 'CreateTraceInstanceId' delayed;
function TraceEvent; external advapi32 name 'TraceEvent' delayed;
function TraceEventInstance; external advapi32 name 'TraceEventInstance' delayed;

function RegisterTraceGuidsW; external advapi32 name 'RegisterTraceGuidsW' delayed;
function RegisterTraceGuidsA; external advapi32 name 'RegisterTraceGuidsA' delayed;
function RegisterTraceGuids; external advapi32 name 'RegisterTraceGuids'+AWSuffix delayed;
{$IFDEF WINXP_UP}
function EnumerateTraceGuids; external advapi32 name 'EnumerateTraceGuids' delayed;
{$ENDIF WINXP_UP}
function UnregisterTraceGuids; external advapi32 name 'UnregisterTraceGuids' delayed;
function GetTraceLoggerHandle; external advapi32 name 'GetTraceLoggerHandle' delayed;
function GetTraceEnableLevel; external advapi32 name 'GetTraceEnableLevel' delayed;
function GetTraceEnableFlags; external advapi32 name 'GetTraceEnableFlags' delayed;

function OpenTraceA; external advapi32 name 'OpenTraceA' delayed;
function OpenTraceW; external advapi32 name 'OpenTraceW' delayed;
function OpenTrace; external advapi32 name 'OpenTrace'+AWSuffix delayed;

function ProcessTrace; external advapi32 name 'ProcessTrace' delayed;
function CloseTrace; external advapi32 name 'CloseTrace' delayed;
function SetTraceCallback; external advapi32 name 'SetTraceCallback' delayed;
function RemoveTraceCallback ; external advapi32 name 'RemoveTraceCallback' delayed;
function TraceMessageVa; external advapi32 name 'TraceMessageVa' delayed;
