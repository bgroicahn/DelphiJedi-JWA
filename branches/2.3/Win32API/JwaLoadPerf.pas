...
function InstallPerfDllA; external loadperflib name 'InstallPerfDllA' delayed;
function InstallPerfDllW; external loadperflib name 'InstallPerfDllW' delayed;
function InstallPerfDll; external loadperflib name 'InstallPerfDll' + AWSuffix delayed;
function LoadPerfCounterTextStringsA; external loadperflib name 'LoadPerfCounterTextStringsA' delayed;
function LoadPerfCounterTextStringsW; external loadperflib name 'LoadPerfCounterTextStringsW' delayed;
function LoadPerfCounterTextStrings; external loadperflib name 'LoadPerfCounterTextStrings' + AWSuffix delayed;
function UnloadPerfCounterTextStringsA; external loadperflib name 'UnloadPerfCounterTextStringsA' delayed;
function UnloadPerfCounterTextStringsW; external loadperflib name 'UnloadPerfCounterTextStringsW' delayed;
function UnloadPerfCounterTextStrings; external loadperflib name 'UnloadPerfCounterTextStrings' + AWSuffix delayed;
function UpdatePerfNameFilesA; external loadperflib name 'UpdatePerfNameFilesA' delayed;
function UpdatePerfNameFilesW; external loadperflib name 'UpdatePerfNameFilesW' delayed;
function UpdatePerfNameFiles; external loadperflib name 'UpdatePerfNameFiles' + AWSuffix delayed;
function SetServiceAsTrustedA; external loadperflib name 'SetServiceAsTrustedA' delayed;
function SetServiceAsTrustedW; external loadperflib name 'SetServiceAsTrustedW' delayed;
function SetServiceAsTrusted; external loadperflib name 'SetServiceAsTrusted' + AWSuffix delayed;
function BackupPerfRegistryToFileW; external loadperflib name 'BackupPerfRegistryToFileW' delayed;
function RestorePerfRegistryFromFileW; external loadperflib name 'RestorePerfRegistryFromFileW' delayed;
