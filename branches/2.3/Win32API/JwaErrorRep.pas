...
function ReportFault; external faultreplib name 'ReportFault' delayed;
function AddERExcludedApplicationA; external faultreplib name 'AddERExcludedApplicationA' delayed;
function AddERExcludedApplicationW; external faultreplib name 'AddERExcludedApplicationW' delayed;
function AddERExcludedApplication; external faultreplib name 'AddERExcludedApplication' + AWSuffix delayed;
