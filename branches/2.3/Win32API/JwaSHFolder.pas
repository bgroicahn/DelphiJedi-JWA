...
function SHGetFolderPathA; external ShFolderDll name 'SHGetFolderPathA' delayed;
function SHGetFolderPathW; external ShFolderDll name 'SHGetFolderPathW' delayed;
function SHGetFolderPath; external ShFolderDll name 'SHGetFolderPath'+ AWSuffix delayed;
