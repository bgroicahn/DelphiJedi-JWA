...
function DsRoleGetPrimaryDomainInformation; external netapi32 name 'DsRoleGetPrimaryDomainInformation' delayed;
procedure DsRoleFreeMemory; external netapi32 name 'DsRoleFreeMemory' delayed;
