...
function DsBrowseForContainerW; external dsuiext name 'DsBrowseForContainerW' delayed;
function DsBrowseForContainerA; external dsuiext name 'DsBrowseForContainerA' delayed;
function DsBrowseForContainer; external dsuiext name 'DsBrowseForContainer' + AWSuffix delayed;
function DsGetIcon; external dsuiext name 'DsGetIcon' delayed;
procedure DsGetFriendlyClassName; external dsuiext name 'DsGetFriendlyClassName' delayed;
