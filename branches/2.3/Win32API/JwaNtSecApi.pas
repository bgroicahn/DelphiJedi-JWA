...
function LsaRegisterLogonProcess; external secur32 name 'LsaRegisterLogonProcess' delayed;
function LsaLogonUser; external secur32 name 'LsaLogonUser' delayed;
function LsaLookupAuthenticationPackage; external secur32 name 'LsaLookupAuthenticationPackage' delayed;
function LsaFreeReturnBuffer; external secur32 name 'LsaFreeReturnBuffer' delayed;
function LsaCallAuthenticationPackage; external secur32 name 'LsaCallAuthenticationPackage' delayed;
function LsaDeregisterLogonProcess; external secur32 name 'LsaDeregisterLogonProcess' delayed;
function LsaConnectUntrusted; external secur32 name 'LsaConnectUntrusted' delayed;
function LsaFreeMemory; external advapi32 name 'LsaFreeMemory' delayed;
function LsaClose; external advapi32 name 'LsaClose' delayed;
function LsaOpenPolicy; external advapi32 name 'LsaOpenPolicy' delayed;
function LsaEnumerateLogonSessions; external secur32 name 'LsaEnumerateLogonSessions' delayed;
function LsaGetLogonSessionData; external secur32 name 'LsaGetLogonSessionData' delayed;
function LsaQueryInformationPolicy; external advapi32 name 'LsaQueryInformationPolicy' delayed;
function LsaSetInformationPolicy; external advapi32 name 'LsaSetInformationPolicy' delayed;
function LsaQueryDomainInformationPolicy; external advapi32 name 'LsaQueryDomainInformationPolicy' delayed;
function LsaSetDomainInformationPolicy; external advapi32 name 'LsaSetDomainInformationPolicy' delayed;
function LsaRegisterPolicyChangeNotification; external secur32 name 'LsaRegisterPolicyChangeNotification' delayed;
function LsaUnregisterPolicyChangeNotification; external secur32 name 'LsaUnregisterPolicyChangeNotification' delayed;
function LsaEnumerateTrustedDomains; external advapi32 name 'LsaEnumerateTrustedDomains' delayed;
function LsaLookupNames; external advapi32 name 'LsaLookupNames' delayed;
function LsaLookupNames2; external advapi32 name 'LsaLookupNames2' delayed;
function LsaLookupSids; external advapi32 name 'LsaLookupSids' delayed;
function LsaEnumerateAccountsWithUserRight; external advapi32 name 'LsaEnumerateAccountsWithUserRight' delayed;
function LsaEnumerateAccountRights; external advapi32 name 'LsaEnumerateAccountRights' delayed;
function LsaAddAccountRights; external advapi32 name 'LsaAddAccountRights' delayed;
function LsaRemoveAccountRights; external advapi32 name 'LsaRemoveAccountRights' delayed;
function LsaOpenTrustedDomainByName; external advapi32 name 'LsaOpenTrustedDomainByName' delayed;
function LsaQueryTrustedDomainInfo; external advapi32 name 'LsaQueryTrustedDomainInfo' delayed;
function LsaSetTrustedDomainInformation; external advapi32 name 'LsaSetTrustedDomainInformation' delayed;
function LsaDeleteTrustedDomain; external advapi32 name 'LsaDeleteTrustedDomain' delayed;
function LsaQueryTrustedDomainInfoByName; external advapi32 name 'LsaQueryTrustedDomainInfoByName' delayed;
function LsaSetTrustedDomainInfoByName; external advapi32 name 'LsaSetTrustedDomainInfoByName' delayed;
function LsaEnumerateTrustedDomainsEx; external advapi32 name 'LsaEnumerateTrustedDomainsEx' delayed;
function LsaCreateTrustedDomainEx; external advapi32 name 'LsaCreateTrustedDomainEx' delayed;
function LsaQueryForestTrustInformation; external advapi32 name 'LsaQueryForestTrustInformation' delayed;
function LsaSetForestTrustInformation; external advapi32 name 'LsaSetForestTrustInformation' delayed;
function LsaStorePrivateData; external advapi32 name 'LsaStorePrivateData' delayed;
function LsaRetrievePrivateData; external advapi32 name 'LsaRetrievePrivateData' delayed;
function LsaNtStatusToWinError; external advapi32 name 'LsaNtStatusToWinError' delayed;
