...
function QueryUsersOnEncryptedFile; external advapi32 name 'QueryUsersOnEncryptedFile' delayed;
function QueryRecoveryAgentsOnEncryptedFile; external advapi32 name 'QueryRecoveryAgentsOnEncryptedFile' delayed;
function RemoveUsersFromEncryptedFile; external advapi32 name 'RemoveUsersFromEncryptedFile' delayed;
function AddUsersToEncryptedFile; external advapi32 name 'AddUsersToEncryptedFile' delayed;
function SetUserFileEncryptionKey; external advapi32 name 'SetUserFileEncryptionKey' delayed;
procedure FreeEncryptionCertificateHashList; external advapi32 name 'FreeEncryptionCertificateHashList' delayed;
function EncryptionDisable; external advapi32 name 'EncryptionDisable' delayed;
function DuplicateEncryptionInfoFile; external advapi32 name 'DuplicateEncryptionInfoFile' delayed;
