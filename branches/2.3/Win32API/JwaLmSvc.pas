...
// $Id: JwaLmSvc.pas,v 1.12 2007/09/05 11:58:51 dezipaitor Exp $
...
function NetServiceControl; external netapi32 name 'NetServiceControl' delayed;
function NetServiceEnum; external netapi32 name 'NetServiceEnum' delayed;
function NetServiceGetInfo; external netapi32 name 'NetServiceGetInfo' delayed;
function NetServiceInstall; external netapi32 name 'NetServiceInstall' delayed;
