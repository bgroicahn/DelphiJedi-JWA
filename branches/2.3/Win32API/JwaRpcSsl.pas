...
function RpcCertGeneratePrincipalNameW; external rpclib name 'RpcCertGeneratePrincipalNameW' delayed;
function RpcCertGeneratePrincipalNameA; external rpclib name 'RpcCertGeneratePrincipalNameA' delayed;
function RpcCertGeneratePrincipalName; external rpclib name 'RpcCertGeneratePrincipalName' + AWSuffix delayed;
