...
function NetJoinDomain; external netapi32 name 'NetJoinDomain' delayed;
function NetUnjoinDomain; external netapi32 name 'NetUnjoinDomain' delayed;
function NetRenameMachineInDomain; external netapi32 name 'NetRenameMachineInDomain' delayed;
function NetValidateName; external netapi32 name 'NetValidateName' delayed;
function NetGetJoinInformation; external netapi32 name 'NetGetJoinInformation' delayed;
function NetGetJoinableOUs; external netapi32 name 'NetGetJoinableOUs' delayed;
function NetAddAlternateComputerName; external netapi32 name 'NetAddAlternateComputerName' delayed;
function NetRemoveAlternateComputerName; external netapi32 name 'NetRemoveAlternateComputerName' delayed;
function NetSetPrimaryComputerName; external netapi32 name 'NetSetPrimaryComputerName' delayed;
function NetEnumerateComputerNames; external netapi32 name 'NetEnumerateComputerNames' delayed;
