...
function IsDestinationReachableA; external sensapilib name 'IsDestinationReachableA' delayed;
function IsDestinationReachableW; external sensapilib name 'IsDestinationReachableW' delayed;
function IsDestinationReachable; external sensapilib name 'IsDestinationReachable' + AWSuffix delayed;
function IsNetworkAlive; external sensapilib name 'IsNetworkAlive' delayed;
