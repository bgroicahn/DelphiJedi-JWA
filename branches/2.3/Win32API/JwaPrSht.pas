...
function CreatePropertySheetPageA; external comctl32 name 'CreatePropertySheetPageA' delayed;
function CreatePropertySheetPageW; external comctl32 name 'CreatePropertySheetPageW' delayed;
function DestroyPropertySheetPage; external comctl32 name 'DestroyPropertySheetPage' delayed;
function PropertySheetA; external comctl32 name 'PropertySheetA' delayed;
function PropertySheetW; external comctl32 name 'PropertySheetW' delayed;
function CreatePropertySheetPage; external comctl32 name 'CreatePropertySheetPage' + AWSuffix delayed;
function PropertySheet; external comctl32 name 'PropertySheet' + AWSuffix delayed;
