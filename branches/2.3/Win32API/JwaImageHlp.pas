...
function BindImage; external ImageHlpLib name 'BindImage' delayed;
function BindImageEx; external ImageHlpLib name 'BindImageEx' delayed;
function ReBaseImage; external ImageHlpLib name 'ReBaseImage' delayed;
function ReBaseImage64; external ImageHlpLib name 'ReBaseImage64' delayed;
function CheckSumMappedFile; external ImageHlpLib name 'CheckSumMappedFile' delayed;
function MapFileAndCheckSumA; external ImageHlpLib name 'MapFileAndCheckSumA' delayed;
function MapFileAndCheckSumW; external ImageHlpLib name 'MapFileAndCheckSumW' delayed;
function MapFileAndCheckSum; external ImageHlpLib name 'MapFileAndCheckSum' + AWSuffix delayed;
function GetImageConfigInformation; external ImageHlpLib name 'GetImageConfigInformation' delayed;
function GetImageUnusedHeaderBytes; external ImageHlpLib name 'GetImageUnusedHeaderBytes' delayed;
function SetImageConfigInformation; external ImageHlpLib name 'SetImageConfigInformation' delayed;
function ImageGetDigestStream; external ImageHlpLib name 'ImageGetDigestStream' delayed;
function ImageAddCertificate; external ImageHlpLib name 'ImageAddCertificate' delayed;
function ImageRemoveCertificate; external ImageHlpLib name 'ImageRemoveCertificate' delayed;
function ImageEnumerateCertificates; external ImageHlpLib name 'ImageEnumerateCertificates' delayed;
function ImageGetCertificateData; external ImageHlpLib name 'ImageGetCertificateData' delayed;
function ImageGetCertificateHeader; external ImageHlpLib name 'ImageGetCertificateHeader' delayed;
function ImageLoad; external ImageHlpLib name 'ImageLoad' delayed;
function ImageUnload; external ImageHlpLib name 'ImageUnload' delayed;
function MapAndLoad; external ImageHlpLib name 'MapAndLoad' delayed;
function UnMapAndLoad; external ImageHlpLib name 'UnMapAndLoad' delayed;
function TouchFileTimes; external ImageHlpLib name 'TouchFileTimes' delayed;
function SplitSymbols; external ImageHlpLib name 'SplitSymbols' delayed;
function UpdateDebugInfoFile; external ImageHlpLib name 'UpdateDebugInfoFile' delayed;
function UpdateDebugInfoFileEx; external ImageHlpLib name 'UpdateDebugInfoFileEx' delayed;
function FindDebugInfoFile; external ImageHlpLib name 'FindDebugInfoFile' delayed;
function FindDebugInfoFileEx; external ImageHlpLib name 'FindDebugInfoFileEx' delayed;
function SymFindFileInPath; external ImageHlpLib name 'SymFindFileInPath' delayed;
function FindExecutableImage; external ImageHlpLib name 'FindExecutableImage' delayed;
function FindExecutableImageEx; external ImageHlpLib name 'FindExecutableImageEx' delayed;
function ImageNtHeader; external ImageHlpLib name 'ImageNtHeader' delayed;
function ImageDirectoryEntryToDataEx; external ImageHlpLib name 'ImageDirectoryEntryToDataEx' delayed;
function ImageDirectoryEntryToData; external ImageHlpLib name 'ImageDirectoryEntryToData' delayed;
function ImageRvaToSection; external ImageHlpLib name 'ImageRvaToSection' delayed;
function ImageRvaToVa; external ImageHlpLib name 'ImageRvaToVa' delayed;
function MapDebugInformation; external ImageHlpLib name 'MapDebugInformation' delayed;
function UnmapDebugInformation; external ImageHlpLib name 'UnmapDebugInformation' delayed;
function SearchTreeForFile; external ImageHlpLib name 'SearchTreeForFile' delayed;
function EnumDirTree; external ImageHlpLib name 'EnumDirTree' delayed;
function MakeSureDirectoryPathExists; external ImageHlpLib name 'MakeSureDirectoryPathExists' delayed;
function UnDecorateSymbolName; external ImageHlpLib name 'UnDecorateSymbolName' delayed;
function StackWalk64; external ImageHlpLib name 'StackWalk64' delayed;
function StackWalk; external ImageHlpLib name 'StackWalk' delayed;
function ImagehlpApiVersion; external ImageHlpLib name 'ImagehlpApiVersion' delayed;
function ImagehlpApiVersionEx; external ImageHlpLib name 'ImagehlpApiVersionEx' delayed;
function GetTimestampForLoadedLibrary; external ImageHlpLib name 'GetTimestampForLoadedLibrary' delayed;
function SymSetOptions; external ImageHlpLib name 'SymSetOptions' delayed;
function SymGetOptions; external ImageHlpLib name 'SymGetOptions' delayed;
function SymCleanup; external ImageHlpLib name 'SymCleanup' delayed;
function SymMatchString; external ImageHlpLib name 'SymMatchString' delayed;
function SymEnumSourceFiles; external ImageHlpLib name 'SymEnumSourceFiles' delayed;
function SymEnumerateModules64; external ImageHlpLib name 'SymEnumerateModules64' delayed;
function SymEnumerateModules; external ImageHlpLib name 'SymEnumerateModules' delayed;
function SymEnumerateSymbols64; external ImageHlpLib name 'SymEnumerateSymbols64' delayed;
function SymEnumerateSymbolsW64; external ImageHlpLib name 'SymEnumerateSymbolsW64' delayed;
function SymEnumerateSymbols; external ImageHlpLib name 'SymEnumerateSymbols' delayed;
function SymEnumerateSymbolsW; external ImageHlpLib name 'SymEnumerateSymbolsW' delayed;
function EnumerateLoadedModules64; external ImageHlpLib name 'EnumerateLoadedModules64' delayed;
function EnumerateLoadedModules; external ImageHlpLib name 'EnumerateLoadedModules' delayed;
function SymFunctionTableAccess64; external ImageHlpLib name 'SymFunctionTableAccess64' delayed;
function SymFunctionTableAccess; external ImageHlpLib name 'SymFunctionTableAccess' delayed;
function SymGetModuleInfo64; external ImageHlpLib name 'SymGetModuleInfo64' delayed;
function SymGetModuleInfoW64; external ImageHlpLib name 'SymGetModuleInfoW64' delayed;
function SymGetModuleInfo; external ImageHlpLib name 'SymGetModuleInfo' delayed;
function SymGetModuleInfoW; external ImageHlpLib name 'SymGetModuleInfoW' delayed;
function SymGetModuleBase64; external ImageHlpLib name 'SymGetModuleBase64' delayed;
function SymGetModuleBase; external ImageHlpLib name 'SymGetModuleBase' delayed;
function SymGetSymNext64; external ImageHlpLib name 'SymGetSymNext64' delayed;
function SymGetSymNext; external ImageHlpLib name 'SymGetSymNext' delayed;
function SymGetSymPrev64; external ImageHlpLib name 'SymGetSymPrev64' delayed;
function SymGetSymPrev; external ImageHlpLib name 'SymGetSymPrev' delayed;
function SymGetLineFromAddr64; external ImageHlpLib name 'SymGetLineFromAddr64' delayed;
function SymGetLineFromAddr; external ImageHlpLib name 'SymGetLineFromAddr' delayed;
function SymGetLineFromName64; external ImageHlpLib name 'SymGetLineFromName64' delayed;
function SymGetLineFromName; external ImageHlpLib name 'SymGetLineFromName' delayed;
function SymGetLineNext64; external ImageHlpLib name 'SymGetLineNext64' delayed;
function SymGetLineNext; external ImageHlpLib name 'SymGetLineNext' delayed;
function SymGetLinePrev64; external ImageHlpLib name 'SymGetLinePrev64' delayed;
function SymGetLinePrev; external ImageHlpLib name 'SymGetLinePrev' delayed;
function SymMatchFileName; external ImageHlpLib name 'SymMatchFileName' delayed;
function SymInitialize; external ImageHlpLib name 'SymInitialize' delayed;
function SymGetSearchPath; external ImageHlpLib name 'SymGetSearchPath' delayed;
function SymSetSearchPath; external ImageHlpLib name 'SymSetSearchPath' delayed;
function SymLoadModuleEx; external ImageHlpLib name 'SymLoadModuleEx' delayed;
function SymLoadModule64; external ImageHlpLib name 'SymLoadModule64' delayed;
function SymLoadModule; external ImageHlpLib name 'SymLoadModule' delayed;
function SymUnloadModule64; external ImageHlpLib name 'SymUnloadModule64' delayed;
function SymUnloadModule; external ImageHlpLib name 'SymUnloadModule' delayed;
function SymUnDName64; external ImageHlpLib name 'SymUnDName64' delayed;
function SymUnDName; external ImageHlpLib name 'SymUnDName' delayed;
function SymRegisterCallback64; external ImageHlpLib name 'SymRegisterCallback64' delayed;
function SymRegisterFunctionEntryCallback64; external ImageHlpLib name 'SymRegisterFunctionEntryCallback64' delayed;
function SymRegisterCallback; external ImageHlpLib name 'SymRegisterCallback' delayed;
function SymRegisterFunctionEntryCallback; external ImageHlpLib name 'SymRegisterFunctionEntryCallback' delayed;
function SymSetContext; external ImageHlpLib name 'SymSetContext' delayed;
function SymFromAddr; external ImageHlpLib name 'SymFromAddr' delayed;
function SymFromName; external ImageHlpLib name 'SymFromName' delayed;
function SymEnumSymbolsForAddr; external ImageHlpLib name 'SymEnumSymbolsForAddr' delayed;
function SymEnumSymbols; external ImageHlpLib name 'SymEnumSymbols' delayed;
function SymGetTypeInfo; external ImageHlpLib name 'SymGetTypeInfo' delayed;
function SymEnumTypes; external ImageHlpLib name 'SymEnumTypes' delayed;
function SymGetTypeFromName; external ImageHlpLib name 'SymGetTypeFromName' delayed;
function SymAddSymbol; external ImageHlpLib name 'SymAddSymbol' delayed;
function SymDeleteSymbol; external ImageHlpLib name 'SymDeleteSymbol' delayed;
function DbgHelpCreateUserDump; external ImageHlpLib name 'DbgHelpCreateUserDump' delayed;
function DbgHelpCreateUserDumpW; external ImageHlpLib name 'DbgHelpCreateUserDumpW' delayed;
function SymGetSymFromAddr64; external ImageHlpLib name 'SymGetSymFromAddr64' delayed;
function SymGetSymFromAddr; external ImageHlpLib name 'SymGetSymFromAddr' delayed;
function SymGetSymFromName64; external ImageHlpLib name 'SymGetSymFromName64' delayed;
function SymGetSymFromName; external ImageHlpLib name 'SymGetSymFromName' delayed;
function FindFileInPath; external ImageHlpLib name 'FindFileInPath' delayed;
function FindFileInSearchPath; external ImageHlpLib name 'FindFileInSearchPath' delayed;
function SymEnumSym; external ImageHlpLib name 'SymEnumSym' delayed;
function MiniDumpWriteDump; external ImageHlpLib name 'MiniDumpWriteDump' delayed;
function MiniDumpReadDumpStream; external ImageHlpLib name 'MiniDumpReadDumpStream' delayed;
