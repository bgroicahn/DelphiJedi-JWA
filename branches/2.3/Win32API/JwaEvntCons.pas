...
{$IFDEF WINVISTA_UP}
function EventAccessControl; external advapi32 name 'EventAccessControl' delayed;
function EventAccessQuery; external advapi32 name 'EventAccessQuery' delayed;
function EventAccessRemove; external advapi32 name 'EventAccessRemove' delayed;
{$ENDIF WINVISTA_UP}
