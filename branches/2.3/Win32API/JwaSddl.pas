...
function ConvertSidToStringSidA; external advapi32 name 'ConvertSidToStringSidA' delayed;
function ConvertSidToStringSidW; external advapi32 name 'ConvertSidToStringSidW' delayed;
function ConvertSidToStringSid; external advapi32 name 'ConvertSidToStringSid' + AWSuffix delayed;
function ConvertStringSidToSidA; external advapi32 name 'ConvertStringSidToSidA' delayed;
function ConvertStringSidToSidW; external advapi32 name 'ConvertStringSidToSidW' delayed;
function ConvertStringSidToSid; external advapi32 name 'ConvertStringSidToSid' + AWSuffix delayed;
function ConvertStringSecurityDescriptorToSecurityDescriptorA; external advapi32 name 'ConvertStringSecurityDescriptorToSecurityDescriptorA' delayed;
function ConvertStringSecurityDescriptorToSecurityDescriptorW; external advapi32 name 'ConvertStringSecurityDescriptorToSecurityDescriptorW' delayed;
function ConvertStringSecurityDescriptorToSecurityDescriptor; external advapi32 name 'ConvertStringSecurityDescriptorToSecurityDescriptor' + AWSuffix delayed;
function ConvertSecurityDescriptorToStringSecurityDescriptorA; external advapi32 name 'ConvertSecurityDescriptorToStringSecurityDescriptorA' delayed;
function ConvertSecurityDescriptorToStringSecurityDescriptorW; external advapi32 name 'ConvertSecurityDescriptorToStringSecurityDescriptorW' delayed;
function ConvertSecurityDescriptorToStringSecurityDescriptor; external advapi32 name 'ConvertSecurityDescriptorToStringSecurityDescriptor' + AWSuffix delayed;
