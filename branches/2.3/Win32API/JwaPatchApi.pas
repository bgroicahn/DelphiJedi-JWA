...
function CreatePatchFileA; external patchapi name 'CreatePatchFileA' delayed;
function CreatePatchFileW; external patchapi name 'CreatePatchFileW' delayed;
function CreatePatchFileByHandles; external patchapi name 'CreatePatchFileByHandles' delayed;
function CreatePatchFileExA; external patchapi name 'CreatePatchFileExA' delayed;
function CreatePatchFileExW; external patchapi name 'CreatePatchFileExW' delayed;
function CreatePatchFileByHandlesEx; external patchapi name 'CreatePatchFileByHandlesEx' delayed;
function ExtractPatchHeaderToFileA; external patchapi name 'ExtractPatchHeaderToFileA' delayed;
function ExtractPatchHeaderToFileW; external patchapi name 'ExtractPatchHeaderToFileW' delayed;
function ExtractPatchHeaderToFileByHandles; external patchapi name 'ExtractPatchHeaderToFileByHandles' delayed;
function TestApplyPatchToFileA; external patchapi name 'TestApplyPatchToFileA' delayed;
function TestApplyPatchToFileW; external patchapi name 'TestApplyPatchToFileW' delayed;
function TestApplyPatchToFileByHandles; external patchapi name 'TestApplyPatchToFileByHandles' delayed;
function ApplyPatchToFileA; external patchapi name 'ApplyPatchToFileA' delayed;
function ApplyPatchToFileW; external patchapi name 'ApplyPatchToFileW' delayed;
function ApplyPatchToFileByHandles; external patchapi name 'ApplyPatchToFileByHandles' delayed;
function ApplyPatchToFileExA; external patchapi name 'ApplyPatchToFileExA' delayed;
function ApplyPatchToFileExW; external patchapi name 'ApplyPatchToFileExW' delayed;
function ApplyPatchToFileByHandlesEx; external patchapi name 'ApplyPatchToFileByHandlesEx' delayed;
function GetFilePatchSignatureA; external patchapi name 'GetFilePatchSignatureA' delayed;
function GetFilePatchSignatureW; external patchapi name 'GetFilePatchSignatureW' delayed;
function GetFilePatchSignatureByHandle; external patchapi name 'GetFilePatchSignatureByHandle' delayed;
function CreatePatchFile; external patchapi name 'CreatePatchFile' + AWSuffix delayed;
function CreatePatchFileEx; external patchapi name 'CreatePatchFileEx' + AWSuffix delayed;
function ExtractPatchHeaderToFile; external patchapi name 'ExtractPatchHeaderToFile' + AWSuffix delayed;
function TestApplyPatchToFile; external patchapi name 'TestApplyPatchToFile' + AWSuffix delayed;
function ApplyPatchToFile; external patchapi name 'ApplyPatchToFile' + AWSuffix delayed;
function ApplyPatchToFileEx; external patchapi name 'ApplyPatchToFileEx' + AWSuffix delayed;
function GetFilePatchSignature; external patchapi name 'GetFilePatchSignature' + AWSuffix delayed;
