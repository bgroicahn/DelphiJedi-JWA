...
function SaferGetPolicyInformation; external advapi32 name 'SaferGetPolicyInformation' delayed;
function SaferSetPolicyInformation; external advapi32 name 'SaferSetPolicyInformation' delayed;
function SaferCreateLevel; external advapi32 name 'SaferCreateLevel' delayed;
function SaferCloseLevel; external advapi32 name 'SaferCloseLevel' delayed;
function SaferIdentifyLevel; external advapi32 name 'SaferIdentifyLevel' delayed;
function SaferComputeTokenFromLevel; external advapi32 name 'SaferComputeTokenFromLevel' delayed;
function SaferGetLevelInformation; external advapi32 name 'SaferGetLevelInformation' delayed;
function SaferSetLevelInformation; external advapi32 name 'SaferSetLevelInformation' delayed;
function SaferRecordEventLogEntry; external advapi32 name 'SaferRecordEventLogEntry' delayed;
function SaferiIsExecutableFileType; external advapi32 name 'SaferiIsExecutableFileType' delayed;
