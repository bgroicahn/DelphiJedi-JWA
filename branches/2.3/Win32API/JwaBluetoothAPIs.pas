...
function BluetoothFindFirstRadio; external btapi name 'BluetoothFindFirstRadio' delayed;
function BluetoothFindNextRadio; external btapi name 'BluetoothFindNextRadio' delayed;
function BluetoothFindRadioClose; external btapi name 'BluetoothFindRadioClose' delayed;
function BluetoothGetRadioInfo; external btapi name 'BluetoothGetRadioInfo' delayed;
function BluetoothFindFirstDevice; external btapi name 'BluetoothFindFirstDevice' delayed;
function BluetoothFindNextDevice; external btapi name 'BluetoothFindNextDevice' delayed;
function BluetoothFindDeviceClose; external btapi name 'BluetoothFindDeviceClose' delayed;
function BluetoothGetDeviceInfo; external btapi name 'BluetoothGetDeviceInfo' delayed;
function BluetoothUpdateDeviceRecord; external btapi name 'BluetoothUpdateDeviceRecord' delayed;
function BluetoothRemoveDevice; external btapi name 'BluetoothRemoveDevice' delayed;
function BluetoothSelectDevices; external btapi name 'BluetoothSelectDevices' delayed;
function BluetoothSelectDevicesFree; external btapi name 'BluetoothSelectDevicesFree' delayed;
function BluetoothDisplayDeviceProperties; external btapi name 'BluetoothDisplayDeviceProperties' delayed;
function BluetoothAuthenticateDevice; external btapi name 'BluetoothAuthenticateDevice' delayed;
function BluetoothAuthenticateMultipleDevices; external btapi name 'BluetoothAuthenticateMultipleDevices' delayed;
function BluetoothSetServiceState; external btapi name 'BluetoothSetServiceState' delayed;
function BluetoothEnumerateInstalledServices; external btapi name 'BluetoothEnumerateInstalledServices' delayed;
function BluetoothEnableDiscovery; external btapi name 'BluetoothEnableDiscovery' delayed;
function BluetoothIsDiscoverable; external btapi name 'BluetoothIsDiscoverable' delayed;
function BluetoothEnableIncomingConnections; external btapi name 'BluetoothEnableIncomingConnections' delayed;
function BluetoothIsConnectable; external btapi name 'BluetoothIsConnectable' delayed;
function BluetoothRegisterForAuthentication; external btapi name 'BluetoothRegisterForAuthentication' delayed;
function BluetoothUnregisterAuthentication; external btapi name 'BluetoothUnregisterAuthentication' delayed;
function BluetoothSendAuthenticationResponse; external btapi name 'BluetoothSendAuthenticationResponse' delayed;
function BluetoothSdpGetElementData; external btapi name 'BluetoothSdpGetElementData' delayed;
function BluetoothSdpGetContainerElementData; external btapi name 'BluetoothSdpGetContainerElementData' delayed;
function BluetoothSdpGetAttributeValue; external btapi name 'BluetoothSdpGetAttributeValue' delayed;
function BluetoothSdpGetString; external btapi name 'BluetoothSdpGetString' delayed;
function BluetoothSdpEnumAttributes; external btapi name 'BluetoothSdpEnumAttributes' delayed;
