...
function DhcpCApiInitialize; external dhcpapi name 'DhcpCApiInitialize' delayed;
procedure DhcpCApiCleanup; external dhcpapi name 'DhcpCApiCleanup' delayed;
function DhcpRequestParams; external dhcpapi name 'DhcpRequestParams' delayed;
function DhcpUndoRequestParams; external dhcpapi name 'DhcpUndoRequestParams' delayed;
function DhcpRegisterParamChange; external dhcpapi name 'DhcpRegisterParamChange' delayed;
function DhcpDeRegisterParamChange; external dhcpapi name 'DhcpDeRegisterParamChange' delayed;
function DhcpRemoveDNSRegistrations; external dhcpapi name 'DhcpRemoveDNSRegistrations' delayed;
