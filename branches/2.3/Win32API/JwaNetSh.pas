...
// $Id: JwaNetSh.pas,v 1.12 2007/09/05 11:58:51 dezipaitor Exp $
...
function GetHostMachineInfo; external netsh name 'GetHostMachineInfo' delayed;
function MatchEnumTag; external netsh name 'MatchEnumTag' delayed;
function MatchToken; external netsh name 'MatchToken' delayed;
function PreprocessCommand; external netsh name 'PreprocessCommand' delayed;
function RegisterContext; external netsh name 'RegisterContext' delayed;
function RegisterHelper; external netsh name 'RegisterHelper' delayed;
