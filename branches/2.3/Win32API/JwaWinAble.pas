...
function BlockInput; external user32 name 'BlockInput' delayed;
{$IFNDEF JWA_INCLUDEMODE}
function GetGUIThreadInfo; external user32 name 'GetGUIThreadInfo' delayed;
function GetWindowModuleFileNameW; external user32 name 'GetWindowModuleFileNameW' delayed;
function GetWindowModuleFileNameA; external user32 name 'GetWindowModuleFileNameA' delayed;
function GetWindowModuleFileName; external user32 name 'GetWindowModuleFileName' + AWSuffix delayed;c
function SendInput; external user32 name 'SendInput' delayed;
procedure NotifyWinEvent; external user32 name 'NotifyWinEvent' delayed;
function SetWinEventHook; external user32 name 'SetWinEventHook' delayed;
function UnhookWinEvent; external user32 name 'UnhookWinEvent' delayed;
{$ENDIF JWA_INCLUDEMODE}
