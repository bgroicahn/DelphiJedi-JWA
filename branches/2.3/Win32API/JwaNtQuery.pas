...
function LoadIFilterEx; external querylib name 'LoadIFilterEx' delayed;
function LoadIFilter; external querylib name 'LoadIFilter' delayed;
function BindIFilterFromStorage; external querylib name 'BindIFilterFromStorage' delayed;
function BindIFilterFromStream; external querylib name 'BindIFilterFromStream' delayed;
function LocateCatalogsW; external querylib name 'LocateCatalogsW' delayed;
function LocateCatalogsA; external querylib name 'LocateCatalogsA' delayed;
function LocateCatalogs; external querylib name 'LocateCatalogs' + AWSuffix delayed;
function SetCatalogState; external querylib name 'SetCatalogState' delayed;
function CIState; external querylib name 'CIState' delayed;
function CIMakeICommand; external querylib name 'CIMakeICommand' delayed;
function CICreateCommand; external querylib name 'CICreateCommand' delayed;
function CITextToSelectTree; external querylib name 'CITextToSelectTree' delayed;
function CITextToSelectTreeEx; external querylib name 'CITextToSelectTreeEx' delayed;
function CITextToFullTree; external querylib name 'CITextToSelectTreeEx' delayed;
function CITextToFullTreeEx; external querylib name 'CITextToFullTreeEx' delayed;
function CIBuildQueryNode; external querylib name 'CIBuildQueryNode' delayed;
function CIBuildQueryTree; external querylib name 'CIBuildQueryTree' delayed;
function CIRestrictionToFullTree; external querylib name 'CIRestrictionToFullTree' delayed;
