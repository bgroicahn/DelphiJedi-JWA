...
function DsGetDcNameA; external netapi32 name 'DsGetDcNameA' delayed;
function DsGetDcNameW; external netapi32 name 'DsGetDcNameW' delayed;
function DsGetDcName; external netapi32 name 'DsGetDcName' + AWSuffix delayed;
function DsGetSiteNameA; external netapi32 name 'DsGetSiteNameA' delayed;
function DsGetSiteNameW; external netapi32 name 'DsGetSiteNameW' delayed;
function DsGetSiteName; external netapi32 name 'DsGetSiteName' + AWSuffix delayed;
function DsValidateSubnetNameA; external netapi32 name 'DsValidateSubnetNameA' delayed;
function DsValidateSubnetNameW; external netapi32 name 'DsValidateSubnetNameW' delayed;
function DsValidateSubnetName; external netapi32 name 'DsValidateSubnetName' + AWSuffix delayed;
function DsAddressToSiteNamesA; external netapi32 name 'DsAddressToSiteNamesA' delayed;
function DsAddressToSiteNamesW; external netapi32 name 'DsAddressToSiteNamesW' delayed;
function DsAddressToSiteNames; external netapi32 name 'DsAddressToSiteNames' + AWSuffix delayed;
function DsAddressToSiteNamesExA; external netapi32 name 'DsAddressToSiteNamesExA' delayed;
function DsAddressToSiteNamesExW; external netapi32 name 'DsAddressToSiteNamesExW' delayed;
function DsAddressToSiteNamesEx; external netapi32 name 'DsAddressToSiteNamesEx' + AWSuffix delayed;
function DsEnumerateDomainTrustsA; external netapi32 name 'DsEnumerateDomainTrustsA' delayed;
function DsEnumerateDomainTrustsW; external netapi32 name 'DsEnumerateDomainTrustsW' delayed;
function DsEnumerateDomainTrusts; external netapi32 name 'DsEnumerateDomainTrusts' + AWSuffix delayed;
function DsGetForestTrustInformationW; external netapi32 name 'DsGetForestTrustInformationW' delayed;
function DsMergeForestTrustInformationW; external netapi32 name 'DsMergeForestTrustInformationW' delayed;
function DsGetDcSiteCoverageA; external netapi32 name 'DsGetDcSiteCoverageA' delayed;
function DsGetDcSiteCoverageW; external netapi32 name 'DsGetDcSiteCoverageW' delayed;
function DsGetDcSiteCoverage; external netapi32 name 'DsGetDcSiteCoverage' + AWSuffix delayed;
function DsDeregisterDnsHostRecordsA; external netapi32 name 'DsDeregisterDnsHostRecordsA' delayed;
function DsDeregisterDnsHostRecordsW; external netapi32 name 'DsDeregisterDnsHostRecordsW' delayed;
function DsDeregisterDnsHostRecords; external netapi32 name 'DsDeregisterDnsHostRecords' + AWSuffix delayed;
function DsGetDcOpenW; external netapi32 name 'DsGetDcOpenW' delayed;
function DsGetDcOpenA; external netapi32 name 'DsGetDcOpenA' delayed;
function DsGetDcOpen; external netapi32 name 'DsGetDcOpen' + AWSuffix delayed;
function DsGetDcNextW; external netapi32 name 'DsGetDcNextW' delayed;
function DsGetDcNextA; external netapi32 name 'DsGetDcNextA' delayed;
function DsGetDcNext; external netapi32 name 'DsGetDcNext' + AWSuffix delayed;
procedure DsGetDcCloseW; external netapi32 name 'DsGetDcCloseW' delayed;
procedure DsGetDcClose; external netapi32 name 'DsGetDcClose' delayed;
