...
function NetDfsAdd; external netapi32 name 'NetDfsAdd' delayed;
function NetDfsAddStdRoot; external netapi32 name 'NetDfsAddStdRoot' delayed;
function NetDfsRemoveStdRoot; external netapi32 name 'NetDfsRemoveStdRoot' delayed;
function NetDfsAddFtRoot; external netapi32 name 'NetDfsAddFtRoot' delayed;
function NetDfsRemoveFtRoot; external netapi32 name 'NetDfsRemoveFtRoot' delayed;
function NetDfsRemoveFtRootForced; external netapi32 name 'NetDfsRemoveFtRootForced' delayed;
function NetDfsManagerInitialize; external netapi32 name 'NetDfsManagerInitialize' delayed;
function NetDfsAddStdRootForced; external netapi32 name 'NetDfsAddStdRootForced' delayed;
function NetDfsGetDcAddress; external netapi32 name 'NetDfsGetDcAddress' delayed;
function NetDfsRemove; external netapi32 name 'NetDfsRemove' delayed;
function NetDfsEnum; external netapi32 name 'NetDfsEnum' delayed;
function NetDfsGetInfo; external netapi32 name 'NetDfsGetInfo' delayed;
function NetDfsSetInfo; external netapi32 name 'NetDfsSetInfo' delayed;
function NetDfsGetClientInfo; external netapi32 name 'NetDfsGetClientInfo' delayed;
function NetDfsSetClientInfo; external netapi32 name 'NetDfsSetClientInfo' delayed;
function NetDfsMove; external netapi32 name 'NetDfsMove' delayed;
function NetDfsRename; external netapi32 name 'NetDfsRename' delayed;
