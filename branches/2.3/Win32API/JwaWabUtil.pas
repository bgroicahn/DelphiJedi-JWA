...
function CreateTable; external mapi32 name 'CreateTable@36' delayed;
function MAPIInitIdle; external mapi32 name 'MAPIInitIdle@4' delayed;
procedure MAPIDeinitIdle; external mapi32 name 'MAPIDeinitIdle@0' delayed;
function FtgRegisterIdleRoutine; external mapi32 name 'FtgRegisterIdleRoutine@20' delayed;
procedure DeregisterIdleRoutine; external mapi32 name 'DeregisterIdleRoutine@4' delayed;
procedure EnableIdleRoutine; external mapi32 name 'EnableIdleRoutine@8' delayed;
procedure ChangeIdleRoutine; external mapi32 name 'ChangeIdleRoutine@28' delayed;
function MAPIGetDefaultMalloc; external mapi32 name 'MAPIGetDefaultMalloc@0' delayed;
function OpenStreamOnFile; external mapi32 name 'OpenStreamOnFile' delayed;
function PropCopyMore; external mapi32 name 'PropCopyMore@16' delayed;
function UlPropSize; external mapi32 name 'UlPropSize@4' delayed;
function FEqualNames; external mapi32 name 'FEqualNames@8' delayed;
//procedure GetInstance; external mapi32 name 'GetInstance' delayed;
function FPropContainsProp; external mapi32 name 'FPropContainsProp@12' delayed;
function FPropCompareProp; external mapi32 name 'FPropCompareProp@12' delayed;
function LPropCompareProp; external mapi32 name 'LPropCompareProp@8' delayed;
function HrAddColumns; external mapi32 name 'HrAddColumns@16' delayed;
function HrAddColumnsEx; external mapi32 name 'HrAddColumnsEx@20' delayed;
procedure HrAllocAdviseSink; external mapi32 name 'HrAllocAdviseSink@12' delayed;
procedure HrThisThreadAdviseSink; external mapi32 name 'HrThisThreadAdviseSink@8' delayed;
function HrDispatchNotifications; external mapi32 name 'HrDispatchNotifications@4' delayed;
procedure BuildDisplayTable; external mapi32 name 'BuildDisplayTable@40' delayed;
function ScCountNotifications; external mapi32 name 'ScCountNotifications@12' delayed;
function ScCopyNotifications; external mapi32 name 'ScCopyNotifications@16' delayed;
function ScRelocNotifications; external mapi32 name 'ScRelocNotifications@20' delayed;
function ScCountProps; external mapi32 name 'ScCountProps@12' delayed;
function LpValFindProp; external mapi32 name 'LpValFindProp@12' delayed;
function ScCopyProps; external mapi32 name 'ScCopyProps@16' delayed;
function ScRelocProps; external mapi32 name 'ScRelocProps@20' delayed;
function ScDupPropset; external mapi32 name 'ScDupPropset@16' delayed;
function UlAddRef; external mapi32 name 'UlAddRef@4' delayed;
function UlRelease; external mapi32 name 'UlRelease@4' delayed;
procedure HrGetOneProp; external mapi32 name 'HrGetOneProp@12' delayed;
procedure HrSetOneProp; external mapi32 name 'HrSetOneProp@8' delayed;
function FPropExists; external mapi32 name 'FPropExists@8' delayed;
function PpropFindProp; external mapi32 name 'PpropFindProp@12' delayed;
procedure FreePadrlist; external mapi32 name 'FreePadrlist@4' delayed;
procedure FreeProws; external mapi32 name 'FreeProws@4' delayed;
function HrQueryAllRows; external mapi32 name 'HrQueryAllRows@24' delayed;
function ScUNCFromLocalPath; external mapi32 name 'ScUNCFromLocalPath@12' delayed;
function ScLocalPathFromUNC; external mapi32 name 'ScLocalPathFromUNC@12' delayed;
function FtAddFt; external mapi32 name 'FtAddFt@16' delayed;
function FtMulDwDw; external mapi32 name 'FtMulDwDw@8' delayed;
function FtMulDw; external mapi32 name 'FtMulDw@12' delayed;
function FtSubFt; external mapi32 name 'FtSubFt@16' delayed;
function FtNegFt; external mapi32 name 'FtNegFt@8' delayed;
function ScCreateConversationIndex; external mapi32 name 'ScCreateConversationIndex@16' delayed;
procedure WrapStoreEntryID; external mapi32 name 'WrapStoreEntryID@24' delayed;
function RTFSync; external mapi32 name 'RTFSync' delayed;
function WrapCompressedRTFStream; external mapi32 name 'WrapCompressedRTFStream' delayed;
function HrIStorageFromStream; external mapi32 name 'HrIStorageFromStream@16' delayed;
function ScInitMapiUtil; external mapi32 name 'ScInitMapiUtil@4' delayed;
procedure DeinitMapiUtil; external mapi32 name 'DeinitMapiUtil@0' delayed;
