...
function WSARecvEx; external mswsocklib name 'WSARecvEx' delayed;
function TransmitFile; external mswsocklib name 'TransmitFile' delayed;
function AcceptEx; external mswsocklib name 'AcceptEx' delayed;
procedure GetAcceptExSockaddrs; external mswsocklib name 'GetAcceptExSockaddrs' delayed;
