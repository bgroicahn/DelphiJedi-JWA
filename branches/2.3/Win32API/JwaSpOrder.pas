...
function WSCWriteProviderOrder; external sporderlib name 'WSCWriteProviderOrder' delayed;
function WSCWriteNameSpaceOrder; external sporderlib name 'WSCWriteNameSpaceOrder' delayed;
