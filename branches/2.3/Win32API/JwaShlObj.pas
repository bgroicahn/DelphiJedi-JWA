...
function SHGetMalloc; external shell32 name 'SHGetMalloc' delayed;
function SHAlloc; external shell32 name 'SHAlloc' delayed;
procedure SHFree; external shell32 name 'SHFree' delayed;
function SHGetIconOverlayIndexA; external shell32 name 'SHGetIconOverlayIndexA' delayed;
function SHGetIconOverlayIndexW; external shell32 name 'SHGetIconOverlayIndexW' delayed;
function SHGetIconOverlayIndex; external shell32 name 'SHGetIconOverlayIndex'+AWSuffix delayed;
function SHGetPathFromIDListA; external shell32 name 'SHGetPathFromIDListA' delayed;
function SHGetPathFromIDListW; external shell32 name 'SHGetPathFromIDListW' delayed;
function SHGetPathFromIDList; external shell32 name 'SHGetPathFromIDList'+AWSuffix delayed;
function SHCreateDirectory; external shell32 name 'SHCreateDirectory' delayed;
function SHCreateDirectoryExA; external shell32 name 'SHCreateDirectoryExA' delayed;
function SHCreateDirectoryExW; external shell32 name 'SHCreateDirectoryExW' delayed;
function SHCreateDirectoryEx; external shell32 name 'SHCreateDirectoryEx'+AWSuffix delayed;
function SHOpenFolderAndSelectItems; external shell32 name 'SHOpenFolderAndSelectItems' delayed;
function SHCreateShellItem; external shell32 name 'SHCreateShellItem' delayed;
function SHGetSpecialFolderLocation; external shell32 name 'SHGetSpecialFolderLocation' delayed;
procedure SHFlushSFCache; external shell32 name 'SHFlushSFCache' delayed;
function SHCloneSpecialIDList; external shell32 name 'SHCloneSpecialIDList' delayed;
function SHGetSpecialFolderPathA; external shell32 name 'SHGetSpecialFolderPathA' delayed;
function SHGetSpecialFolderPathW; external shell32 name 'SHGetSpecialFolderPathW' delayed;
function SHGetSpecialFolderPath; external shell32 name 'SHGetSpecialFolderPath'+AWSuffix delayed;
{$IFNDEF JWA_INCLUDEMODE}
function SHGetFolderPathA; external shell32 name 'SHGetFolderPathA' delayed;
function SHGetFolderPathW; external shell32 name 'SHGetFolderPathW' delayed;
function SHGetFolderPath; external shell32 name 'SHGetFolderPath'+AWSuffix delayed;
{$ENDIF JWA_INCLUDEMODE}
function SHGetFolderLocation; external shell32 name 'SHGetFolderLocation' delayed;
...
function SHGetFolderPathAndSubDir; external shell32 name 'SHGetFolderPathAndSubDir'+AWSuffix delayed;
function SHBrowseForFolderA; external shell32 name 'SHBrowseForFolderA' delayed;
function SHBrowseForFolderW; external shell32 name 'SHBrowseForFolderW' delayed;
function SHBrowseForFolder; external shell32 name 'SHBrowseForFolder'+AWSuffix delayed;
function SHLoadInProc; external shell32 name 'SHLoadInProc' delayed;
function SHGetDesktopFolder; external shell32 name 'SHGetDesktopFolder' delayed;
procedure SHChangeNotify; external shell32 name 'SHChangeNotify' delayed;
procedure SHAddToRecentDocs; external shell32 name 'SHAddToRecentDocs' delayed;
function SHHandleUpdateImage; external shell32 name 'SHHandleUpdateImage' delayed;
procedure SHUpdateImageA; external shell32 name 'SHUpdateImageA' delayed;
procedure SHUpdateImageW; external shell32 name 'SHUpdateImageW' delayed;
procedure SHUpdateImage; external shell32 name 'SHUpdateImage'+AWSuffix delayed;
function SHChangeNotifyRegister; external shell32 name 'SHChangeNotifyRegister' delayed;
function SHChangeNotifyDeregister; external shell32 name 'SHChangeNotifyDeregister' delayed;
function SHChangeNotification_Lock; external shell32 name 'SHChangeNotification_Lock' delayed;
function SHChangeNotification_Unlock; external shell32 name 'SHChangeNotification_Unlock' delayed;
function SHGetRealIDL; external shell32 name 'SHGetRealIDL' delayed;
function SHGetInstanceExplorer; external shell32 name 'SHGetInstanceExplorer' delayed;
function SHGetDataFromIDListA; external shell32 name 'SHGetDataFromIDListA' delayed;
function SHGetDataFromIDListW; external shell32 name 'SHGetDataFromIDListW' delayed;
function SHGetDataFromIDList; external shell32 name 'SHGetDataFromIDList'+AWSuffix delayed;
function RestartDialog; external shell32 name 'RestartDialog' delayed;
function RestartDialogEx; external shell32 name 'RestartDialogEx' delayed;
function SHCoCreateInstance; external shell32 name 'SHCoCreateInstance' delayed;
function SHCreateStdEnumFmtEtc; external shell32 name 'SHCreateStdEnumFmtEtc' delayed;
function SHDoDragDrop; external shell32 name 'SHDoDragDrop' delayed;
function DAD_SetDragImage; external shell32 name 'DAD_SetDragImage' delayed;
function DAD_DragEnterEx; external shell32 name 'DAD_DragEnterEx' delayed;
function DAD_DragEnterEx2; external shell32 name 'DAD_DragEnterEx2' delayed;
function DAD_ShowDragImage; external shell32 name 'DAD_ShowDragImage' delayed;
function DAD_DragMove; external shell32 name 'DAD_DragMove' delayed;
function DAD_DragLeave; external shell32 name 'DAD_DragLeave' delayed;
function DAD_AutoScroll; external shell32 name 'DAD_AutoScroll' delayed;
function ReadCabinetState; external shell32 name 'ReadCabinetState' delayed;
function WriteCabinetState; external shell32 name 'WriteCabinetState' delayed;
function PathMakeUniqueName; external shell32 name 'PathMakeUniqueName' delayed;
procedure PathQualify; external shell32 name 'PathQualify' delayed;
function PathIsExe; external shell32 name 'PathIsExe' delayed;
function PathIsSlowA; external shell32 name 'PathIsSlowA' delayed;
function PathIsSlowW; external shell32 name 'PathIsSlowW' delayed;
function PathIsSlow; external shell32 name 'PathIsSlow'+AWSuffix delayed;
function PathCleanupSpec; external shell32 name 'PathCleanupSpec' delayed;
function PathResolve; external shell32 name 'PathResolve' delayed;
function GetFileNameFromBrowse; external shell32 name 'GetFileNameFromBrowse' delayed;
function DriveType; external shell32 name 'DriveType' delayed;
function RealDriveType; external shell32 name 'RealDriveType' delayed;
function IsNetDrive; external shell32 name 'IsNetDrive' delayed;
function Shell_MergeMenus; external shell32 name 'Shell_MergeMenus' delayed;
function SHObjectProperties; external shell32 name 'SHObjectProperties' delayed;
function SHFormatDrive; external shell32 name 'SHFormatDrive' delayed;
function SHCreatePropSheetExtArray; external shell32 name 'SHCreatePropSheetExtArray' delayed;
procedure SHDestroyPropSheetExtArray; external shell32 name 'SHDestroyPropSheetExtArray' delayed;
function SHAddFromPropSheetExtArray; external shell32 name 'SHAddFromPropSheetExtArray' delayed;
function SHReplaceFromPropSheetExtArray; external shell32 name 'SHReplaceFromPropSheetExtArray' delayed;
function ILClone; external shell32 name 'ILClone' delayed;
function ILGetNext; external shell32 name 'ILGetNext' delayed;
function ILGetSize; external shell32 name 'ILGetSize' delayed;
function ILFindLastID; external shell32 name 'ILFindLastID' delayed;
function ILRemoveLastID; external shell32 name 'ILRemoveLastID' delayed;
function ILAppendID; external shell32 name 'ILAppendID' delayed;
procedure ILFree; external shell32 name 'ILFree' delayed;
function ILCloneFirst; external shell32 name 'ILCloneFirst' delayed;
function ILIsEqual; external shell32 name 'ILIsEqual' delayed;
function ILIsParent; external shell32 name 'ILIsParent' delayed;
function ILFindChild; external shell32 name 'ILFindChild' delayed;
function ILCombine; external shell32 name 'ILCombine' delayed;
function ILSaveToStream; external shell32 name 'ILSaveToStream' delayed;
function ILCreateFromPathA; external shell32 name 'ILCreateFromPathA' delayed;
function ILCreateFromPathW; external shell32 name 'ILCreateFromPathW' delayed;
function ILCreateFromPath; external shell32 name 'ILCreateFromPath'+AWSuffix delayed;
function SHILCreateFromPath; external shell32 name 'SHILCreateFromPath' delayed;
function OpenRegStream; external shell32 name 'OpenRegStream' delayed;
function SHFindFiles; external shell32 name 'SHFindFiles' delayed;
procedure PathGetShortPath; external shell32 name 'PathGetShortPath' delayed;
function PathYetAnotherMakeUniqueName; external shell32 name 'PathYetAnotherMakeUniqueName' delayed;
function Win32DeleteFile; external shell32 name 'Win32DeleteFile' delayed;
function SHRestricted; external shell32 name 'SHRestricted' delayed;
function SignalFileOpen; external shell32 name 'SignalFileOpen' delayed;
function SHSimpleIDListFromPath; external shell32 name 'SHSimpleIDListFromPath' delayed;
...
function SHDefExtractIcon; external shell32 name 'SHDefExtractIcon'+AWSuffix delayed;
function Shell_GetImageLists; external shell32 name 'Shell_GetImageLists' delayed;
function Shell_GetCachedImageIndex; external shell32 name 'Shell_GetCachedImageIndex' delayed;
function SHValidateUNC; external shell32 name 'SHValidateUNC' delayed;
function PifMgr_OpenProperties; external shell32 name 'PifMgr_OpenProperties' delayed;
function PifMgr_GetProperties; external shell32 name 'PifMgr_GetProperties' delayed;
function PifMgr_SetProperties; external shell32 name 'PifMgr_SetProperties' delayed;
function PifMgr_CloseProperties; external shell32 name 'PifMgr_CloseProperties' delayed;
procedure SHSetInstanceExplorer; external shell32 name 'SHSetInstanceExplorer' delayed;
function IsUserAnAdmin; external shell32 name 'IsUserAnAdmin' delayed;
function SHShellFolderView_Message; external shell32 name 'SHShellFolderView_Message' delayed;
function SHCreateShellFolderView; external shell32 name 'SHCreateShellFolderView' delayed;
function CDefFolderMenu_Create2; external shell32 name 'CDefFolderMenu_Create2' delayed;
function SHFind_InitMenuPopup; external shell32 name 'SHFind_InitMenuPopup' delayed;
function SHCreateShellFolderViewEx; external shell32 name 'SHCreateShellFolderViewEx' delayed;
procedure SHGetSetSettings; external shell32 name 'SHGetSetSettings' delayed;
procedure SHGetSettings; external shell32 name 'SHGetSettings' delayed;
function SHBindToParent; external shell32 name 'SHBindToParent' delayed;
function SHParseDisplayName; external shell32 name 'SHParseDisplayName' delayed;
function SHPathPrepareForWriteA; external shell32 name 'SHPathPrepareForWriteA' delayed;
function SHPathPrepareForWriteW; external shell32 name 'SHPathPrepareForWriteW' delayed;
function SHPathPrepareForWrite; external shell32 name 'SHPathPrepareForWrite'+AWSuffix delayed;
function SoftwareUpdateMessageBox; external shdocvwDll name 'SoftwareUpdateMessageBox' delayed;
function SHPropStgCreate; external shell32 name 'SHPropStgCreate' delayed;
...
function SHLimitInputEdit; external shell32 name 'SHLimitInputEdit' delayed;
function SHMultiFileProperties; external shell32 name 'SHMultiFileProperties' delayed;
function SHMapPIDLToSystemImageListIndex; external shell32 name 'SHMapPIDLToSystemImageListIndex' delayed;
function SHCLSIDFromString; external shell32 name 'SHCLSIDFromString' delayed;
...
function ImportPrivacySettings; external shdocvwDll name 'ImportPrivacySettings' delayed;
function DoPrivacyDlg; external shdocvwDll name 'DoPrivacyDlg' delayed;

function SHEnableServiceObject; external shdocvwDll name 'SHEnableServiceObject' delayed;
function SHGetSetFolderCustomSettingsA; external shdocvwDll name 'SHGetSetFolderCustomSettingsA' delayed;
function SHGetSetFolderCustomSettingsW; external shdocvwDll name 'SHGetSetFolderCustomSettingsW' delayed;
function SHGetSetFolderCustomSettings; external shdocvwDll name 'SHGetSetFolderCustomSettings'+AWSuffix delayed;
function CallCPLEntry16; external shdocvwDll name 'CallCPLEntry16' delayed;
function SHStartNetConnectionDialogA; external shdocvwDll name 'SHStartNetConnectionDialogA' delayed;
function SHStartNetConnectionDialogW; external shdocvwDll name 'SHStartNetConnectionDialogW' delayed;
function SHStartNetConnectionDialog; external shdocvwDll name 'SHStartNetConnectionDialog'+AWSuffix delayed;
function SHOpenPropSheetA; external shdocvwDll name 'SHOpenPropSheetA' delayed;
function SHOpenPropSheetW; external shdocvwDll name 'SHOpenPropSheetW' delayed;
function SHOpenPropSheet; external shdocvwDll name 'SHOpenPropSheet'+AWSuffix delayed;
function SHCreateFileExtractIconA; external shdocvwDll name 'SHCreateFileExtractIconA' delayed;
function SHCreateFileExtractIconW; external shdocvwDll name 'SHCreateFileExtractIconW' delayed;
function SHCreateFileExtractIcon; external shdocvwDll name 'SHCreateFileExtractIcon'+AWSuffix delayed;
function ILLoadFromStream; external shdocvwDll name 'ILLoadFromStream' delayed;
function PathProcessCommand; external shdocvwDll name 'PathProcessCommand' delayed;
function SHLoadOLE; external shdocvwDll name 'SHLoadOLE' delayed;
function SHMapIDListToImageListIndexAsync; external shdocvwDll name 'SHMapIDListToImageListIndexAsync' delayed;
function SHFlushClipboard; external shdocvwDll name 'SHFlushClipboard' delayed;
function SHGetShellStyleHInstance; external shdocvwDll name 'SHGetShellStyleHInstance' delayed;
function SHRunControlPanel; external shdocvwDll name 'SHRunControlPanel' delayed;
procedure PerUserInit; external mydocs name 'PerUserInit' delayed;
