...
function NetServerEnum; external netapi32 name 'NetServerEnum' delayed;
function NetServerEnumEx; external netapi32 name 'NetServerEnumEx' delayed;
function NetServerGetInfo; external netapi32 name 'NetServerGetInfo' delayed;
function NetServerSetInfo; external netapi32 name 'NetServerSetInfo' delayed;
function NetServerSetInfoCommandLine; external netapi32 name 'NetServerSetInfoCommandLine' delayed;
function NetServerDiskEnum; external netapi32 name 'NetServerDiskEnum' delayed;
function NetServerComputerNameAdd; external netapi32 name 'NetServerComputerNameAdd' delayed;
function NetServerComputerNameDel; external netapi32 name 'NetServerComputerNameDel' delayed;
function NetServerTransportAdd; external netapi32 name 'NetServerTransportAdd' delayed;
function NetServerTransportAddEx; external netapi32 name 'NetServerTransportAddEx' delayed;
function NetServerTransportDel; external netapi32 name 'NetServerTransportDel' delayed;
function NetServerTransportEnum; external netapi32 name 'NetServerTransportEnum' delayed;
function SetServiceBits; external netapi32 name 'SetServiceBits' delayed;
