...
{$IFDEF WINVISTA_UP}
function EventRegister; external advapi32 name 'EventRegister' delayed;
function EventUnregister; external advapi32 name 'EventUnregister' delayed;
function EventEnabled; external advapi32 name 'EventEnabled' delayed;
function EventProviderEnabled; external advapi32 name 'EventProviderEnabled' delayed;
function EventWrite; external advapi32 name 'EventWrite' delayed;
function EventWriteTransfer; external advapi32 name 'EventWriteTransfer' delayed;
function EventWriteString; external advapi32 name 'EventWriteString' delayed;
function EventActivityIdControl; external advapi32 name 'EventActivityIdControl' delayed;
{$ENDIF WINVISTA_UP}
