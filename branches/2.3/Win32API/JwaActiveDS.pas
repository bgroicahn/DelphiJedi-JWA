...
function ADsPropCreateNotifyObj; external dsprop name 'ADsPropCreateNotifyObj' delayed;
function ADsPropGetInitInfo; external dsprop name 'ADsPropGetInitInfo' delayed;
function ADsPropSetHwnd; external dsprop name 'ADsPropSetHwnd' delayed;
function ADsPropCheckIfWritable; external dsprop name 'ADsPropCheckIfWritable' delayed;
