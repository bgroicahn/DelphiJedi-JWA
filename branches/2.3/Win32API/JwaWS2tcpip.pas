...
{$ELSE}
*)
function getaddrinfo; external ws2tcpip name 'getaddrinfo' delayed;
procedure freeaddrinfo; external ws2tcpip name 'freeaddrinfo' delayed;
function getnameinfo; external ws2tcpip name 'getnameinfo' delayed;
