...
function ber_init; external winberapi name 'ber_init' delayed;
procedure ber_free; external winberapi name 'ber_free' delayed;
{$IFNDEF JWA_INCLUDEMODE}
procedure ber_bvfree; external winberapi name 'ber_bvfree' delayed;
{$ENDIF JWA_INCLUDEMODE}
procedure ber_bvecfree; external winberapi name 'ber_bvecfree' delayed;
function ber_bvdup; external winberapi name 'ber_bvdup' delayed;
function ber_alloc_t; external winberapi name 'ber_alloc_t' delayed;
function ber_skip_tag; external winberapi name 'ber_skip_tag' delayed;
function ber_peek_tag; external winberapi name 'ber_peek_tag' delayed;
function ber_first_element; external winberapi name 'ber_first_element' delayed;
function ber_next_element; external winberapi name 'ber_next_element' delayed;
function ber_flatten; external winberapi name 'ber_flatten' delayed;
//function ber_printf; external winberapi name 'ber_printf' delayed;
//function ber_scanf; external winberapi name 'ber_scanf' delayed;
