...
function NetWkstaGetInfo; external netapi32 name 'NetWkstaGetInfo' delayed;
function NetWkstaSetInfo; external netapi32 name 'NetWkstaSetInfo' delayed;
function NetWkstaUserGetInfo; external netapi32 name 'NetWkstaUserGetInfo' delayed;
function NetWkstaUserSetInfo; external netapi32 name 'NetWkstaUserSetInfo' delayed;
function NetWkstaUserEnum; external netapi32 name 'NetWkstaUserEnum' delayed;
function NetWkstaTransportAdd; external netapi32 name 'NetWkstaTransportAdd' delayed;
function NetWkstaTransportDel; external netapi32 name 'NetWkstaTransportDel' delayed;
function NetWkstaTransportEnum; external netapi32 name 'NetWkstaTransportEnum' delayed;
