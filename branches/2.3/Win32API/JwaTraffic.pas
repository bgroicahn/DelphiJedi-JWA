...
function TcRegisterClient; external trafficlib name 'TcRegisterClient' delayed;
function TcEnumerateInterfaces; external trafficlib name 'TcEnumerateInterfaces' delayed;
function TcOpenInterfaceA; external trafficlib name 'TcOpenInterfaceA' delayed;
function TcOpenInterfaceW; external trafficlib name 'TcOpenInterfaceW' delayed;
function TcCloseInterface; external trafficlib name 'TcCloseInterface' delayed;
function TcQueryInterface; external trafficlib name 'TcQueryInterface' delayed;
function TcSetInterface; external trafficlib name 'TcSetInterface' delayed;
function TcQueryFlowA; external trafficlib name 'TcQueryFlowA' delayed;
function TcQueryFlowW; external trafficlib name 'TcQueryFlowW' delayed;
function TcSetFlowA; external trafficlib name 'TcSetFlowA' delayed;
function TcSetFlowW; external trafficlib name 'TcSetFlowW' delayed;
function TcAddFlow; external trafficlib name 'TcAddFlow' delayed;
function TcGetFlowNameA; external trafficlib name 'TcGetFlowNameA' delayed;
function TcGetFlowNameW; external trafficlib name 'TcGetFlowNameW' delayed;
function TcModifyFlow; external trafficlib name 'TcModifyFlow' delayed;
function TcAddFilter; external trafficlib name 'TcAddFilter' delayed;
function TcDeregisterClient; external trafficlib name 'TcDeregisterClient' delayed;
function TcDeleteFlow; external trafficlib name 'TcDeleteFlow' delayed;
function TcDeleteFilter; external trafficlib name 'TcDeleteFilter' delayed;
function TcEnumerateFlows; external trafficlib name 'TcEnumerateFlows' delayed;
function TcOpenInterface; external trafficlib name 'TcOpenInterface' + AWSuffix delayed;
function TcQueryFlow; external trafficlib name 'TcQueryFlow' + AWSuffix delayed;
function TcSetFlow; external trafficlib name 'TcSetFlow' + AWSuffix delayed;
function TcGetFlowName; external trafficlib name 'TcGetFlowName' + AWSuffix delayed;
