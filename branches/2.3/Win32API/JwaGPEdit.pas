...
function CreateGPOLink; external gpeditlib name 'CreateGPOLink' delayed;
function DeleteGPOLink; external gpeditlib name 'DeleteGPOLink' delayed;
function DeleteAllGPOLinks; external gpeditlib name 'DeleteAllGPOLinks' delayed;
function BrowseForGPO; external gpeditlib name 'BrowseForGPO' delayed;
function ImportRSoPData; external gpeditlib name 'ImportRSoPData' delayed;
function ExportRSoPData; external gpeditlib name 'ExportRSoPData' delayed;
