...
function OpenThemeData; external themelib name 'OpenThemeData' delayed;
function CloseThemeData; external themelib name 'CloseThemeData' delayed;
function DrawThemeBackground; external themelib name 'DrawThemeBackground' delayed;
function DrawThemeText; external themelib name 'DrawThemeText' delayed;
function GetThemeBackgroundContentRect; external themelib name 'GetThemeBackgroundContentRect' delayed;
function GetThemeBackgroundExtent; external themelib name 'GetThemeBackgroundContentRect' delayed;
function GetThemePartSize; external themelib name 'GetThemePartSize' delayed;
function GetThemeTextExtent; external themelib name 'GetThemeTextExtent' delayed;
function GetThemeTextMetrics; external themelib name 'GetThemeTextMetrics' delayed;
function GetThemeBackgroundRegion; external themelib name 'GetThemeBackgroundRegion' delayed;
function HitTestThemeBackground; external themelib name 'HitTestThemeBackground' delayed;
function DrawThemeEdge; external themelib name 'DrawThemeEdge' delayed;
function DrawThemeIcon; external themelib name 'DrawThemeIcon' delayed;
function IsThemePartDefined; external themelib name 'IsThemePartDefined' delayed;
function IsThemeBackgroundPartiallyTransparent; external themelib name 'IsThemeBackgroundPartiallyTransparent' delayed;
function GetThemeColor; external themelib name 'GetThemeColor' delayed;
function GetThemeMetric; external themelib name 'GetThemeMetric' delayed;
function GetThemeString; external themelib name 'GetThemeString' delayed;
function GetThemeBool; external themelib name 'GetThemeBool' delayed;
function GetThemeInt; external themelib name 'GetThemeInt' delayed;
function GetThemeEnumValue; external themelib name 'GetThemeEnumValue' delayed;
function GetThemePosition; external themelib name 'GetThemePosition' delayed;
function GetThemeFont; external themelib name 'GetThemeFont' delayed;
function GetThemeRect; external themelib name 'GetThemeRect' delayed;
function GetThemeMargins; external themelib name 'GetThemeMargins' delayed;
function GetThemeIntList; external themelib name 'GetThemeIntList' delayed;
function GetThemePropertyOrigin; external themelib name 'GetThemePropertyOrigin' delayed;
function SetWindowTheme; external themelib name 'SetWindowTheme' delayed;
function GetThemeFilename; external themelib name 'GetThemeFilename' delayed;
function GetThemeSysColor; external themelib name 'GetThemeSysColor' delayed;
function GetThemeSysColorBrush; external themelib name 'GetThemeSysColorBrush' delayed;
function GetThemeSysBool; external themelib name 'GetThemeSysBool' delayed;
function GetThemeSysSize; external themelib name 'GetThemeSysSize' delayed;
function GetThemeSysFont; external themelib name 'GetThemeSysFont' delayed;
function GetThemeSysString; external themelib name 'GetThemeSysString' delayed;
function GetThemeSysInt; external themelib name 'GetThemeSysInt' delayed;
function IsThemeActive; external themelib name 'IsThemeActive' delayed;
function IsAppThemed; external themelib name 'IsAppThemed' delayed;
function GetWindowTheme; external themelib name 'GetWindowTheme' delayed;
function EnableThemeDialogTexture; external themelib name 'EnableThemeDialogTexture' delayed;
function IsThemeDialogTextureEnabled; external themelib name 'IsThemeDialogTextureEnabled' delayed;
function GetThemeAppProperties; external themelib name 'GetThemeAppProperties' delayed;
procedure SetThemeAppProperties; external themelib name 'SetThemeAppProperties' delayed;
function GetCurrentThemeName; external themelib name 'GetCurrentThemeName' delayed;
function GetThemeDocumentationProperty; external themelib name 'GetThemeDocumentationProperty' delayed;
function DrawThemeParentBackground; external themelib name 'DrawThemeParentBackground' delayed;
function EnableTheming; external themelib name 'EnableTheming' delayed;
