...
function CryptAcquireContextA; external advapi32 name 'CryptAcquireContextA' delayed;
function CryptAcquireContextW; external advapi32 name 'CryptAcquireContextW' delayed;
function CryptAcquireContext; external advapi32 name 'CryptAcquireContext' + AWSuffix delayed;
function CryptReleaseContext; external advapi32 name 'CryptReleaseContext' delayed;
function CryptGenKey; external advapi32 name 'CryptGenKey' delayed;
function CryptDeriveKey; external advapi32 name 'CryptDeriveKey' delayed;
function CryptDestroyKey; external advapi32 name 'CryptDestroyKey' delayed;
function CryptSetKeyParam; external advapi32 name 'CryptSetKeyParam' delayed;
...
function CryptSetProvParam; external advapi32 name 'CryptSetProvParam' delayed;
function CryptGetProvParam; external advapi32 name 'CryptGetProvParam' delayed;
function CryptGenRandom; external advapi32 name 'CryptGenRandom' delayed;
...
function CryptImportKey; external advapi32 name 'CryptImportKey' delayed;
function CryptEncrypt; external advapi32 name 'CryptEncrypt' delayed;
function CryptDecrypt; external advapi32 name 'CryptDecrypt' delayed;
...
function CryptHashSessionKey; external advapi32 name 'CryptHashSessionKey' delayed;
function CryptDestroyHash; external advapi32 name 'CryptDestroyHash' delayed;
function CryptSignHashA; external advapi32 name 'CryptSignHashA' delayed;
function CryptSignHashW; external advapi32 name 'CryptSignHashW' delayed;
function CryptSignHash; external advapi32 name 'CryptSignHash' + AWSuffix delayed;
function CryptVerifySignatureA; external advapi32 name 'CryptVerifySignatureA' delayed;
function CryptVerifySignatureW; external advapi32 name 'CryptVerifySignatureW' delayed;
function CryptVerifySignature; external advapi32 name 'CryptVerifySignature' + AWSuffix delayed;
function CryptSetProviderA; external advapi32 name 'CryptSetProviderA' delayed;
function CryptSetProviderW; external advapi32 name 'CryptSetProviderW' delayed;
function CryptSetProvider; external advapi32 name 'CryptSetProvider' + AWSuffix delayed;
function CryptSetProviderExA; external advapi32 name 'CryptSetProviderExA' delayed;
function CryptSetProviderExW; external advapi32 name 'CryptSetProviderExW' delayed;
function CryptSetProviderEx; external advapi32 name 'CryptSetProviderEx' + AWSuffix delayed;
function CryptGetDefaultProviderA; external advapi32 name 'CryptGetDefaultProviderA' delayed;
function CryptGetDefaultProviderW; external advapi32 name 'CryptGetDefaultProviderW' delayed;
function CryptGetDefaultProvider; external advapi32 name 'CryptGetDefaultProvider' + AWSuffix delayed;
function CryptEnumProviderTypesA; external advapi32 name 'CryptEnumProviderTypesA' delayed;
function CryptEnumProviderTypesW; external advapi32 name 'CryptEnumProviderTypesW' delayed;
function CryptEnumProviderTypes; external advapi32 name 'CryptEnumProviderTypes' + AWSuffix delayed;
function CryptEnumProvidersA; external advapi32 name 'CryptEnumProvidersA' delayed;
function CryptEnumProvidersW; external advapi32 name 'CryptEnumProvidersW' delayed;
function CryptEnumProviders; external advapi32 name 'CryptEnumProviders' + AWSuffix delayed;
function CryptContextAddRef; external advapi32 name 'CryptContextAddRef' delayed;
function CryptDuplicateKey; external advapi32 name 'CryptDuplicateKey' delayed;
function CryptDuplicateHash; external advapi32 name 'CryptDuplicateHash' delayed;
function CryptFormatObject; external crypt32 name 'CryptFormatObject' delayed;
function CryptEncodeObjectEx; external crypt32 name 'CryptEncodeObjectEx' delayed;
function CryptEncodeObject; external crypt32 name 'CryptEncodeObject' delayed;
function CryptDecodeObjectEx; external crypt32 name 'CryptDecodeObjectEx' delayed;
function CryptDecodeObject; external crypt32 name 'CryptDecodeObject' delayed;
function CryptInstallOIDFunctionAddress; external crypt32 name 'CryptInstallOIDFunctionAddress' delayed;
function CryptInitOIDFunctionSet; external crypt32 name 'CryptInitOIDFunctionSet' delayed;
function CryptGetOIDFunctionAddress; external crypt32 name 'CryptGetOIDFunctionAddress' delayed;
function CryptGetDefaultOIDDllList; external crypt32 name 'CryptGetDefaultOIDDllList' delayed;
function CryptGetDefaultOIDFunctionAddress; external crypt32 name 'CryptGetDefaultOIDFunctionAddress' delayed;
function CryptFreeOIDFunctionAddress; external crypt32 name 'CryptFreeOIDFunctionAddress' delayed;
function CryptRegisterOIDFunction; external crypt32 name 'CryptRegisterOIDFunction' delayed;
function CryptUnregisterOIDFunction; external crypt32 name 'CryptUnregisterOIDFunction' delayed;
function CryptRegisterDefaultOIDFunction; external crypt32 name 'CryptRegisterDefaultOIDFunction' delayed;
function CryptUnregisterDefaultOIDFunction; external crypt32 name 'CryptUnregisterDefaultOIDFunction' delayed;
function CryptSetOIDFunctionValue; external crypt32 name 'CryptSetOIDFunctionValue' delayed;
function CryptGetOIDFunctionValue; external crypt32 name 'CryptGetOIDFunctionValue' delayed;
function CryptEnumOIDFunction; external crypt32 name 'CryptEnumOIDFunction' delayed;
function CryptFindOIDInfo; external crypt32 name 'CryptFindOIDInfo' delayed;
function CryptRegisterOIDInfo; external crypt32 name 'CryptRegisterOIDInfo' delayed;
function CryptUnregisterOIDInfo; external crypt32 name 'CryptUnregisterOIDInfo' delayed;
function CryptEnumOIDInfo; external crypt32 name 'CryptEnumOIDInfo' delayed;
function CryptFindLocalizedName; external crypt32 name 'CryptFindLocalizedName' delayed;
function CryptMsgOpenToEncode; external crypt32 name 'CryptMsgOpenToEncode' delayed;
function CryptMsgCalculateEncodedLength; external crypt32 name 'CryptMsgCalculateEncodedLength' delayed;
function CryptMsgOpenToDecode; external crypt32 name 'CryptMsgOpenToDecode' delayed;
function CryptMsgDuplicate; external crypt32 name 'CryptMsgDuplicate' delayed;
function CryptMsgClose; external crypt32 name 'CryptMsgClose' delayed;
function CryptMsgUpdate; external crypt32 name 'CryptMsgUpdate' delayed;
function CryptMsgGetParam; external crypt32 name 'CryptMsgGetParam' delayed;
function CryptMsgControl; external crypt32 name 'CryptMsgControl' delayed;
function CryptMsgVerifyCountersignatureEncoded; external crypt32 name 'CryptMsgVerifyCountersignatureEncoded' delayed;
function CryptMsgVerifyCountersignatureEncodedEx; external crypt32 name 'CryptMsgVerifyCountersignatureEncodedEx' delayed;
function CryptMsgCountersign; external crypt32 name 'CryptMsgCountersign' delayed;
function CryptMsgCountersignEncoded; external crypt32 name 'CryptMsgCountersignEncoded' delayed;
function CertOpenStore; external crypt32 name 'CertOpenStore' delayed;
function CertDuplicateStore; external crypt32 name 'CertDuplicateStore' delayed;
function CertSaveStore; external crypt32 name 'CertSaveStore' delayed;
function CertCloseStore; external crypt32 name 'CertCloseStore' delayed;
function CertGetSubjectCertificateFromStore; external crypt32 name 'CertGetSubjectCertificateFromStore' delayed;
...
function CertGetIssuerCertificateFromStore; external crypt32 name 'CertGetIssuerCertificateFromStore' delayed;
function CertVerifySubjectCertificateContext; external crypt32 name 'CertVerifySubjectCertificateContext' delayed;
function CertDuplicateCertificateContext; external crypt32 name 'CertDuplicateCertificateContext' delayed;
...
function CertSetCertificateContextProperty; external crypt32 name 'CertSetCertificateContextProperty' delayed;
function CertGetCertificateContextProperty; external crypt32 name 'CertGetCertificateContextProperty' delayed;
function CertEnumCertificateContextProperties; external crypt32 name 'CertEnumCertificateContextProperties' delayed;
function CertGetCRLFromStore; external crypt32 name 'CertGetCRLFromStore' delayed;
function CertEnumCRLsInStore; external crypt32 name 'CertEnumCRLsInStore' delayed;
function CertFindCRLInStore; external crypt32 name 'CertFindCRLInStore' delayed;
function CertDuplicateCRLContext; external crypt32 name 'CertDuplicateCRLContext' delayed;
function CertCreateCRLContext; external crypt32 name 'CertCreateCRLContext' delayed;
function CertFreeCRLContext; external crypt32 name 'CertFreeCRLContext' delayed;
function CertSetCRLContextProperty; external crypt32 name 'CertSetCRLContextProperty' delayed;
function CertGetCRLContextProperty; external crypt32 name 'CertGetCRLContextProperty' delayed;
function CertEnumCRLContextProperties; external crypt32 name 'CertEnumCRLContextProperties' delayed;
function CertFindCertificateInCRL; external crypt32 name 'CertFindCertificateInCRL' delayed;
function CertAddEncodedCertificateToStore; external crypt32 name 'CertAddEncodedCertificateToStore' delayed;
function CertAddCertificateContextToStore; external crypt32 name 'CertAddCertificateContextToStore' delayed;
function CertAddSerializedElementToStore; external crypt32 name 'CertAddSerializedElementToStore' delayed;
function CertDeleteCertificateFromStore; external crypt32 name 'CertDeleteCertificateFromStore' delayed;
function CertAddEncodedCRLToStore; external crypt32 name 'CertAddEncodedCRLToStore' delayed;
function CertAddCRLContextToStore; external crypt32 name 'CertAddCRLContextToStore' delayed;
function CertDeleteCRLFromStore; external crypt32 name 'CertDeleteCRLFromStore' delayed;
function CertSerializeCertificateStoreElement; external crypt32 name 'CertSerializeCertificateStoreElement' delayed;
function CertSerializeCRLStoreElement; external crypt32 name 'CertSerializeCRLStoreElement' delayed;
function CertDuplicateCTLContext; external crypt32 name 'CertDuplicateCTLContext' delayed;
function CertCreateCTLContext; external crypt32 name 'CertCreateCTLContext' delayed;
function CertFreeCTLContext; external crypt32 name 'CertFreeCTLContext' delayed;
function CertSetCTLContextProperty; external crypt32 name 'CertSetCTLContextProperty' delayed;
function CertGetCTLContextProperty; external crypt32 name 'CertGetCTLContextProperty' delayed;
function CertEnumCTLContextProperties; external crypt32 name 'CertEnumCTLContextProperties' delayed;
function CertEnumCTLsInStore; external crypt32 name 'CertEnumCTLsInStore' delayed;
function CertFindSubjectInCTL; external crypt32 name 'CertFindSubjectInCTL' delayed;
function CertFindCTLInStore; external crypt32 name 'CertFindCTLInStore' delayed;
function CertAddEncodedCTLToStore; external crypt32 name 'CertAddEncodedCTLToStore' delayed;
function CertAddCTLContextToStore; external crypt32 name 'CertAddCTLContextToStore' delayed;
function CertSerializeCTLStoreElement; external crypt32 name 'CertSerializeCTLStoreElement' delayed;
function CertDeleteCTLFromStore; external crypt32 name 'CertDeleteCTLFromStore' delayed;
function CertAddCertificateLinkToStore; external crypt32 name 'CertAddCertificateLinkToStore' delayed;
function CertAddCRLLinkToStore; external crypt32 name 'CertAddCRLLinkToStore' delayed;
function CertAddCTLLinkToStore; external crypt32 name 'CertAddCTLLinkToStore' delayed;
function CertAddStoreToCollection; external crypt32 name 'CertAddStoreToCollection' delayed;
procedure CertRemoveStoreFromCollection; external crypt32 name 'CertRemoveStoreFromCollection' delayed;
function CertControlStore; external crypt32 name 'CertControlStore' delayed;
function CertSetStoreProperty; external crypt32 name 'CertSetStoreProperty' delayed;
function CertGetStoreProperty; external crypt32 name 'CertGetStoreProperty' delayed;
function CertCreateContext; external crypt32 name 'CertCreateContext' delayed;
function CertRegisterSystemStore; external crypt32 name 'CertRegisterSystemStore' delayed;
function CertRegisterPhysicalStore; external crypt32 name 'CertRegisterPhysicalStore' delayed;
function CertUnregisterSystemStore; external crypt32 name 'CertUnregisterSystemStore' delayed;
function CertUnregisterPhysicalStore; external crypt32 name 'CertUnregisterPhysicalStore' delayed;
function CertEnumSystemStoreLocation; external crypt32 name 'CertEnumSystemStoreLocation' delayed;
function CertEnumSystemStore; external crypt32 name 'CertEnumSystemStore' delayed;
function CertEnumPhysicalStore; external crypt32 name 'CertEnumPhysicalStore' delayed;
function CertGetEnhancedKeyUsage; external crypt32 name 'CertGetEnhancedKeyUsage' delayed;
function CertSetEnhancedKeyUsage; external crypt32 name 'CertSetEnhancedKeyUsage' delayed;
function CertAddEnhancedKeyUsageIdentifier; external crypt32 name 'CertAddEnhancedKeyUsageIdentifier' delayed;
function CertRemoveEnhancedKeyUsageIdentifier; external crypt32 name 'CertRemoveEnhancedKeyUsageIdentifier' delayed;
function CertGetValidUsages; external crypt32 name 'CertGetValidUsages' delayed;
function CryptMsgGetAndVerifySigner; external crypt32 name 'CryptMsgGetAndVerifySigner' delayed;
function CryptMsgSignCTL; external crypt32 name 'CryptMsgSignCTL' delayed;
function CryptMsgEncodeAndSignCTL; external crypt32 name 'CryptMsgEncodeAndSignCTL' delayed;
function CertFindSubjectInSortedCTL; external crypt32 name 'CertFindSubjectInSortedCTL' delayed;
function CertEnumSubjectInSortedCTL; external crypt32 name 'CertEnumSubjectInSortedCTL' delayed;
function CertVerifyCTLUsage; external crypt32 name 'CertVerifyCTLUsage' delayed;
function CertVerifyRevocation; external crypt32 name 'CertVerifyRevocation' delayed;
function CertCompareIntegerBlob; external crypt32 name 'CertCompareIntegerBlob' delayed;
function CertCompareCertificate; external crypt32 name 'CertCompareCertificate' delayed;
function CertCompareCertificateName; external crypt32 name 'CertCompareCertificateName' delayed;
function CertIsRDNAttrsInCertificateName; external crypt32 name 'CertIsRDNAttrsInCertificateName' delayed;
function CertComparePublicKeyInfo; external crypt32 name 'CertComparePublicKeyInfo' delayed;
function CertGetPublicKeyLength; external crypt32 name 'CertGetPublicKeyLength' delayed;
function CryptVerifyCertificateSignature; external crypt32 name 'CryptVerifyCertificateSignature' delayed;
function CryptVerifyCertificateSignatureEx; external crypt32 name 'CryptVerifyCertificateSignatureEx' delayed;
function CryptHashToBeSigned; external crypt32 name 'CryptHashToBeSigned' delayed;
function CryptHashCertificate; external crypt32 name 'CryptHashCertificate' delayed;
function CryptSignCertificate; external crypt32 name 'CryptSignCertificate' delayed;
function CryptSignAndEncodeCertificate; external crypt32 name 'CryptSignAndEncodeCertificate' delayed;
function CertVerifyTimeValidity; external crypt32 name 'CertVerifyTimeValidity' delayed;
function CertVerifyCRLTimeValidity; external crypt32 name 'CertVerifyCRLTimeValidity' delayed;
function CertVerifyValidityNesting; external crypt32 name 'CertVerifyValidityNesting' delayed;
function CertVerifyCRLRevocation; external crypt32 name 'CertVerifyCRLRevocation' delayed;
function CertAlgIdToOID; external crypt32 name 'CertAlgIdToOID' delayed;
function CertOIDToAlgId; external crypt32 name 'CertOIDToAlgId' delayed;
function CertFindExtension; external crypt32 name 'CertFindExtension' delayed;
function CertFindAttribute; external crypt32 name 'CertFindAttribute' delayed;
function CertFindRDNAttr; external crypt32 name 'CertFindRDNAttr' delayed;
function CertGetIntendedKeyUsage; external crypt32 name 'CertGetIntendedKeyUsage' delayed;
function CryptInstallDefaultContext; external crypt32 name 'CryptInstallDefaultContext' delayed;
function CryptUninstallDefaultContext; external crypt32 name 'CryptUninstallDefaultContext' delayed;
function CryptExportPublicKeyInfo; external crypt32 name 'CryptExportPublicKeyInfo' delayed;
function CryptExportPublicKeyInfoEx; external crypt32 name 'CryptExportPublicKeyInfoEx' delayed;
function CryptImportPublicKeyInfo; external crypt32 name 'CryptImportPublicKeyInfo' delayed;
function CryptImportPublicKeyInfoEx; external crypt32 name 'CryptImportPublicKeyInfoEx' delayed;
function CryptAcquireCertificatePrivateKey; external crypt32 name 'CryptAcquireCertificatePrivateKey' delayed;
function CryptFindCertificateKeyProvInfo; external crypt32 name 'CryptFindCertificateKeyProvInfo' delayed;
function CryptImportPKCS8; external crypt32 name 'CryptImportPKCS8' delayed;
function CryptExportPKCS8; external crypt32 name 'CryptExportPKCS8' delayed;
function CryptExportPKCS8Ex; external crypt32 name 'CryptExportPKCS8Ex' delayed;
function CryptHashPublicKeyInfo; external crypt32 name 'CryptHashPublicKeyInfo' delayed;
function CertRDNValueToStrA; external crypt32 name 'CertRDNValueToStrA' delayed;
function CertRDNValueToStrW; external crypt32 name 'CertRDNValueToStrW' delayed;
function CertRDNValueToStr; external crypt32 name 'CertRDNValueToStr' + AWSuffix delayed;
function CertNameToStrA; external crypt32 name 'CertNameToStrA' delayed;
function CertNameToStrW; external crypt32 name 'CertNameToStrW' delayed;
function CertNameToStr; external crypt32 name 'CertNameToStr' + AWSuffix delayed;
function CertStrToNameA; external crypt32 name 'CertStrToNameA' delayed;
function CertStrToNameW; external crypt32 name 'CertStrToNameW' delayed;
function CertStrToName; external crypt32 name 'CertStrToName' + AWSuffix delayed;
function CertGetNameStringA; external crypt32 name 'CertGetNameStringA' delayed;
function CertGetNameStringW; external crypt32 name 'CertGetNameStringW' delayed;
function CertGetNameString; external crypt32 name 'CertGetNameString' + AWSuffix delayed;
function CryptSignMessage; external crypt32 name 'CryptSignMessage' delayed;
function CryptVerifyMessageSignature; external crypt32 name 'CryptVerifyMessageSignature' delayed;
function CryptGetMessageSignerCount; external crypt32 name 'CryptGetMessageSignerCount' delayed;
function CryptGetMessageCertificates; external crypt32 name 'CryptGetMessageCertificates' delayed;
function CryptVerifyDetachedMessageSignature; external crypt32 name 'CryptVerifyDetachedMessageSignature' delayed;
function CryptEncryptMessage; external crypt32 name 'CryptEncryptMessage' delayed;
function CryptDecryptMessage; external crypt32 name 'CryptDecryptMessage' delayed;
function CryptSignAndEncryptMessage; external crypt32 name 'CryptSignAndEncryptMessage' delayed;
function CryptDecryptAndVerifyMessageSignature; external crypt32 name 'CryptDecryptAndVerifyMessageSignature' delayed;
function CryptDecodeMessage; external crypt32 name 'CryptDecodeMessage' delayed;
function CryptHashMessage; external crypt32 name 'CryptHashMessage' delayed;
function CryptVerifyMessageHash; external crypt32 name 'CryptVerifyMessageHash' delayed;
function CryptVerifyDetachedMessageHash; external crypt32 name 'CryptVerifyDetachedMessageHash' delayed;
function CryptSignMessageWithKey; external crypt32 name 'CryptSignMessageWithKey' delayed;
function CryptVerifyMessageSignatureWithKey; external crypt32 name 'CryptVerifyMessageSignatureWithKey' delayed;
function CertOpenSystemStoreA; external crypt32 name 'CertOpenSystemStoreA' delayed;
function CertOpenSystemStoreW; external crypt32 name 'CertOpenSystemStoreW' delayed;
function CertOpenSystemStore; external crypt32 name 'CertOpenSystemStore' + AWSuffix delayed;
function CertAddEncodedCertificateToSystemStoreA; external crypt32 name 'CertAddEncodedCertificateToSystemStoreA' delayed;
function CertAddEncodedCertificateToSystemStoreW; external crypt32 name 'CertAddEncodedCertificateToSystemStoreW' delayed;
function CertAddEncodedCertificateToSystemStore; external crypt32 name 'CertAddEncodedCertificateToSystemStore' + AWSuffix delayed;
function FindCertsByIssuer; external softpub name 'FindCertsByIssuer' delayed;
function CryptQueryObject; external crypt32 name 'CryptQueryObject' delayed;
function CryptMemAlloc; external crypt32 name 'CryptMemAlloc' delayed;
function CryptMemRealloc; external crypt32 name 'CryptMemRealloc' delayed;
procedure CryptMemFree; external crypt32 name 'CryptMemFree' delayed;
function CryptCreateAsyncHandle; external crypt32 name 'CryptCreateAsyncHandle' delayed;
function CryptSetAsyncParam; external crypt32 name 'CryptSetAsyncParam' delayed;
function CryptGetAsyncParam; external crypt32 name 'CryptGetAsyncParam' delayed;
function CryptCloseAsyncHandle; external crypt32 name 'CryptCloseAsyncHandle' delayed;
function CryptRetrieveObjectByUrlA; external cryptnet name 'CryptRetrieveObjectByUrlA' delayed;
function CryptRetrieveObjectByUrlW; external cryptnet name 'CryptRetrieveObjectByUrlW' delayed;
function CryptRetrieveObjectByUrl; external cryptnet name 'CryptRetrieveObjectByUrl' + AWSuffix delayed;
function CryptInstallCancelRetrieval; external cryptnet name 'CryptInstallCancelRetrieval' delayed;
function CryptUninstallCancelRetrieval; external cryptnet name 'CryptUninstallCancelRetrieval' delayed;
function CryptCancelAsyncRetrieval; external cryptnet name 'CryptCancelAsyncRetrieval' delayed;
function CryptGetObjectUrl; external cryptnet name 'CryptGetObjectUrl' delayed;
function CryptGetTimeValidObject; external cryptnet name 'CryptGetTimeValidObject' delayed;
function CryptFlushTimeValidObject; external cryptnet name 'CryptFlushTimeValidObject' delayed;
function CryptProtectData; external crypt32 name 'CryptProtectData' delayed;
function CryptUnprotectData; external crypt32 name 'CryptUnprotectData' delayed;
function CertCreateSelfSignCertificate; external crypt32 name 'CertCreateSelfSignCertificate' delayed;
function CryptGetKeyIdentifierProperty; external crypt32 name 'CryptGetKeyIdentifierProperty' delayed;
function CryptSetKeyIdentifierProperty; external crypt32 name 'CryptSetKeyIdentifierProperty' delayed;
function CryptEnumKeyIdentifierProperties; external crypt32 name 'CryptEnumKeyIdentifierProperties' delayed;
function CryptCreateKeyIdentifierFromCSP; external crypt32 name 'CryptCreateKeyIdentifierFromCSP' delayed;
function CertCreateCertificateChainEngine; external crypt32 name 'CertCreateCertificateChainEngine' delayed;
procedure CertFreeCertificateChainEngine; external crypt32 name 'CertFreeCertificateChainEngine' delayed;
function CertResyncCertificateChainEngine; external crypt32 name 'CertResyncCertificateChainEngine' delayed;
function CertGetCertificateChain; external crypt32 name 'CertGetCertificateChain' delayed;
procedure CertFreeCertificateChain; external crypt32 name 'CertFreeCertificateChain' delayed;
function CertDuplicateCertificateChain; external crypt32 name 'CertDuplicateCertificateChain' delayed;
function CertFindChainInStore; external crypt32 name 'CertFindChainInStore' delayed;
function CertVerifyCertificateChainPolicy; external crypt32 name 'CertVerifyCertificateChainPolicy' delayed;
function CryptBinaryToStringA; external crypt32 name 'CryptBinaryToStringA' delayed;
function CryptBinaryToStringW; external crypt32 name 'CryptBinaryToStringW' delayed;
function CryptBinaryToString; external crypt32 name 'CryptBinaryToString' + AWSuffix delayed;
function CryptStringToBinaryA; external crypt32 name 'CryptToStringBinaryA' delayed;
function CryptStringToBinaryW; external crypt32 name 'CryptToStringBinaryW' delayed;
function CryptStringToBinary; external crypt32 name 'CryptToStringBinary' + AWSuffix delayed;
