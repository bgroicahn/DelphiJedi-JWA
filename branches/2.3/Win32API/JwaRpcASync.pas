...
function RpcAsyncInitializeHandle; external rpclib name 'RpcAsyncInitializeHandle' delayed;
function RpcAsyncRegisterInfo; external rpclib name 'RpcAsyncRegisterInfo' delayed;
function RpcAsyncGetCallStatus; external rpclib name 'RpcAsyncGetCallStatus' delayed;
function RpcAsyncCompleteCall; external rpclib name 'RpcAsyncCompleteCall' delayed;
function RpcAsyncAbortCall; external rpclib name 'RpcAsyncAbortCall' delayed;
function RpcAsyncCancelCall; external rpclib name 'RpcAsyncCancelCall' delayed;
...
//function RpcAsyncCleanupThread; external rpclib name 'RpcAsyncCleanupThread' delayed;
function RpcErrorStartEnumeration; external rpclib name 'RpcErrorStartEnumeration' delayed;
function RpcErrorGetNextRecord; external rpclib name 'RpcErrorGetNextRecord' delayed;
function RpcErrorEndEnumeration; external rpclib name 'RpcErrorEndEnumeration' delayed;
function RpcErrorResetEnumeration; external rpclib name 'RpcErrorResetEnumeration' delayed;
function RpcErrorGetNumberOfRecords; external rpclib name 'RpcErrorGetNumberOfRecords' delayed;
function RpcErrorSaveErrorInfo; external rpclib name 'RpcErrorSaveErrorInfo' delayed;
function RpcErrorLoadErrorInfo; external rpclib name 'RpcErrorLoadErrorInfo' delayed;
function RpcErrorAddRecord; external rpclib name 'RpcErrorAddRecord' delayed;
procedure RpcErrorClearInformation; external rpclib name 'RpcErrorClearInformation' delayed;
function RpcGetAuthorizationContextForClient; external rpclib name 'RpcGetAuthorizationContextForClient' delayed;
function RpcFreeAuthorizationContext; external rpclib name 'RpcFreeAuthorizationContext' delayed;
function RpcSsContextLockExclusive; external rpclib name 'RpcSsContextLockExclusive' delayed;
function RpcSsContextLockShared; external rpclib name 'RpcSsContextLockShared' delayed;
function RpcServerInqCallAttributesA; external rpclib name 'RpcServerInqCallAttributesA' delayed;
function RpcServerInqCallAttributesW; external rpclib name 'RpcServerInqCallAttributesW' delayed;
function RpcServerInqCallAttributes; external rpclib name 'RpcServerInqCallAttributes' + AWSuffix delayed;
