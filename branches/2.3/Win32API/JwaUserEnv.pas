...
function LoadUserProfileA; external userenvlib name 'LoadUserProfileA' delayed;
function LoadUserProfileW; external userenvlib name 'LoadUserProfileW' delayed;
function LoadUserProfile; external userenvlib name 'LoadUserProfile' + AWSuffix delayed;
function UnloadUserProfile; external userenvlib name 'UnloadUserProfile' delayed;
function GetProfilesDirectoryA; external userenvlib name 'GetProfilesDirectoryA' delayed;
function GetProfilesDirectoryW; external userenvlib name 'GetProfilesDirectoryW' delayed;
function GetProfilesDirectory; external userenvlib name 'GetProfilesDirectory' + AWSuffix delayed;
function GetProfileType; external userenvlib name 'GetProfileType' delayed;
function DeleteProfileA; external userenvlib name 'DeleteProfileA' delayed;
function DeleteProfileW; external userenvlib name 'DeleteProfileW' delayed;
function DeleteProfile; external userenvlib name 'DeleteProfile' + AWSuffix delayed;
function GetDefaultUserProfileDirectoryA; external userenvlib name 'GetDefaultUserProfileDirectoryA' delayed;
function GetDefaultUserProfileDirectoryW; external userenvlib name 'GetDefaultUserProfileDirectoryW' delayed;
function GetDefaultUserProfileDirectory; external userenvlib name 'GetDefaultUserProfileDirectory' + AWSuffix delayed;
function GetAllUsersProfileDirectoryA; external userenvlib name 'GetAllUsersProfileDirectoryA' delayed;
function GetAllUsersProfileDirectoryW; external userenvlib name 'GetAllUsersProfileDirectoryW' delayed;
function GetAllUsersProfileDirectory; external userenvlib name 'GetAllUsersProfileDirectory' + AWSuffix delayed;
function GetUserProfileDirectoryA; external userenvlib name 'GetUserProfileDirectoryA' delayed;
function GetUserProfileDirectoryW; external userenvlib name 'GetUserProfileDirectoryW' delayed;
function GetUserProfileDirectory; external userenvlib name 'GetUserProfileDirectory' + AWSuffix delayed;
function CreateEnvironmentBlock; external userenvlib name 'CreateEnvironmentBlock' delayed;
function DestroyEnvironmentBlock; external userenvlib name 'DestroyEnvironmentBlock' delayed;
function ExpandEnvironmentStringsForUserA; external userenvlib name 'ExpandEnvironmentStringsForUserA' delayed;
function ExpandEnvironmentStringsForUserW; external userenvlib name 'ExpandEnvironmentStringsForUserW' delayed;
function ExpandEnvironmentStringsForUser; external userenvlib name 'ExpandEnvironmentStringsForUser' + AWSuffix delayed;
function RefreshPolicy; external userenvlib name 'RefreshPolicy' delayed;
function RefreshPolicyEx; external userenvlib name 'RefreshPolicyEx' delayed;
function EnterCriticalPolicySection; external userenvlib name 'EnterCriticalPolicySection' delayed;
function LeaveCriticalPolicySection; external userenvlib name 'LeaveCriticalPolicySection' delayed;
function RegisterGPNotification; external userenvlib name 'RegisterGPNotification' delayed;
function UnregisterGPNotification; external userenvlib name 'UnregisterGPNotification' delayed;
function GetGPOListA; external userenvlib name 'GetGPOListA' delayed;
function GetGPOListW; external userenvlib name 'GetGPOListW' delayed;
function GetGPOList; external userenvlib name 'GetGPOList' + AWSuffix delayed;
function FreeGPOListA; external userenvlib name 'FreeGPOListA' delayed;
function FreeGPOListW; external userenvlib name 'FreeGPOListW' delayed;
function FreeGPOList; external userenvlib name 'FreeGPOList' + AWSuffix delayed;
function GetAppliedGPOListA; external userenvlib name 'GetAppliedGPOListA' delayed;
function GetAppliedGPOListW; external userenvlib name 'GetAppliedGPOListW' delayed;
function GetAppliedGPOList; external userenvlib name 'GetAppliedGPOList' + AWSuffix delayed;
function ProcessGroupPolicyCompleted; external userenvlib name 'ProcessGroupPolicyCompleted' delayed;
function ProcessGroupPolicyCompletedEx; external userenvlib name 'ProcessGroupPolicyCompletedEx' delayed;
function RsopAccessCheckByType; external userenvlib name 'RsopAccessCheckByType' delayed;
function RsopFileAccessCheck; external userenvlib name 'RsopFileAccessCheck' delayed;
function RsopSetPolicySettingStatus; external userenvlib name 'RsopSetPolicySettingStatus' delayed;
function RsopResetPolicySettingStatus; external userenvlib name 'RsopResetPolicySettingStatus' delayed;
