...
function GetPwrDiskSpindownRange; external powrproflib name 'GetPwrDiskSpindownRange' delayed;
function EnumPwrSchemes; external powrproflib name 'EnumPwrSchemes' delayed;
function ReadGlobalPwrPolicy; external powrproflib name 'ReadGlobalPwrPolicy' delayed;
function ReadPwrScheme; external powrproflib name 'ReadPwrScheme' delayed;
function WritePwrScheme; external powrproflib name 'WritePwrScheme' delayed;
function WriteGlobalPwrPolicy; external powrproflib name 'WriteGlobalPwrPolicy' delayed;
function DeletePwrScheme; external powrproflib name 'DeletePwrScheme' delayed;
function GetActivePwrScheme; external powrproflib name 'GetActivePwrScheme' delayed;
function SetActivePwrScheme; external powrproflib name 'SetActivePwrScheme' delayed;
function GetPwrCapabilities; external powrproflib name 'GetPwrCapabilities' delayed;
function IsPwrSuspendAllowed; external powrproflib name 'IsPwrSuspendAllowed' delayed;
function IsPwrHibernateAllowed; external powrproflib name 'IsPwrHibernateAllowed' delayed;
function IsPwrShutdownAllowed; external powrproflib name 'IsPwrShutdownAllowed' delayed;
function IsAdminOverrideActive; external powrproflib name 'IsAdminOverrideActive' delayed;
function SetSuspendState; external powrproflib name 'SetSuspendState' delayed;
function GetCurrentPowerPolicies; external powrproflib name 'GetCurrentPowerPolicies' delayed;
function CanUserWritePwrScheme; external powrproflib name 'CanUserWritePwrScheme' delayed;
function ReadProcessorPwrScheme; external powrproflib name 'ReadProcessorPwrScheme' delayed;
function WriteProcessorPwrScheme; external powrproflib name 'WriteProcessorPwrScheme' delayed;
function ValidatePowerPolicies; external powrproflib name 'ValidatePowerPolicies' delayed;
function CallNtPowerInformation; external powrproflib name 'CallNtPowerInformation' delayed;
