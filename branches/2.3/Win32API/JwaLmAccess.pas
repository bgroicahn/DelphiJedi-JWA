...
function NetUserAdd; external netapi32 name 'NetUserAdd' delayed;
function NetUserEnum; external netapi32 name 'NetUserEnum' delayed;
function NetUserGetInfo; external netapi32 name 'NetUserGetInfo' delayed;
function NetUserSetInfo; external netapi32 name 'NetUserSetInfo' delayed;
function NetUserDel; external netapi32 name 'NetUserDel' delayed;
function NetUserGetGroups; external netapi32 name 'NetUserGetGroups' delayed;
function NetUserSetGroups; external netapi32 name 'NetUserSetGroups' delayed;
function NetUserGetLocalGroups; external netapi32 name 'NetUserGetLocalGroups' delayed;
function NetUserModalsGet; external netapi32 name 'NetUserModalsGet' delayed;
function NetUserModalsSet; external netapi32 name 'NetUserModalsSet' delayed;
function NetUserChangePassword; external netapi32 name 'NetUserChangePassword' delayed;
function NetGroupAdd; external netapi32 name 'NetGroupAdd' delayed;
function NetGroupAddUser; external netapi32 name 'NetGroupAddUser' delayed;
function NetGroupEnum; external netapi32 name 'NetGroupEnum' delayed;
function NetGroupGetInfo; external netapi32 name 'NetGroupGetInfo' delayed;
function NetGroupSetInfo; external netapi32 name 'NetGroupSetInfo' delayed;
function NetGroupDel; external netapi32 name 'NetGroupDel' delayed;
function NetGroupDelUser; external netapi32 name 'NetGroupDelUser' delayed;
function NetGroupGetUsers; external netapi32 name 'NetGroupGetUsers' delayed;
function NetGroupSetUsers; external netapi32 name 'NetGroupSetUsers' delayed;
function NetLocalGroupAdd; external netapi32 name 'NetLocalGroupAdd' delayed;
function NetLocalGroupAddMember; external netapi32 name 'NetLocalGroupAddMember' delayed;
function NetLocalGroupEnum; external netapi32 name 'NetLocalGroupEnum' delayed;
function NetLocalGroupGetInfo; external netapi32 name 'NetLocalGroupGetInfo' delayed;
function NetLocalGroupSetInfo; external netapi32 name 'NetLocalGroupSetInfo' delayed;
function NetLocalGroupDel; external netapi32 name 'NetLocalGroupDel' delayed;
function NetLocalGroupDelMember; external netapi32 name 'NetLocalGroupDelMember' delayed;
function NetLocalGroupGetMembers; external netapi32 name 'NetLocalGroupGetMembers' delayed;
function NetLocalGroupSetMembers; external netapi32 name 'NetLocalGroupSetMembers' delayed;
function NetLocalGroupAddMembers; external netapi32 name 'NetLocalGroupAddMembers' delayed;
function NetLocalGroupDelMembers; external netapi32 name 'NetLocalGroupDelMembers' delayed;
function NetQueryDisplayInformation; external netapi32 name 'NetQueryDisplayInformation' delayed;
function NetGetDisplayInformationIndex; external netapi32 name 'NetGetDisplayInformationIndex' delayed;
function NetAccessAdd; external netapi32 name 'NetAccessAdd' delayed;
function NetAccessEnum; external netapi32 name 'NetAccessEnum' delayed;
function NetAccessGetInfo; external netapi32 name 'NetAccessGetInfo' delayed;
function NetAccessSetInfo; external netapi32 name 'NetAccessSetInfo' delayed;
function NetAccessDel; external netapi32 name 'NetAccessDel' delayed;
function NetAccessGetUserPerms; external netapi32 name 'NetAccessGetUserPerms' delayed;
function NetValidatePasswordPolicy; external netapi32 name 'NetValidatePasswordPolicy' delayed;
function NetValidatePasswordPolicyFree; external netapi32 name 'NetValidatePasswordPolicyFree' delayed;
function NetGetDCName; external netapi32 name 'NetGetDCName' delayed;
function NetGetAnyDCName; external netapi32 name 'NetGetAnyDCName' delayed;
function I_NetLogonControl; external netapi32 name 'I_NetLogonControl' delayed;
function I_NetLogonControl2; external netapi32 name 'I_NetLogonControl2' delayed;
function NetEnumerateTrustedDomains; external netapi32 name 'NetEnumerateTrustedDomains' delayed;
