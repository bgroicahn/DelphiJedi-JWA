...
function __WSAFDIsSet; external ws2_32 name '__WSAFDIsSet' delayed;
function accept; external ws2_32 name 'accept' delayed;
function bind; external ws2_32 name 'bind' delayed;
function closesocket; external ws2_32 name 'closesocket' delayed;
function connect; external ws2_32 name 'connect' delayed;
function ioctlsocket; external ws2_32 name 'ioctlsocket' delayed;
function getpeername; external ws2_32 name 'getpeername' delayed;
function getsockname; external ws2_32 name 'getsockname' delayed;
function getsockopt; external ws2_32 name 'getsockopt' delayed;
function htonl; external ws2_32 name 'htonl' delayed;
function htons; external ws2_32 name 'htons' delayed;
function inet_addr; external ws2_32 name 'inet_addr' delayed;
function inet_ntoa; external ws2_32 name 'inet_ntoa' delayed;
function listen; external ws2_32 name 'listen' delayed;
function ntohl; external ws2_32 name 'ntohl' delayed;
function ntohs; external ws2_32 name 'ntohs' delayed;
function recv; external ws2_32 name 'recv' delayed;
function recvfrom; external ws2_32 name 'recvfrom' delayed;
function select; external ws2_32 name 'select' delayed;
function send; external ws2_32 name 'send' delayed;
function sendto; external ws2_32 name 'sendto' delayed;
function setsockopt; external ws2_32 name 'setsockopt' delayed;
function shutdown; external ws2_32 name 'shutdown' delayed;
function socket; external ws2_32 name 'socket' delayed;
function gethostbyaddr; external ws2_32 name 'gethostbyaddr' delayed;
function gethostbyname; external ws2_32 name 'gethostbyname' delayed;
function gethostname; external ws2_32 name 'gethostname' delayed;
function getservbyport; external ws2_32 name 'getservbyport' delayed;
function getservbyname; external ws2_32 name 'getservbyname' delayed;
function getprotobynumber; external ws2_32 name 'getprotobynumber' delayed;
function getprotobyname; external ws2_32 name 'getprotobyname' delayed;
function WSAStartup; external ws2_32 name 'WSAStartup' delayed;
function WSACleanup; external ws2_32 name 'WSACleanup' delayed;
procedure WSASetLastError; external ws2_32 name 'WSASetLastError' delayed;
function WSAGetLastError; external ws2_32 name 'WSAGetLastError' delayed;
function WSAIsBlocking; external ws2_32 name 'WSAIsBlocking' delayed;
function WSAUnhookBlockingHook; external ws2_32 name 'WSAUnhookBlockingHook' delayed;
function WSASetBlockingHook; external ws2_32 name 'WSASetBlockingHook' delayed;
function WSACancelBlockingCall; external ws2_32 name 'WSACancelBlockingCall' delayed;
function WSAAsyncGetServByName; external ws2_32 name 'WSAAsyncGetServByName' delayed;
function WSAAsyncGetServByPort; external ws2_32 name 'WSAAsyncGetServByPort' delayed;
function WSAAsyncGetProtoByName; external ws2_32 name 'WSAAsyncGetProtoByName' delayed;
function WSAAsyncGetProtoByNumber; external ws2_32 name 'WSAAsyncGetProtoByNumber' delayed;
function WSAAsyncGetHostByName; external ws2_32 name 'WSAAsyncGetHostByName' delayed;
function WSAAsyncGetHostByAddr; external ws2_32 name 'WSAAsyncGetHostByAddr' delayed;
function WSACancelAsyncRequest; external ws2_32 name 'WSACancelAsyncRequest' delayed;
function WSAAsyncSelect; external ws2_32 name 'WSAAsyncSelect' delayed;
function WSAAccept; external ws2_32 name 'WSAAccept' delayed;
function WSACloseEvent; external ws2_32 name 'WSACloseEvent' delayed;
function WSAConnect; external ws2_32 name 'WSAConnect' delayed;
function WSACreateEvent; external ws2_32 name 'WSACreateEvent' delayed;
function WSADuplicateSocketA; external ws2_32 name 'WSADuplicateSocketA' delayed;
function WSADuplicateSocketW; external ws2_32 name 'WSADuplicateSocketW' delayed;
function WSADuplicateSocket; external ws2_32 name 'WSADuplicateSocket' + AWSuffix delayed;
function WSAEnumNetworkEvents; external ws2_32 name 'WSAEnumNetworkEvents' delayed;
function WSAEnumProtocolsA; external ws2_32 name 'WSAEnumProtocolsA' delayed;
function WSAEnumProtocolsW; external ws2_32 name 'WSAEnumProtocolsW' delayed;
function WSAEnumProtocols; external ws2_32 name 'WSAEnumProtocols' + AWSuffix delayed;
function WSAEventSelect; external ws2_32 name 'WSAEventSelect' delayed;
function WSAGetOverlappedResult; external ws2_32 name 'WSAGetOverlappedResult' delayed;
function WSAGetQOSByName; external ws2_32 name 'WSAGetQOSByName' delayed;
function WSAHtonl; external ws2_32 name 'WSAHtonl' delayed;
function WSAHtons; external ws2_32 name 'WSAHtons' delayed;
function WSAIoctl; external ws2_32 name 'WSAIoctl' delayed;
function WSAJoinLeaf; external ws2_32 name 'WSAJoinLeaf' delayed;
function WSANtohl; external ws2_32 name 'WSANtohl' delayed;
function WSANtohs; external ws2_32 name 'WSANtohs' delayed;
function WSARecv; external ws2_32 name 'WSARecv' delayed;
function WSARecvDisconnect; external ws2_32 name 'WSARecvDisconnect' delayed;
function WSARecvFrom; external ws2_32 name 'WSARecvFrom' delayed;
function WSAResetEvent; external ws2_32 name 'WSAResetEvent' delayed;
function WSASend; external ws2_32 name 'WSASend' delayed;
function WSASendDisconnect; external ws2_32 name 'WSASendDisconnect' delayed;
function WSASendTo; external ws2_32 name 'WSASendTo' delayed;
function WSASetEvent; external ws2_32 name 'WSASetEvent' delayed;
function WSASocketA; external ws2_32 name 'WSASocketA' delayed;
function WSASocketW; external ws2_32 name 'WSASocketW' delayed;
function WSASocket; external ws2_32 name 'WSASocket' + AWSuffix delayed;
function WSAWaitForMultipleEvents; external ws2_32 name 'WSAWaitForMultipleEvents' delayed;
function WSAAddressToStringA; external ws2_32 name 'WSAAddressToStringA' delayed;
function WSAAddressToStringW; external ws2_32 name 'WSAAddressToStringW' delayed;
function WSAAddressToString; external ws2_32 name 'WSAAddressToString' + AWSuffix delayed;
function WSAStringToAddressA; external ws2_32 name 'WSAStringToAddressA' delayed;
function WSAStringToAddressW; external ws2_32 name 'WSAStringToAddressW' delayed;
function WSAStringToAddress; external ws2_32 name 'WSAStringToAddress' + AWSuffix delayed;
function WSALookupServiceBeginA; external ws2_32 name 'WSALookupServiceBeginA' delayed;
function WSALookupServiceBeginW; external ws2_32 name 'WSALookupServiceBeginW' delayed;
function WSALookupServiceBegin; external ws2_32 name 'WSALookupServiceBegin' + AWSuffix delayed;
function WSALookupServiceNextA; external ws2_32 name 'WSALookupServiceNextA' delayed;
function WSALookupServiceNextW; external ws2_32 name 'WSALookupServiceNextW' delayed;
function WSALookupServiceNext; external ws2_32 name 'WSALookupServiceNext' + AWSuffix delayed;
function WSANSPIoctl; external ws2_32 name 'WSANSPIoctl' delayed;
function WSALookupServiceEnd; external ws2_32 name 'WSALookupServiceEnd' delayed;
function WSAInstallServiceClassA; external ws2_32 name 'WSAInstallServiceClassA' delayed;
function WSAInstallServiceClassW; external ws2_32 name 'WSAInstallServiceClassW' delayed;
function WSAInstallServiceClass; external ws2_32 name 'WSAInstallServiceClass' + AWSuffix delayed;
function WSARemoveServiceClass; external ws2_32 name 'WSARemoveServiceClass' delayed;
function WSAGetServiceClassInfoA; external ws2_32 name 'WSAGetServiceClassInfoA' delayed;
function WSAGetServiceClassInfoW; external ws2_32 name 'WSAGetServiceClassInfoW' delayed;
function WSAGetServiceClassInfo; external ws2_32 name 'WSAGetServiceClassInfo' + AWSuffix delayed;
function WSAEnumNameSpaceProvidersA; external ws2_32 name 'WSAEnumNameSpaceProvidersA' delayed;
function WSAEnumNameSpaceProvidersW; external ws2_32 name 'WSAEnumNameSpaceProvidersW' delayed;
function WSAEnumNameSpaceProviders; external ws2_32 name 'WSAEnumNameSpaceProviders' + AWSuffix delayed;
function WSAGetServiceClassNameByClassIdA; external ws2_32 name 'WSAGetServiceClassNameByClassIdA' delayed;
function WSAGetServiceClassNameByClassIdW; external ws2_32 name 'WSAGetServiceClassNameByClassIdW' delayed;
function WSAGetServiceClassNameByClassId; external ws2_32 name 'WSAGetServiceClassNameByClassId' + AWSuffix delayed;
function WSASetServiceA; external ws2_32 name 'WSASetServiceA' delayed;
function WSASetServiceW; external ws2_32 name 'WSASetServiceW' delayed;
function WSASetService; external ws2_32 name 'WSASetService' + AWSuffix delayed;
function WSAProviderConfigChange; external ws2_32 name 'WSAProviderConfigChange' delayed;
