...
function CreateToolhelp32Snapshot; external kernel32 name 'CreateToolhelp32Snapshot' delayed;
function Heap32ListFirst; external kernel32 name 'Heap32ListFirst' delayed;
function Heap32ListNext; external kernel32 name 'Heap32ListNext' delayed;
function Heap32First; external kernel32 name 'Heap32First' delayed;
function Heap32Next; external kernel32 name 'Heap32Next' delayed;
function Toolhelp32ReadProcessMemory; external kernel32 name 'Toolhelp32ReadProcessMemory' delayed;
function Thread32First; external kernel32 name 'Thread32First' delayed;
function Thread32Next; external kernel32 name 'Thread32Next' delayed;


{$IFDEF UNICODE}
function Process32First; external kernel32 name 'Process32FirstW' delayed;
{$ELSE}
function Process32First; external kernel32 name 'Process32First' delayed;
{$ENDIF}
function Process32FirstW; external kernel32 name 'Process32FirstW' delayed;
function Process32FirstA; external kernel32 name 'Process32First' delayed;

{$IFDEF UNICODE}
function Process32Next; external kernel32 name 'Process32NextW' delayed;
{$ELSE}
function Process32Next; external kernel32 name 'Process32Next' delayed;
{$ENDIF}
function Process32NextW; external kernel32 name 'Process32NextW' delayed;
function Process32NextA; external kernel32 name 'Process32Next' delayed; //ANSI

{$IFDEF UNICODE}
function Module32First; external kernel32 name 'Module32FirstW' delayed;
{$ELSE}
function Module32First; external kernel32 name 'Module32First' delayed;
{$ENDIF}
function Module32FirstA; external kernel32 name 'Module32First' delayed;
function Module32FirstW; external kernel32 name 'Module32FirstW' delayed;



{$IFDEF UNICODE}
function Module32Next; external kernel32 name 'Module32NextW' delayed;
{$ELSE}
function Module32Next; external kernel32 name 'Module32Next' delayed;
{$ENDIF}
function Module32NextA; external kernel32 name 'Module32Next' delayed;
function Module32NextW; external kernel32 name 'Module32NextW' delayed;
