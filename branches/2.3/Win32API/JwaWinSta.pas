...
procedure CachedGetUserFromSid; external utildll name 'CachedGetUserFromSid' delayed;
function CalculateDiffTime; external utildll name 'CalculateDiffTime' delayed;
function CalculateElapsedTime; external utildll name 'CalculateElapsedTime' delayed;
function CurrentDateTimeString; external utildll name 'CurrentDateTimeString' delayed;
function DateTimeString; external utildll name 'DateTimeString' delayed;
function DateTimeStringVistaRTM; external utildll name 'DateTimeString' delayed;
function ElapsedTimeString; external utildll name 'ElapsedTimeString' delayed;
// Vista version of ElapsedTimeString, exported name is ElapsedTimeString

function ElapsedTimeStringVistaRTM; external utildll name 'ElapsedTimeString' delayed;
function GetUnknownString; external utildll name 'GetUnknownString' delayed;
function LogonIdFromWinStationNameA; external winstadll name 'LogonIdFromWinStationNameA' delayed;
function LogonIdFromWinStationNameW; external winstadll name 'LogonIdFromWinStationNameW' delayed;
function QueryCurrentWinStation; external utildll name 'QueryCurrentWinStation' delayed;
function QueryCurrentWinStationVistaRTM; external utildll name 'QueryCurrentWinStation' delayed;
function StrConnectState; external utildll name 'StrConnectState' delayed;
function WinStationBroadcastSystemMessage; external winstadll name 'WinStationBroadcastSystemMessage' delayed;
function WinStationCallBack; external winstadll name 'WinStationCallBack' delayed;
procedure WinStationCloseServer; external winstadll name 'WinStationCloseServer' delayed;
function WinStationConnectW; external winstadll name 'WinStationConnectW' delayed;
function WinStationDisconnect; external winstadll name 'WinStationDisconnect' delayed;
function WinStationEnumerateA; external winstadll name 'WinStationEnumerateA' delayed;
function WinStationEnumerateW; external winstadll name 'WinStationEnumerateW' delayed;
function WinStationFreeGAPMemory; external winstadll name 'WinStationFreeGAPMemory' delayed;
function WinStationGetAllProcesses; external winstadll name 'WinStationGetAllProcesses' delayed;
function WinStationGetLanAdapterNameW; external winstadll name 'WinStationGetLanAdapterNameW' delayed;
function WinStationGetProcessSid; external winstadll name 'WinStationGetProcessSid' delayed;
function WinStationGetTermSrvCountersValue; external winstadll name 'WinStationGetTermSrvCountersValue' delayed;
function WinStationNameFromLogonIdA; external winstadll name 'WinStationNameFromLogonIdA' delayed;
function WinStationNameFromLogonIdW; external winstadll name 'WinStationNameFromLogonIdW' delayed;
function WinStationOpenServerA; external winstadll name 'WinStationOpenServerA' delayed;
function WinStationOpenServerW; external winstadll name 'WinStationOpenServerW' delayed;
function WinStationQueryLogonCredentialsW; external winstadll name 'WinStationQueryLogonCredentialsW' delayed;
function WinStationRegisterConsoleNotification; external winstadll name 'WinStationRegisterConsoleNotification' delayed;
function WinStationRenameA; external winstadll name 'WinStationRenameA' delayed;
function WinStationRenameW; external winstadll name 'WinStationRenameW' delayed;
function WinStationSendMessageA; external winstadll name 'WinStationSendMessageA' delayed;
function WinStationSendMessageW; external winstadll name 'WinStationSendMessageW' delayed;
function WinStationServerPing; external winstadll name 'WinStationServerPing' delayed;
function WinStationSetInformationA; external winstadll name 'WinStationSetInformationA' delayed;
function WinStationSetInformationW; external winstadll name 'WinStationSetInformationW' delayed;
function WinStationShadow; external winstadll name 'WinStationShadow' delayed;
function WinStationShadowStop; external winstadll name 'WinStationShadowStop' delayed;
function WinStationShutDownSystem; external winstadll name 'WinStationShutDownSystem' delayed;
function WinStationQueryInformationW; external winstadll name 'WinStationQueryInformationW' delayed;
function WinStationTerminateProcess; external winstadll name 'WinStationTerminateProcess' delayed;
function WinStationUnRegisterConsoleNotification; external winstadll name 'WinStationUnRegisterConsoleNotification' delayed;
